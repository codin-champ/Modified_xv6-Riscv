...
int main() {
  ...
  16:	310080e7          	jalr	784(ra) # 322 <fork>
      if (pid < 0)
  ...
  50:	36e080e7          	jalr	878(ra) # 3ba <sleep>
  ...
  6c:	7f050513          	addi	a0,a0,2032 # 858 <malloc+0xe8>
  70:	00000097          	auipc	ra,0x0
  74:	642080e7          	jalr	1602(ra) # 6b2 <printf>
  return 0;
}
  78:	4501                	li	a0,0
  7a:	70e2                	ld	ra,56(sp)
  ...
  8a:	d8f1                	beqz	s1,5e <main+0x5e>
      if(waitx(0,&wtime,&rtime) >= 0) {
  8c:	fc840613          	addi	a2,s0,-56
  90:	fcc40593          	addi	a1,s0,-52
  94:	4501                	li	a0,0
  96:	00000097          	auipc	ra,0x0
  9a:	33c080e7          	jalr	828(ra) # 3d2 <waitx>
  9e:	fe0545e3          	bltz	a0,88 <main+0x88>
          trtime += rtime;
  a2:	fc842783          	lw	a5,-56(s0)
  a6:	0127893b          	addw	s2,a5,s2
          twtime += wtime;
  aa:	fcc42783          	lw	a5,-52(s0)
  ae:	013789bb          	addw	s3,a5,s3
  b2:	bfd9                	j	88 <main+0x88>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 422:	46250513          	addi	a0,a0,1122 # 880 <digits>
 426:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ee:	396b8b93          	addi	s7,s7,918 # 880 <digits>
 ...
 62e:	24e90913          	addi	s2,s2,590 # 878 <malloc+0x108>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f6:	1a67b783          	ld	a5,422(a5) # 898 <freep>
...
malloc(uint nbytes)
{
 ...
 798:	10453503          	ld	a0,260(a0) # 898 <freep>
 ...
 7c0:	0dc90913          	addi	s2,s2,220 # 898 <freep>
  if(p == (char*)-1)
 7c4:	5afd                	li	s5,-1
 7c6:	a88d                	j	838 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7c8:	00000797          	auipc	a5,0x0
 7cc:	0d878793          	addi	a5,a5,216 # 8a0 <base>
 7d0:	00000717          	auipc	a4,0x0
 7d4:	0cf73423          	sd	a5,200(a4) # 898 <freep>
 7d8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7fa:	0aa73123          	sd	a0,162(a4) # 898 <freep>
      return (void*)(p + 1);
