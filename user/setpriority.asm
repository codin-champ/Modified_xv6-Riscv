...
int main(int argc, char *argv[]) 
{
  ...
  16:	7f658593          	addi	a1,a1,2038 # 808 <malloc+0xe8>
  1a:	4509                	li	a0,2
  1c:	00000097          	auipc	ra,0x0
  20:	618080e7          	jalr	1560(ra) # 634 <fprintf>
    exit(1);
  24:	4505                	li	a0,1
  26:	00000097          	auipc	ra,0x0
  2a:	2ac080e7          	jalr	684(ra) # 2d2 <exit>
  2e:	84ae                	mv	s1,a1
  }
  ...
  36:	1a0080e7          	jalr	416(ra) # 1d2 <atoi>
  3a:	892a                	mv	s2,a0
  3c:	6888                	ld	a0,16(s1)
  3e:	00000097          	auipc	ra,0x0
  42:	194080e7          	jalr	404(ra) # 1d2 <atoi>
  46:	85aa                	mv	a1,a0
  48:	854a                	mv	a0,s2
  4a:	00000097          	auipc	ra,0x0
  4e:	338080e7          	jalr	824(ra) # 382 <set_priority>
  exit(0);
  52:	4501                	li	a0,0
...
free(void *ap)
{
 ...
 6a6:	1ae7b783          	ld	a5,430(a5) # 850 <freep>
 ...
 6d4:	00e6ea63          	bltu	a3,a4,6e8 <free+0x50>
{
 ...
 716:	12f73f23          	sd	a5,318(a4) # 850 <freep>
}
 71a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 748:	10c53503          	ld	a0,268(a0) # 850 <freep>
 ...
 770:	0e490913          	addi	s2,s2,228 # 850 <freep>
  if(p == (char*)-1)
 774:	5afd                	li	s5,-1
 776:	a88d                	j	7e8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 778:	00000797          	auipc	a5,0x0
 77c:	0e078793          	addi	a5,a5,224 # 858 <base>
 780:	00000717          	auipc	a4,0x0
 784:	0cf73823          	sd	a5,208(a4) # 850 <freep>
 788:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7aa:	0aa73523          	sd	a0,170(a4) # 850 <freep>
      return (void*)(p + 1);
