...
w_mscratch(uint64 x)
{
  ...
  asm volatile("csrw mtvec, %0" : : "r" (x));
    ...
    80000068:	30c78793          	addi	a5,a5,780 # 80006370 <timervec>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000ed8:	ada080e7          	jalr	-1318(ra) # 800029ae <trapinithart>
    plicinithart();   // ask PLIC for device interrupts
    80000edc:	00005097          	auipc	ra,0x5
    80000ee0:	4d4080e7          	jalr	1236(ra) # 800063b0 <plicinithart>
  }

  scheduler();        
    80000ee4:	00002097          	auipc	ra,0x2
    80000ee8:	8e8080e7          	jalr	-1816(ra) # 800027cc <scheduler>
    consoleinit();
    ...
    80000f50:	a3a080e7          	jalr	-1478(ra) # 80002986 <trapinit>
    trapinithart();  // install kernel trap vector
    80000f54:	00002097          	auipc	ra,0x2
    80000f58:	a5a080e7          	jalr	-1446(ra) # 800029ae <trapinithart>
    plicinit();      // set up interrupt controller
    80000f5c:	00005097          	auipc	ra,0x5
    80000f60:	43e080e7          	jalr	1086(ra) # 8000639a <plicinit>
    plicinithart();  // ask PLIC for device interrupts
    80000f64:	00005097          	auipc	ra,0x5
    80000f68:	44c080e7          	jalr	1100(ra) # 800063b0 <plicinithart>
    binit();         // buffer cache
    80000f6c:	00002097          	auipc	ra,0x2
    80000f70:	632080e7          	jalr	1586(ra) # 8000359e <binit>
    iinit();         // inode table
    80000f74:	00003097          	auipc	ra,0x3
    80000f78:	cc2080e7          	jalr	-830(ra) # 80003c36 <iinit>
    fileinit();      // file table
    80000f7c:	00004097          	auipc	ra,0x4
    80000f80:	c6c080e7          	jalr	-916(ra) # 80004be8 <fileinit>
    virtio_disk_init(); // emulated hard disk
    80000f84:	00005097          	auipc	ra,0x5
    80000f88:	54e080e7          	jalr	1358(ra) # 800064d2 <virtio_disk_init>
    userinit();      // first user process
...
void forkret(void)
{
  ...
  if (first)
    ...
    80001a04:	fb07a783          	lw	a5,-80(a5) # 800089b0 <first.2426>
  ...
  usertrapret();
    ...
    80001a0e:	fbc080e7          	jalr	-68(ra) # 800029c6 <usertrapret>
}
    ...
    80001a1e:	f807ab23          	sw	zero,-106(a5) # 800089b0 <first.2426>
    fsinit(ROOTDEV);
    80001a22:	4505                	li	a0,1
    80001a24:	00002097          	auipc	ra,0x2
    80001a28:	192080e7          	jalr	402(ra) # 80003bb6 <fsinit>
...
0000000080001a2e <allocpid>:
{
  ...
  pid = nextpid;
    ...
    80001a50:	f6878793          	addi	a5,a5,-152 # 800089b4 <nextpid>
...
0000000080001caa <userinit>:
{
  ...
  uvminit(p->pagetable, initcode, sizeof(initcode));
    ...
    80001cce:	cf658593          	addi	a1,a1,-778 # 800089c0 <initcode>
  ...
  p->cwd = namei("/");
    ...
    80001d0c:	8dc080e7          	jalr	-1828(ra) # 800045e4 <namei>
...
0000000080001da0 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for (i = 0; i < NOFILE; i++)
    ...
    80001e4a:	e34080e7          	jalr	-460(ra) # 80004c7a <filedup>
  ...
  np->cwd = idup(p->cwd);
    ...
    80001e6c:	f88080e7          	jalr	-120(ra) # 80003df0 <idup>
...
0000000080001ee4 <sched>:
{
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80001f5c:	9c4080e7          	jalr	-1596(ra) # 8000291c <swtch>
...
0000000080002252 <exit>:
{
  ...
  if (p == initproc)
    ...
    80002296:	a3a080e7          	jalr	-1478(ra) # 80004ccc <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    ...
    800022ae:	556080e7          	jalr	1366(ra) # 80004800 <begin_op>
  iput(p->cwd);
    800022b2:	1509b503          	ld	a0,336(s3)
    800022b6:	00002097          	auipc	ra,0x2
    800022ba:	d32080e7          	jalr	-718(ra) # 80003fe8 <iput>
  end_op();
    800022be:	00002097          	auipc	ra,0x2
    800022c2:	5c2080e7          	jalr	1474(ra) # 80004880 <end_op>
  p->cwd = 0;
...
void ageing(void)
{
  ...
  for (struct proc *p = proc; p < &proc[NPROC]; p++)
    ...
    800024ae:	5b4080e7          	jalr	1460(ra) # 80006a5e <qerase>
        p->in_queue = 0;
...
void procdump(void)
{
  ...
  printf("Pid \t Priority \t State \t Run-Time \t Sleep-Time \t Num_runs \n");
    ...
    80002546:	046080e7          	jalr	70(ra) # 80000588 <printf>
  for (p = proc; p < &proc[NPROC]; p++)
    8000254a:	00010497          	auipc	s1,0x10
    8000254e:	bfe48493          	addi	s1,s1,-1026 # 80012148 <proc>
  {
    if (p->state == UNUSED)
      continue;
    ...
    80002558:	d3c98993          	addi	s3,s3,-708 # 80008290 <digits+0x250>
    
    printf("%d\t %d \t\t %s \t %d \t\t %d \t %d", p->pid,p->dynamic_priority,state, p->rtime, p->sleep_time, p->n_run);
    8000255c:	00006a97          	auipc	s5,0x6
    80002560:	d7ca8a93          	addi	s5,s5,-644 # 800082d8 <digits+0x298>
    printf("\n");
    80002564:	00006a17          	auipc	s4,0x6
    80002568:	b64a0a13          	addi	s4,s4,-1180 # 800080c8 <digits+0x88>
    if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
    8000256c:	00006b97          	auipc	s7,0x6
    80002570:	db4b8b93          	addi	s7,s7,-588 # 80008320 <states.2470>
  for (p = proc; p < &proc[NPROC]; p++)
    80002574:	00016917          	auipc	s2,0x16
    80002578:	7d490913          	addi	s2,s2,2004 # 80018d48 <tickslock>
    8000257c:	a805                	j	800025ac <procdump+0x98>
    printf("%d\t %d \t\t %s \t %d \t\t %d \t %d", p->pid,p->dynamic_priority,state, p->rtime, p->sleep_time, p->n_run);
    8000257e:	1944a803          	lw	a6,404(s1)
    80002582:	1784a783          	lw	a5,376(s1)
    80002586:	1744a703          	lw	a4,372(s1)
    8000258a:	1844a603          	lw	a2,388(s1)
    8000258e:	588c                	lw	a1,48(s1)
  ...
  for (p = proc; p < &proc[NPROC]; p++)
    800025a4:	1b048493          	addi	s1,s1,432
    800025a8:	01248f63          	beq	s1,s2,800025c6 <procdump+0xb2>
    if (p->state == UNUSED)
    800025ac:	4c9c                	lw	a5,24(s1)
    800025ae:	dbfd                	beqz	a5,800025a4 <procdump+0x90>
      state = "???";
    800025b0:	86ce                	mv	a3,s3
    if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
    800025b2:	fcfb66e3          	bltu	s6,a5,8000257e <procdump+0x6a>
    800025b6:	1782                	slli	a5,a5,0x20
    800025b8:	9381                	srli	a5,a5,0x20
    800025ba:	078e                	slli	a5,a5,0x3
    800025bc:	97de                	add	a5,a5,s7
    800025be:	6394                	ld	a3,0(a5)
    800025c0:	fedd                	bnez	a3,8000257e <procdump+0x6a>
      state = "???";
    800025c2:	86ce                	mv	a3,s3
    800025c4:	bf6d                	j	8000257e <procdump+0x6a>
...
waitx(uint64 addr, uint* rtime, uint* wtime)
{
    ...
    800025f4:	e06a                	sd	s10,0(sp)
    800025f6:	1080                	addi	s0,sp,96
    800025f8:	8b2a                	mv	s6,a0
    800025fa:	8c2e                	mv	s8,a1
    800025fc:	8bb2                	mv	s7,a2
  struct proc *np;
  int havekids, pid;
  struct proc *p = myproc();
    800025fe:	fffff097          	auipc	ra,0xfffff
    80002602:	3b2080e7          	jalr	946(ra) # 800019b0 <myproc>
    80002606:	892a                	mv	s2,a0

  acquire(&wait_lock);
    80002608:	0000f517          	auipc	a0,0xf
    8000260c:	cb050513          	addi	a0,a0,-848 # 800112b8 <wait_lock>
  ...
  for(;;){
    ...
    for(np = proc; np < &proc[NPROC]; np++){
    8000261c:	00016997          	auipc	s3,0x16
    80002620:	72c98993          	addi	s3,s3,1836 # 80018d48 <tickslock>
        havekids = 1;
    ...
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002626:	0000fd17          	auipc	s10,0xf
    8000262a:	c92d0d13          	addi	s10,s10,-878 # 800112b8 <wait_lock>
    havekids = 0;
    8000262e:	8766                	mv	a4,s9
    for(np = proc; np < &proc[NPROC]; np++){
    80002630:	00010497          	auipc	s1,0x10
    80002634:	b1848493          	addi	s1,s1,-1256 # 80012148 <proc>
    80002638:	a069                	j	800026c2 <waitx+0xe6>
          pid = np->pid;
    8000263a:	0304a983          	lw	s3,48(s1)
          *rtime = np->rtime;
    8000263e:	1744a783          	lw	a5,372(s1)
    80002642:	00fc2023          	sw	a5,0(s8)
          *wtime = np->etime - np->ctime - np->rtime;
    80002646:	1704a783          	lw	a5,368(s1)
    8000264a:	16c4a703          	lw	a4,364(s1)
    8000264e:	9f99                	subw	a5,a5,a4
    80002650:	1744a703          	lw	a4,372(s1)
    80002654:	9f99                	subw	a5,a5,a4
    80002656:	00fba023          	sw	a5,0(s7)
          if(addr != 0 && copyout(p->pagetable, addr, (char *)&np->xstate,
    8000265a:	000b0e63          	beqz	s6,80002676 <waitx+0x9a>
    8000265e:	4691                	li	a3,4
    80002660:	02c48613          	addi	a2,s1,44
    80002664:	85da                	mv	a1,s6
    80002666:	05093503          	ld	a0,80(s2)
    8000266a:	fffff097          	auipc	ra,0xfffff
    8000266e:	008080e7          	jalr	8(ra) # 80001672 <copyout>
    80002672:	02054563          	bltz	a0,8000269c <waitx+0xc0>
          freeproc(np);
    80002676:	8526                	mv	a0,s1
    80002678:	fffff097          	auipc	ra,0xfffff
    8000267c:	4ea080e7          	jalr	1258(ra) # 80001b62 <freeproc>
          release(&np->lock);
    ...
    80002696:	606080e7          	jalr	1542(ra) # 80000c98 <release>
          return pid;
    8000269a:	a09d                	j	80002700 <waitx+0x124>
            release(&np->lock);
    ...
    800026b8:	a0a1                	j	80002700 <waitx+0x124>
    for(np = proc; np < &proc[NPROC]; np++){
    800026ba:	1b048493          	addi	s1,s1,432
    800026be:	03348463          	beq	s1,s3,800026e6 <waitx+0x10a>
      if(np->parent == p){
    800026c2:	7c9c                	ld	a5,56(s1)
    800026c4:	ff279be3          	bne	a5,s2,800026ba <waitx+0xde>
        acquire(&np->lock);
    ...
    800026d4:	f74783e3          	beq	a5,s4,8000263a <waitx+0x5e>
        release(&np->lock);
    ...
    800026e4:	bfd9                	j	800026ba <waitx+0xde>
    if(!havekids || p->killed){
    800026e6:	c701                	beqz	a4,800026ee <waitx+0x112>
    800026e8:	02892783          	lw	a5,40(s2)
    800026ec:	cb8d                	beqz	a5,8000271e <waitx+0x142>
      release(&wait_lock);
    ...
    80002702:	60e6                	ld	ra,88(sp)
    80002704:	6446                	ld	s0,80(sp)
    80002706:	64a6                	ld	s1,72(sp)
    80002708:	6906                	ld	s2,64(sp)
    8000270a:	79e2                	ld	s3,56(sp)
    8000270c:	7a42                	ld	s4,48(sp)
    8000270e:	7aa2                	ld	s5,40(sp)
    80002710:	7b02                	ld	s6,32(sp)
    80002712:	6be2                	ld	s7,24(sp)
    80002714:	6c42                	ld	s8,16(sp)
    80002716:	6ca2                	ld	s9,8(sp)
    80002718:	6d02                	ld	s10,0(sp)
    8000271a:	6125                	addi	sp,sp,96
    8000271c:	8082                	ret
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000271e:	85ea                	mv	a1,s10
    80002720:	854a                	mv	a0,s2
    80002722:	00000097          	auipc	ra,0x0
    80002726:	8d4080e7          	jalr	-1836(ra) # 80001ff6 <sleep>
    havekids = 0;
    8000272a:	b711                	j	8000262e <waitx+0x52>

000000008000272c <update_time>:
...
update_time()
{
  ...
  for (p = proc; p < &proc[NPROC]; p++) {
    ...
    8000273e:	a0e48493          	addi	s1,s1,-1522 # 80012148 <proc>
    acquire(&p->lock);
    if (p->state == RUNNING) {
    80002742:	4991                	li	s3,4
  for (p = proc; p < &proc[NPROC]; p++) {
    80002744:	00016917          	auipc	s2,0x16
    80002748:	60490913          	addi	s2,s2,1540 # 80018d48 <tickslock>
    8000274c:	a811                	j	80002760 <update_time+0x34>
      p->rtime++;
    }
    release(&p->lock); 
  ...
  for (p = proc; p < &proc[NPROC]; p++) {
    ...
    8000275c:	03248063          	beq	s1,s2,8000277c <update_time+0x50>
    acquire(&p->lock);
    ...
    8000276c:	ff3791e3          	bne	a5,s3,8000274e <update_time+0x22>
      p->rtime++;
    80002770:	1744a783          	lw	a5,372(s1)
    80002774:	2785                	addiw	a5,a5,1
    80002776:	16f4aa23          	sw	a5,372(s1)
    8000277a:	bfd1                	j	8000274e <update_time+0x22>
  }
}
...
000000008000278a <actually_set_priority>:
...
int actually_set_priority(int new_priority, int pid) 
{
    ...
    80002790:	862a                	mv	a2,a0
	//printf("Tobeset=%d\n TargetPid=%d\n", new_priority, pid);
	struct proc *p;
	for (p = proc; p < &proc[NPROC]; p++)
    80002792:	00010797          	auipc	a5,0x10
    80002796:	9b678793          	addi	a5,a5,-1610 # 80012148 <proc>
    8000279a:	00016697          	auipc	a3,0x16
    8000279e:	5ae68693          	addi	a3,a3,1454 # 80018d48 <tickslock>
	{
		if(p->pid == pid)
    800027a2:	5b98                	lw	a4,48(a5)
    800027a4:	00b70863          	beq	a4,a1,800027b4 <actually_set_priority+0x2a>
	for (p = proc; p < &proc[NPROC]; p++)
    800027a8:	1b078793          	addi	a5,a5,432
    800027ac:	fed79be3          	bne	a5,a3,800027a2 <actually_set_priority+0x18>
    ...
    800027b2:	a811                	j	800027c6 <actually_set_priority+0x3c>
			int old_prio = p->static_priority;
    800027b4:	1807a503          	lw	a0,384(a5)
			p->static_priority = new_priority;
    800027b8:	18c7a023          	sw	a2,384(a5)
			p->niceness = 5;
    800027bc:	4715                	li	a4,5
    800027be:	16e7ae23          	sw	a4,380(a5)
			p->sleep_time = 0;
    800027c2:	1607ac23          	sw	zero,376(a5)
}
    800027c6:	6422                	ld	s0,8(sp)
    800027c8:	0141                	addi	sp,sp,16
    800027ca:	8082                	ret

00000000800027cc <scheduler>:
{
    ...
    800027e0:	e062                	sd	s8,0(sp)
    800027e2:	0880                	addi	s0,sp,80
    800027e4:	8792                	mv	a5,tp
  int id = r_tp();
    800027e6:	2781                	sext.w	a5,a5
  c->proc = 0;
    800027e8:	00779b13          	slli	s6,a5,0x7
    800027ec:	0000f717          	auipc	a4,0xf
    800027f0:	ab470713          	addi	a4,a4,-1356 # 800112a0 <pid_lock>
    800027f4:	975a                	add	a4,a4,s6
    800027f6:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    800027fa:	0000f717          	auipc	a4,0xf
    800027fe:	ade70713          	addi	a4,a4,-1314 # 800112d8 <cpus+0x8>
    80002802:	9b3a                	add	s6,s6,a4
  int min_priority = 10000;
    80002804:	6a89                	lui	s5,0x2
    80002806:	710a8a93          	addi	s5,s5,1808 # 2710 <_entry-0x7fffd8f0>
      if (proc[i].n_run < proc[index].n_run)
    8000280a:	00010917          	auipc	s2,0x10
    8000280e:	93e90913          	addi	s2,s2,-1730 # 80012148 <proc>
    80002812:	1b000993          	li	s3,432
        c->proc = p;
    80002816:	079e                	slli	a5,a5,0x7
    80002818:	0000fa17          	auipc	s4,0xf
    8000281c:	a88a0a13          	addi	s4,s4,-1400 # 800112a0 <pid_lock>
    80002820:	9a3e                	add	s4,s4,a5
    80002822:	a8e1                	j	800028fa <scheduler+0x12e>
    if (proc[i].dynamic_priority == min_priority)
    80002824:	02e68063          	beq	a3,a4,80002844 <scheduler+0x78>
  for (int i = 0; i < NPROC; i++)
    80002828:	2785                	addiw	a5,a5,1
    8000282a:	1b060613          	addi	a2,a2,432 # 11b0 <_entry-0x7fffee50>
    8000282e:	05078a63          	beq	a5,a6,80002882 <scheduler+0xb6>
    if (proc[i].state != RUNNABLE)
    80002832:	8532                	mv	a0,a2
    80002834:	4218                	lw	a4,0(a2)
    80002836:	ff1719e3          	bne	a4,a7,80002828 <scheduler+0x5c>
    if (proc[i].dynamic_priority < min_priority)
    8000283a:	16c62703          	lw	a4,364(a2)
    8000283e:	fed753e3          	bge	a4,a3,80002824 <scheduler+0x58>
    80002842:	84be                	mv	s1,a5
      if (proc[i].n_run < proc[index].n_run)
    80002844:	17c52583          	lw	a1,380(a0)
    80002848:	033486b3          	mul	a3,s1,s3
    8000284c:	96ca                	add	a3,a3,s2
    8000284e:	1946a683          	lw	a3,404(a3)
    80002852:	00d5d363          	bge	a1,a3,80002858 <scheduler+0x8c>
    80002856:	84be                	mv	s1,a5
      if (proc[i].n_run == proc[index].n_run)
    80002858:	033486b3          	mul	a3,s1,s3
    8000285c:	96ca                	add	a3,a3,s2
    8000285e:	1946a683          	lw	a3,404(a3)
    80002862:	00b68463          	beq	a3,a1,8000286a <scheduler+0x9e>
    80002866:	86ba                	mv	a3,a4
    80002868:	b7c1                	j	80002828 <scheduler+0x5c>
        if (proc[i].ctime < proc[index].ctime)
    8000286a:	033486b3          	mul	a3,s1,s3
    8000286e:	96ca                	add	a3,a3,s2
    80002870:	15452503          	lw	a0,340(a0)
    80002874:	16c6a583          	lw	a1,364(a3)
    80002878:	86ba                	mv	a3,a4
    8000287a:	fab557e3          	bge	a0,a1,80002828 <scheduler+0x5c>
    8000287e:	84be                	mv	s1,a5
    80002880:	b765                	j	80002828 <scheduler+0x5c>
  return &proc[index];
    80002882:	03348c33          	mul	s8,s1,s3
    80002886:	012c0bb3          	add	s7,s8,s2
      acquire(&p->lock);
    8000288a:	855e                	mv	a0,s7
    8000288c:	ffffe097          	auipc	ra,0xffffe
    80002890:	358080e7          	jalr	856(ra) # 80000be4 <acquire>
      if (p->state == RUNNABLE)
    80002894:	018ba703          	lw	a4,24(s7)
    80002898:	478d                	li	a5,3
    8000289a:	04f71b63          	bne	a4,a5,800028f0 <scheduler+0x124>
        actually_set_priority(p->dynamic_priority, p->pid);
    8000289e:	030ba583          	lw	a1,48(s7)
    800028a2:	184ba503          	lw	a0,388(s7)
    800028a6:	00000097          	auipc	ra,0x0
    800028aa:	ee4080e7          	jalr	-284(ra) # 8000278a <actually_set_priority>
        p->change_queue = 1 << p->level;
    800028ae:	188ba703          	lw	a4,392(s7)
    800028b2:	4785                	li	a5,1
    800028b4:	00e797bb          	sllw	a5,a5,a4
    800028b8:	18fba823          	sw	a5,400(s7)
        p->state = RUNNING;
    800028bc:	4791                	li	a5,4
    800028be:	00fbac23          	sw	a5,24(s7)
        c->proc = p;
    800028c2:	037a3823          	sd	s7,48(s4)
        p->q_enter = ticks;
    800028c6:	00006797          	auipc	a5,0x6
    800028ca:	7727a783          	lw	a5,1906(a5) # 80009038 <ticks>
    800028ce:	18fbac23          	sw	a5,408(s7)
        p->n_run++;
    800028d2:	194ba783          	lw	a5,404(s7)
    800028d6:	2785                	addiw	a5,a5,1
    800028d8:	18fbaa23          	sw	a5,404(s7)
        swtch(&c->context, &p->context);
    800028dc:	060c0593          	addi	a1,s8,96
    800028e0:	95ca                	add	a1,a1,s2
    800028e2:	855a                	mv	a0,s6
    800028e4:	00000097          	auipc	ra,0x0
    800028e8:	038080e7          	jalr	56(ra) # 8000291c <swtch>
        c->proc = 0;
    800028ec:	020a3823          	sd	zero,48(s4)
      release(&p->lock);
    800028f0:	855e                	mv	a0,s7
    800028f2:	ffffe097          	auipc	ra,0xffffe
    800028f6:	3a6080e7          	jalr	934(ra) # 80000c98 <release>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  for (int i = 0; i < NPROC; i++)
    80002906:	00010617          	auipc	a2,0x10
    8000290a:	85a60613          	addi	a2,a2,-1958 # 80012160 <proc+0x18>
  int index = 1;
    8000290e:	4485                	li	s1,1
  int min_priority = 10000;
    80002910:	86d6                	mv	a3,s5
  for (int i = 0; i < NPROC; i++)
    80002912:	4781                	li	a5,0
    if (proc[i].state != RUNNABLE)
    80002914:	488d                	li	a7,3
  for (int i = 0; i < NPROC; i++)
    80002916:	04000813          	li	a6,64
    8000291a:	bf21                	j	80002832 <scheduler+0x66>
...
void trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80002992:	9c258593          	addi	a1,a1,-1598 # 80008350 <states.2470+0x30>
    80002996:	00016517          	auipc	a0,0x16
    8000299a:	3b250513          	addi	a0,a0,946 # 80018d48 <tickslock>
    8000299e:	ffffe097          	auipc	ra,0xffffe
    800029a2:	1b6080e7          	jalr	438(ra) # 80000b54 <initlock>
}
...
void trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    800029b4:	00004797          	auipc	a5,0x4
    800029b8:	92c78793          	addi	a5,a5,-1748 # 800062e0 <kernelvec>
...
void usertrapret(void)
{
  ...
  struct proc *p = myproc();
    ...
    800029d2:	fe2080e7          	jalr	-30(ra) # 800019b0 <myproc>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  w_stvec(TRAMPOLINE + (uservec - trampoline));
    800029e0:	00004617          	auipc	a2,0x4
    800029e4:	62060613          	addi	a2,a2,1568 # 80007000 <_trampoline>
    800029e8:	00004697          	auipc	a3,0x4
    800029ec:	61868693          	addi	a3,a3,1560 # 80007000 <_trampoline>
    800029f0:	8e91                	sub	a3,a3,a2
    800029f2:	040007b7          	lui	a5,0x4000
    800029f6:	17fd                	addi	a5,a5,-1
    800029f8:	07b2                	slli	a5,a5,0xc
    800029fa:	96be                	add	a3,a3,a5
  asm volatile("csrw stvec, %0" : : "r" (x));
    800029fc:	10569073          	csrw	stvec,a3
  ...
  asm volatile("csrr %0, satp" : "=r" (x) );
    80002a02:	180026f3          	csrr	a3,satp
    80002a06:	e314                	sd	a3,0(a4)
  p->trapframe->kernel_sp = p->kstack + PGSIZE; // process's kernel stack
    80002a08:	6d38                	ld	a4,88(a0)
    80002a0a:	6134                	ld	a3,64(a0)
    80002a0c:	6585                	lui	a1,0x1
    80002a0e:	96ae                	add	a3,a3,a1
    80002a10:	e714                	sd	a3,8(a4)
  p->trapframe->kernel_trap = (uint64)usertrap;
    80002a12:	6d38                	ld	a4,88(a0)
    80002a14:	00000697          	auipc	a3,0x0
    80002a18:	27068693          	addi	a3,a3,624 # 80002c84 <usertrap>
    80002a1c:	eb14                	sd	a3,16(a4)
  p->trapframe->kernel_hartid = r_tp(); // hartid for cpuid()
    80002a1e:	6d38                	ld	a4,88(a0)
  asm volatile("mv %0, tp" : "=r" (x) );
    80002a20:	8692                	mv	a3,tp
    80002a22:	f314                	sd	a3,32(a4)
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002a24:	100026f3          	csrr	a3,sstatus
  ...
  x &= ~SSTATUS_SPP; // clear SPP to 0 for user mode
    80002a28:	eff6f693          	andi	a3,a3,-257
  x |= SSTATUS_SPIE; // enable interrupts in user mode
    80002a2c:	0206e693          	ori	a3,a3,32
  asm volatile("csrw sstatus, %0" : : "r" (x));
    80002a30:	10069073          	csrw	sstatus,a3
  w_sstatus(x);
  ...
  asm volatile("csrw sepc, %0" : : "r" (x));
    80002a36:	6f18                	ld	a4,24(a4)
    80002a38:	14171073          	csrw	sepc,a4

  // tell trampoline.S the user page table to switch to.
  uint64 satp = MAKE_SATP(p->pagetable);
    80002a3c:	692c                	ld	a1,80(a0)
    80002a3e:	81b1                	srli	a1,a1,0xc
  ...
  uint64 fn = TRAMPOLINE + (userret - trampoline);
    ...
    80002a44:	65070713          	addi	a4,a4,1616 # 80007090 <userret>
    80002a48:	8f11                	sub	a4,a4,a2
    80002a4a:	97ba                	add	a5,a5,a4
  ((void (*)(uint64, uint64))fn)(TRAPFRAME, satp);
    80002a4c:	577d                	li	a4,-1
    80002a4e:	177e                	slli	a4,a4,0x3f
    80002a50:	8dd9                	or	a1,a1,a4
    80002a52:	02000537          	lui	a0,0x2000
    80002a56:	157d                	addi	a0,a0,-1
    80002a58:	0536                	slli	a0,a0,0xd
    80002a5a:	9782                	jalr	a5
}
...
int min(int a, int b)
{
  ...
  if(a>b)
    ...
    80002a6c:	00a5d363          	bge	a1,a0,80002a72 <min+0xe>
    80002a70:	87ae                	mv	a5,a1
  {
    return b;
  }
  return a;
}
    80002a72:	0007851b          	sext.w	a0,a5
    80002a76:	6422                	ld	s0,8(sp)
    80002a78:	0141                	addi	sp,sp,16
    80002a7a:	8082                	ret

0000000080002a7c <max>:
...
int max(int a, int b)
{
  ...
  if(a>b)
    80002a82:	87aa                	mv	a5,a0
    80002a84:	00b55363          	bge	a0,a1,80002a8a <max+0xe>
    80002a88:	87ae                	mv	a5,a1
  {
    return a;
  }
  return b;
}
    80002a8a:	0007851b          	sext.w	a0,a5
    80002a8e:	6422                	ld	s0,8(sp)
    80002a90:	0141                	addi	sp,sp,16
    80002a92:	8082                	ret

0000000080002a94 <clockintr>:


void clockintr()
{
    80002a94:	7139                	addi	sp,sp,-64
    ...
    80002aa6:	0080                	addi	s0,sp,64
  acquire(&tickslock);
    80002aa8:	00016917          	auipc	s2,0x16
    80002aac:	2a090913          	addi	s2,s2,672 # 80018d48 <tickslock>
    80002ab0:	854a                	mv	a0,s2
    80002ab2:	ffffe097          	auipc	ra,0xffffe
    80002ab6:	132080e7          	jalr	306(ra) # 80000be4 <acquire>
  ticks++;
    80002aba:	00006497          	auipc	s1,0x6
    80002abe:	57e48493          	addi	s1,s1,1406 # 80009038 <ticks>
    80002ac2:	409c                	lw	a5,0(s1)
    80002ac4:	2785                	addiw	a5,a5,1
    80002ac6:	c09c                	sw	a5,0(s1)
  update_time();
    80002ac8:	00000097          	auipc	ra,0x0
    80002acc:	c64080e7          	jalr	-924(ra) # 8000272c <update_time>
  wakeup(&ticks);
    80002ad0:	8526                	mv	a0,s1
    80002ad2:	fffff097          	auipc	ra,0xfffff
    80002ad6:	6b0080e7          	jalr	1712(ra) # 80002182 <wakeup>
  release(&tickslock);
  ...
  if (myproc())
    ...
    80002ae8:	ecc080e7          	jalr	-308(ra) # 800019b0 <myproc>
    80002aec:	c529                	beqz	a0,80002b36 <clockintr+0xa2>
  {
    myproc()->rtime++;
    80002aee:	fffff097          	auipc	ra,0xfffff
    80002af2:	ec2080e7          	jalr	-318(ra) # 800019b0 <myproc>
    80002af6:	17452783          	lw	a5,372(a0) # 2000174 <_entry-0x7dfffe8c>
    80002afa:	2785                	addiw	a5,a5,1
    80002afc:	16f52a23          	sw	a5,372(a0)
    ...
    80002b0e:	ea6080e7          	jalr	-346(ra) # 800019b0 <myproc>
    80002b12:	18852783          	lw	a5,392(a0)
    80002b16:	078a                	slli	a5,a5,0x2
    80002b18:	97a6                	add	a5,a5,s1
    80002b1a:	19c7a703          	lw	a4,412(a5) # 400019c <_entry-0x7bfffe64>
    80002b1e:	2705                	addiw	a4,a4,1
    80002b20:	18e7ae23          	sw	a4,412(a5)
    myproc()->change_queue--;
    80002b24:	fffff097          	auipc	ra,0xfffff
    80002b28:	e8c080e7          	jalr	-372(ra) # 800019b0 <myproc>
    80002b2c:	19052783          	lw	a5,400(a0)
    80002b30:	37fd                	addiw	a5,a5,-1
    80002b32:	18f52823          	sw	a5,400(a0)
{
    80002b36:	0000f497          	auipc	s1,0xf
    80002b3a:	61248493          	addi	s1,s1,1554 # 80012148 <proc>
  struct proc *p;
  ...
  for(p = proc; p<&proc[NPROC]; p++)
  {
    acquire(&p->lock);
    if(p->state == SLEEPING)
    80002b3e:	4a09                	li	s4,2
    {
     p->sleep_time++;
    }
    if(p->state == RUNNING)
    80002b40:	4a91                	li	s5,4
    {
      p->rtime++;
    }
    ...
    80002b42:	06400993          	li	s3,100
    80002b46:	06400b13          	li	s6,100
  for(p = proc; p<&proc[NPROC]; p++)
    80002b4a:	00016917          	auipc	s2,0x16
    80002b4e:	1fe90913          	addi	s2,s2,510 # 80018d48 <tickslock>
    80002b52:	a8b1                	j	80002bae <clockintr+0x11a>
     p->sleep_time++;
    80002b54:	1784a783          	lw	a5,376(s1)
    80002b58:	2785                	addiw	a5,a5,1
    80002b5a:	16f4ac23          	sw	a5,376(s1)
    p->niceness = (p->sleep_time/(p->sleep_time + p->rtime))*10;
    80002b5e:	1784a703          	lw	a4,376(s1)
    80002b62:	1744a783          	lw	a5,372(s1)
    80002b66:	9fb9                	addw	a5,a5,a4
    80002b68:	02f7473b          	divw	a4,a4,a5
    80002b6c:	0027179b          	slliw	a5,a4,0x2
    80002b70:	9fb9                	addw	a5,a5,a4
    80002b72:	0017971b          	slliw	a4,a5,0x1
    80002b76:	16e4ae23          	sw	a4,380(s1)
    p->dynamic_priority = max(0, min(p->static_priority - p->niceness + 5, 100));
    80002b7a:	1804a783          	lw	a5,384(s1)
    80002b7e:	9f99                	subw	a5,a5,a4
    80002b80:	2795                	addiw	a5,a5,5
    80002b82:	0007871b          	sext.w	a4,a5
    80002b86:	00e9d363          	bge	s3,a4,80002b8c <clockintr+0xf8>
    80002b8a:	87da                	mv	a5,s6
    80002b8c:	0007871b          	sext.w	a4,a5
    80002b90:	fff74713          	not	a4,a4
    80002b94:	977d                	srai	a4,a4,0x3f
    80002b96:	8ff9                	and	a5,a5,a4
    80002b98:	18f4a223          	sw	a5,388(s1)
    release(&p->lock);
    80002b9c:	8526                	mv	a0,s1
    80002b9e:	ffffe097          	auipc	ra,0xffffe
    80002ba2:	0fa080e7          	jalr	250(ra) # 80000c98 <release>
  for(p = proc; p<&proc[NPROC]; p++)
    80002ba6:	1b048493          	addi	s1,s1,432
    80002baa:	03248263          	beq	s1,s2,80002bce <clockintr+0x13a>
    acquire(&p->lock);
    80002bae:	8526                	mv	a0,s1
    80002bb0:	ffffe097          	auipc	ra,0xffffe
    80002bb4:	034080e7          	jalr	52(ra) # 80000be4 <acquire>
    if(p->state == SLEEPING)
    80002bb8:	4c9c                	lw	a5,24(s1)
    80002bba:	f9478de3          	beq	a5,s4,80002b54 <clockintr+0xc0>
    if(p->state == RUNNING)
    80002bbe:	fb5790e3          	bne	a5,s5,80002b5e <clockintr+0xca>
      p->rtime++;
    80002bc2:	1744a783          	lw	a5,372(s1)
    80002bc6:	2785                	addiw	a5,a5,1
    80002bc8:	16f4aa23          	sw	a5,372(s1)
    80002bcc:	bf49                	j	80002b5e <clockintr+0xca>
    ...
    80002bda:	6aa2                	ld	s5,8(sp)
    80002bdc:	6b02                	ld	s6,0(sp)
...
int devintr()
{
  ...
  if ((scause & 0x8000000000000000L) &&
    ...
    80002c18:	7d4080e7          	jalr	2004(ra) # 800063e8 <plic_claim>
    ...
    80002c34:	72850513          	addi	a0,a0,1832 # 80008358 <states.2470+0x38>
    ...
    80002c46:	7ca080e7          	jalr	1994(ra) # 8000640c <plic_complete>
    return 1;
    ...
    80002c5c:	c94080e7          	jalr	-876(ra) # 800068ec <virtio_disk_intr>
  ...
  asm volatile("csrw sip, %0" : : "r" (x));
    ...
    80002c7e:	e1a080e7          	jalr	-486(ra) # 80002a94 <clockintr>
...
0000000080002c84 <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80002c9e:	64678793          	addi	a5,a5,1606 # 800062e0 <kernelvec>
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002cde:	418080e7          	jalr	1048(ra) # 800030f2 <syscall>
  if (p->killed)
    80002ce2:	549c                	lw	a5,40(s1)
    80002ce4:	ebc1                	bnez	a5,80002d74 <usertrap+0xf0>
  usertrapret();
    80002ce6:	00000097          	auipc	ra,0x0
    80002cea:	ce0080e7          	jalr	-800(ra) # 800029c6 <usertrapret>
}
    ...
    80002cfe:	67e50513          	addi	a0,a0,1662 # 80008378 <states.2470+0x58>
    ...
    80002d10:	546080e7          	jalr	1350(ra) # 80002252 <exit>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80002d32:	66a50513          	addi	a0,a0,1642 # 80008398 <states.2470+0x78>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002d4a:	68250513          	addi	a0,a0,1666 # 800083c8 <states.2470+0xa8>
    ...
    80002d60:	4f6080e7          	jalr	1270(ra) # 80002252 <exit>
  if (which_dev == 2)
    80002d64:	4789                	li	a5,2
    80002d66:	f8f910e3          	bne	s2,a5,80002ce6 <usertrap+0x62>
    yield();
    80002d6a:	fffff097          	auipc	ra,0xfffff
    80002d6e:	250080e7          	jalr	592(ra) # 80001fba <yield>
    80002d72:	bf95                	j	80002ce6 <usertrap+0x62>
  int which_dev = 0;
    80002d74:	4901                	li	s2,0
    80002d76:	b7d5                	j	80002d5a <usertrap+0xd6>

0000000080002d78 <kerneltrap>:
{
  ...
  asm volatile("csrr %0, sepc" : "=r" (x) );
    80002d86:	14102973          	csrr	s2,sepc
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002d8a:	100024f3          	csrr	s1,sstatus
  asm volatile("csrr %0, scause" : "=r" (x) );
    80002d8e:	142029f3          	csrr	s3,scause
  if ((sstatus & SSTATUS_SPP) == 0)
    80002d92:	1004f793          	andi	a5,s1,256
    80002d96:	cb85                	beqz	a5,80002dc6 <kerneltrap+0x4e>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002d98:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    80002d9c:	8b89                	andi	a5,a5,2
  if (intr_get() != 0)
    80002d9e:	ef85                	bnez	a5,80002dd6 <kerneltrap+0x5e>
  if ((which_dev = devintr()) == 0)
    80002da0:	00000097          	auipc	ra,0x0
    80002da4:	e42080e7          	jalr	-446(ra) # 80002be2 <devintr>
    80002da8:	cd1d                	beqz	a0,80002de6 <kerneltrap+0x6e>
  if (which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    80002daa:	4789                	li	a5,2
    80002dac:	06f50a63          	beq	a0,a5,80002e20 <kerneltrap+0xa8>
  asm volatile("csrw sepc, %0" : : "r" (x));
    80002db0:	14191073          	csrw	sepc,s2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    80002db4:	10049073          	csrw	sstatus,s1
}
    ...
    80002dca:	62250513          	addi	a0,a0,1570 # 800083e8 <states.2470+0xc8>
    80002dce:	ffffd097          	auipc	ra,0xffffd
    80002dd2:	770080e7          	jalr	1904(ra) # 8000053e <panic>
    panic("kerneltrap: interrupts enabled");
    80002dd6:	00005517          	auipc	a0,0x5
    80002dda:	63a50513          	addi	a0,a0,1594 # 80008410 <states.2470+0xf0>
    ...
    80002dec:	64850513          	addi	a0,a0,1608 # 80008430 <states.2470+0x110>
    80002df0:	ffffd097          	auipc	ra,0xffffd
    80002df4:	798080e7          	jalr	1944(ra) # 80000588 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002e04:	64050513          	addi	a0,a0,1600 # 80008440 <states.2470+0x120>
    80002e08:	ffffd097          	auipc	ra,0xffffd
    80002e0c:	780080e7          	jalr	1920(ra) # 80000588 <printf>
    panic("kerneltrap");
    80002e10:	00005517          	auipc	a0,0x5
    80002e14:	64850513          	addi	a0,a0,1608 # 80008458 <states.2470+0x138>
    80002e18:	ffffd097          	auipc	ra,0xffffd
    80002e1c:	726080e7          	jalr	1830(ra) # 8000053e <panic>
  if (which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    80002e20:	fffff097          	auipc	ra,0xfffff
    80002e24:	b90080e7          	jalr	-1136(ra) # 800019b0 <myproc>
    80002e28:	d541                	beqz	a0,80002db0 <kerneltrap+0x38>
    80002e2a:	fffff097          	auipc	ra,0xfffff
    80002e2e:	b86080e7          	jalr	-1146(ra) # 800019b0 <myproc>
    80002e32:	4d18                	lw	a4,24(a0)
    80002e34:	4791                	li	a5,4
    80002e36:	f6f71de3          	bne	a4,a5,80002db0 <kerneltrap+0x38>
    yield();
    80002e3a:	fffff097          	auipc	ra,0xfffff
    80002e3e:	180080e7          	jalr	384(ra) # 80001fba <yield>
    80002e42:	b7bd                	j	80002db0 <kerneltrap+0x38>

0000000080002e44 <argraw>:
  return strlen(buf);
}
...
argraw(int n)
{
  ...
  struct proc *p = myproc();
    ...
    80002e54:	b60080e7          	jalr	-1184(ra) # 800019b0 <myproc>
  switch (n) {
    80002e58:	4795                	li	a5,5
    80002e5a:	0497e163          	bltu	a5,s1,80002e9c <argraw+0x58>
    80002e5e:	048a                	slli	s1,s1,0x2
    80002e60:	00005717          	auipc	a4,0x5
    80002e64:	72870713          	addi	a4,a4,1832 # 80008588 <states.2470+0x268>
    80002e68:	94ba                	add	s1,s1,a4
  ...
  return -1;
    ...
    80002e80:	7fa8                	ld	a0,120(a5)
    80002e82:	bfcd                	j	80002e74 <argraw+0x30>
    return p->trapframe->a2;
    80002e84:	6d3c                	ld	a5,88(a0)
    80002e86:	63c8                	ld	a0,128(a5)
    80002e88:	b7f5                	j	80002e74 <argraw+0x30>
    return p->trapframe->a3;
    80002e8a:	6d3c                	ld	a5,88(a0)
    80002e8c:	67c8                	ld	a0,136(a5)
    80002e8e:	b7dd                	j	80002e74 <argraw+0x30>
    return p->trapframe->a4;
    80002e90:	6d3c                	ld	a5,88(a0)
    80002e92:	6bc8                	ld	a0,144(a5)
    80002e94:	b7c5                	j	80002e74 <argraw+0x30>
    return p->trapframe->a5;
    80002e96:	6d3c                	ld	a5,88(a0)
    80002e98:	6fc8                	ld	a0,152(a5)
    80002e9a:	bfe9                	j	80002e74 <argraw+0x30>
  panic("argraw");
    80002e9c:	00005517          	auipc	a0,0x5
    80002ea0:	5cc50513          	addi	a0,a0,1484 # 80008468 <states.2470+0x148>
    80002ea4:	ffffd097          	auipc	ra,0xffffd
    80002ea8:	69a080e7          	jalr	1690(ra) # 8000053e <panic>

0000000080002eac <fetchaddr>:
{
    ...
    80002eba:	892e                	mv	s2,a1
  struct proc *p = myproc();
    80002ebc:	fffff097          	auipc	ra,0xfffff
    80002ec0:	af4080e7          	jalr	-1292(ra) # 800019b0 <myproc>
  if(addr >= p->sz || addr+sizeof(uint64) > p->sz)
    80002ec4:	653c                	ld	a5,72(a0)
    80002ec6:	02f4f863          	bgeu	s1,a5,80002ef6 <fetchaddr+0x4a>
    80002eca:	00848713          	addi	a4,s1,8
    80002ece:	02e7e663          	bltu	a5,a4,80002efa <fetchaddr+0x4e>
  if(copyin(p->pagetable, (char *)ip, addr, sizeof(*ip)) != 0)
    80002ed2:	46a1                	li	a3,8
    80002ed4:	8626                	mv	a2,s1
    80002ed6:	85ca                	mv	a1,s2
    80002ed8:	6928                	ld	a0,80(a0)
    80002eda:	fffff097          	auipc	ra,0xfffff
    80002ede:	824080e7          	jalr	-2012(ra) # 800016fe <copyin>
    80002ee2:	00a03533          	snez	a0,a0
    80002ee6:	40a00533          	neg	a0,a0
}
    ...
    80002ef8:	bfcd                	j	80002eea <fetchaddr+0x3e>
    80002efa:	557d                	li	a0,-1
    80002efc:	b7fd                	j	80002eea <fetchaddr+0x3e>

0000000080002efe <fetchstr>:
{
    ...
    80002f0e:	84ae                	mv	s1,a1
    80002f10:	89b2                	mv	s3,a2
  struct proc *p = myproc();
    80002f12:	fffff097          	auipc	ra,0xfffff
    80002f16:	a9e080e7          	jalr	-1378(ra) # 800019b0 <myproc>
  int err = copyinstr(p->pagetable, buf, addr, max);
    80002f1a:	86ce                	mv	a3,s3
    80002f1c:	864a                	mv	a2,s2
    80002f1e:	85a6                	mv	a1,s1
    80002f20:	6928                	ld	a0,80(a0)
    80002f22:	fffff097          	auipc	ra,0xfffff
    80002f26:	868080e7          	jalr	-1944(ra) # 8000178a <copyinstr>
  if(err < 0)
    80002f2a:	00054763          	bltz	a0,80002f38 <fetchstr+0x3a>
  return strlen(buf);
    80002f2e:	8526                	mv	a0,s1
    80002f30:	ffffe097          	auipc	ra,0xffffe
    80002f34:	f34080e7          	jalr	-204(ra) # 80000e64 <strlen>
}
...
argint(int n, int *ip)
{
  ...
  *ip = argraw(n);
    ...
    80002f56:	ef2080e7          	jalr	-270(ra) # 80002e44 <argraw>
    80002f5a:	c088                	sw	a0,0(s1)
  return 0;
}
...
argaddr(int n, uint64 *ip)
{
  ...
  *ip = argraw(n);
    ...
    80002f78:	ed0080e7          	jalr	-304(ra) # 80002e44 <argraw>
    80002f7c:	e088                	sd	a0,0(s1)
  return 0;
}
...
argstr(int n, char *buf, int max)
{
    ...
    80002f98:	8932                	mv	s2,a2
  *ip = argraw(n);
    80002f9a:	00000097          	auipc	ra,0x0
    80002f9e:	eaa080e7          	jalr	-342(ra) # 80002e44 <argraw>
  uint64 addr;
  if(argaddr(n, &addr) < 0)
    return -1;
  return fetchstr(addr, buf, max);
    80002fa2:	864a                	mv	a2,s2
    80002fa4:	85a6                	mv	a1,s1
    80002fa6:	00000097          	auipc	ra,0x0
    80002faa:	f58080e7          	jalr	-168(ra) # 80002efe <fetchstr>
}
...
0000000080002fba <SyscallNamesArray>:
[SYS_waitx]   sys_waitx,
...
void SyscallNamesArray(char *names[NELEM(syscalls)])
{
  ...
  names[1] = "fork";
    80002fc0:	00005797          	auipc	a5,0x5
    80002fc4:	4b078793          	addi	a5,a5,1200 # 80008470 <states.2470+0x150>
    80002fc8:	e51c                	sd	a5,8(a0)
  names[2] = "exit";
    80002fca:	00005797          	auipc	a5,0x5
    80002fce:	4ae78793          	addi	a5,a5,1198 # 80008478 <states.2470+0x158>
    80002fd2:	e91c                	sd	a5,16(a0)
  names[3] = "wait";
    80002fd4:	00005797          	auipc	a5,0x5
    80002fd8:	4ac78793          	addi	a5,a5,1196 # 80008480 <states.2470+0x160>
    80002fdc:	ed1c                	sd	a5,24(a0)
  names[4] = "pipe";
    80002fde:	00005797          	auipc	a5,0x5
    80002fe2:	4aa78793          	addi	a5,a5,1194 # 80008488 <states.2470+0x168>
    80002fe6:	f11c                	sd	a5,32(a0)
  names[5] = "read";
    80002fe8:	00005797          	auipc	a5,0x5
    80002fec:	7a078793          	addi	a5,a5,1952 # 80008788 <syscalls+0x1e8>
    80002ff0:	f51c                	sd	a5,40(a0)
  names[6] = "kill";
    80002ff2:	00005797          	auipc	a5,0x5
    80002ff6:	49e78793          	addi	a5,a5,1182 # 80008490 <states.2470+0x170>
    80002ffa:	f91c                	sd	a5,48(a0)
  names[7] = "exec";
    80002ffc:	00005797          	auipc	a5,0x5
    80003000:	49c78793          	addi	a5,a5,1180 # 80008498 <states.2470+0x178>
    80003004:	fd1c                	sd	a5,56(a0)
  names[8] = "fstat";
    80003006:	00005797          	auipc	a5,0x5
    8000300a:	49a78793          	addi	a5,a5,1178 # 800084a0 <states.2470+0x180>
    8000300e:	e13c                	sd	a5,64(a0)
  names[9] = "chdir";
    80003010:	00005797          	auipc	a5,0x5
    80003014:	49878793          	addi	a5,a5,1176 # 800084a8 <states.2470+0x188>
    80003018:	e53c                	sd	a5,72(a0)
  names[10] = "dup";
    8000301a:	00005797          	auipc	a5,0x5
    8000301e:	49678793          	addi	a5,a5,1174 # 800084b0 <states.2470+0x190>
    80003022:	e93c                	sd	a5,80(a0)
  names[11] = "getpid";
    80003024:	00005797          	auipc	a5,0x5
    80003028:	49478793          	addi	a5,a5,1172 # 800084b8 <states.2470+0x198>
    8000302c:	ed3c                	sd	a5,88(a0)
  names[12] = "sbrk";
    8000302e:	00005797          	auipc	a5,0x5
    80003032:	49278793          	addi	a5,a5,1170 # 800084c0 <states.2470+0x1a0>
    80003036:	f13c                	sd	a5,96(a0)
  names[13] = "sleep";
    80003038:	00005797          	auipc	a5,0x5
    8000303c:	49078793          	addi	a5,a5,1168 # 800084c8 <states.2470+0x1a8>
    80003040:	f53c                	sd	a5,104(a0)
  names[14] = "uptime";
    80003042:	00005797          	auipc	a5,0x5
    80003046:	48e78793          	addi	a5,a5,1166 # 800084d0 <states.2470+0x1b0>
    8000304a:	f93c                	sd	a5,112(a0)
  names[15] = "open";
    8000304c:	00005797          	auipc	a5,0x5
    80003050:	48c78793          	addi	a5,a5,1164 # 800084d8 <states.2470+0x1b8>
    80003054:	fd3c                	sd	a5,120(a0)
  names[16] = "write";
    80003056:	00005797          	auipc	a5,0x5
    8000305a:	48a78793          	addi	a5,a5,1162 # 800084e0 <states.2470+0x1c0>
    8000305e:	e15c                	sd	a5,128(a0)
  names[17] = "mknod";
    80003060:	00005797          	auipc	a5,0x5
    80003064:	48878793          	addi	a5,a5,1160 # 800084e8 <states.2470+0x1c8>
    80003068:	e55c                	sd	a5,136(a0)
  names[18] = "unlink";
    8000306a:	00005797          	auipc	a5,0x5
    8000306e:	48678793          	addi	a5,a5,1158 # 800084f0 <states.2470+0x1d0>
    80003072:	e95c                	sd	a5,144(a0)
  names[19] = "link";
    80003074:	00005797          	auipc	a5,0x5
    80003078:	48478793          	addi	a5,a5,1156 # 800084f8 <states.2470+0x1d8>
    8000307c:	ed5c                	sd	a5,152(a0)
  names[20] = "mkdir";
    8000307e:	00005797          	auipc	a5,0x5
    80003082:	48278793          	addi	a5,a5,1154 # 80008500 <states.2470+0x1e0>
    80003086:	f15c                	sd	a5,160(a0)
  names[21] = "close";
    80003088:	00005797          	auipc	a5,0x5
    8000308c:	48078793          	addi	a5,a5,1152 # 80008508 <states.2470+0x1e8>
    80003090:	f55c                	sd	a5,168(a0)
  names[22] = "trace";
    80003092:	00005797          	auipc	a5,0x5
    80003096:	47e78793          	addi	a5,a5,1150 # 80008510 <states.2470+0x1f0>
    8000309a:	f95c                	sd	a5,176(a0)
  names[23] = "set_priority";
    8000309c:	00005797          	auipc	a5,0x5
    800030a0:	47c78793          	addi	a5,a5,1148 # 80008518 <states.2470+0x1f8>
    800030a4:	fd5c                	sd	a5,184(a0)
}
    800030a6:	6422                	ld	s0,8(sp)
    800030a8:	0141                	addi	sp,sp,16
    800030aa:	8082                	ret

00000000800030ac <ArgumentCount>:

void ArgumentCount(int *count)
{
    800030ac:	1141                	addi	sp,sp,-16
    800030ae:	e422                	sd	s0,8(sp)
    800030b0:	0800                	addi	s0,sp,16
  count[1] = 0;
    800030b2:	00052223          	sw	zero,4(a0)
  count[2] = 1;
    800030b6:	4785                	li	a5,1
    800030b8:	c51c                	sw	a5,8(a0)
  count[3] = 1;
    800030ba:	c55c                	sw	a5,12(a0)
  count[4] = 0;
    800030bc:	00052823          	sw	zero,16(a0)
  count[5] = 3;
    800030c0:	468d                	li	a3,3
    800030c2:	c954                	sw	a3,20(a0)
  count[6] = 2;
    800030c4:	4709                	li	a4,2
    800030c6:	cd18                	sw	a4,24(a0)
  count[7] = 2;
    800030c8:	cd58                	sw	a4,28(a0)
  count[8] = 1;
    800030ca:	d11c                	sw	a5,32(a0)
  count[9] = 1;
    800030cc:	d15c                	sw	a5,36(a0)
  count[10] = 1;
    800030ce:	d51c                	sw	a5,40(a0)
  count[11] = 0;
    800030d0:	02052623          	sw	zero,44(a0)
  count[12] = 1;
    800030d4:	d91c                	sw	a5,48(a0)
  count[13] = 1;
    800030d6:	d95c                	sw	a5,52(a0)
  count[14] = 0;
    800030d8:	02052c23          	sw	zero,56(a0)
  count[15] = 2;
    800030dc:	dd58                	sw	a4,60(a0)
  count[16] = 3;
    800030de:	c134                	sw	a3,64(a0)
  count[17] = 3;
    800030e0:	c174                	sw	a3,68(a0)
  count[18] = 1;
    800030e2:	c53c                	sw	a5,72(a0)
  count[19] = 2;
    800030e4:	c578                	sw	a4,76(a0)
  count[20] = 1;
    800030e6:	c93c                	sw	a5,80(a0)
  count[21] = 1;
    800030e8:	c97c                	sw	a5,84(a0)
  count[22] = 1;
    800030ea:	cd3c                	sw	a5,88(a0)
}
    800030ec:	6422                	ld	s0,8(sp)
...
syscall(void)
{
    800030f2:	7149                	addi	sp,sp,-368
    800030f4:	f686                	sd	ra,360(sp)
    800030f6:	f2a2                	sd	s0,352(sp)
    800030f8:	eea6                	sd	s1,344(sp)
    800030fa:	eaca                	sd	s2,336(sp)
    800030fc:	e6ce                	sd	s3,328(sp)
    800030fe:	e2d2                	sd	s4,320(sp)
    80003100:	fe56                	sd	s5,312(sp)
    80003102:	fa5a                	sd	s6,304(sp)
    80003104:	1a80                	addi	s0,sp,368
  char *names[25];
  SyscallNamesArray(names);
    80003106:	ef840513          	addi	a0,s0,-264
    8000310a:	00000097          	auipc	ra,0x0
    8000310e:	eb0080e7          	jalr	-336(ra) # 80002fba <SyscallNamesArray>
  int count[25];
  ArgumentCount(count);
    80003112:	e9040513          	addi	a0,s0,-368
    80003116:	00000097          	auipc	ra,0x0
    8000311a:	f96080e7          	jalr	-106(ra) # 800030ac <ArgumentCount>
  int num;
  struct proc *p = myproc();
  ...
  num = p->trapframe->a7;
    80003128:	05853903          	ld	s2,88(a0)
    8000312c:	0a893783          	ld	a5,168(s2)
    80003130:	0007899b          	sext.w	s3,a5
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) 
    80003134:	37fd                	addiw	a5,a5,-1
    80003136:	475d                	li	a4,23
    80003138:	0ef76663          	bltu	a4,a5,80003224 <syscall+0x132>
    8000313c:	00399713          	slli	a4,s3,0x3
    80003140:	00005797          	auipc	a5,0x5
    80003144:	46078793          	addi	a5,a5,1120 # 800085a0 <syscalls>
    80003148:	97ba                	add	a5,a5,a4
    8000314a:	639c                	ld	a5,0(a5)
    8000314c:	cfe1                	beqz	a5,80003224 <syscall+0x132>
  {
    int arg1 = p->trapframe->a0;
    8000314e:	07093a03          	ld	s4,112(s2)
    int arg2 = p->trapframe->a1;
    80003152:	07893a83          	ld	s5,120(s2)
    int arg3 = p->trapframe->a2;
    80003156:	08093b03          	ld	s6,128(s2)
    p->trapframe->a0 = syscalls[num]();
    8000315a:	9782                	jalr	a5
    8000315c:	06a93823          	sd	a0,112(s2)
    int mask = p->mask;
    if((mask >> num) &0x1 )
    80003160:	1684a783          	lw	a5,360(s1)
    80003164:	4137d7bb          	sraw	a5,a5,s3
    80003168:	8b85                	andi	a5,a5,1
    8000316a:	cfe1                	beqz	a5,80003242 <syscall+0x150>
    int arg1 = p->trapframe->a0;
    8000316c:	2a01                	sext.w	s4,s4
    {
    ...
    8000316e:	00399793          	slli	a5,s3,0x3
    80003172:	fc040713          	addi	a4,s0,-64
    80003176:	97ba                	add	a5,a5,a4
    80003178:	f387b603          	ld	a2,-200(a5)
    8000317c:	588c                	lw	a1,48(s1)
    8000317e:	00005517          	auipc	a0,0x5
    80003182:	3aa50513          	addi	a0,a0,938 # 80008528 <states.2470+0x208>
    80003186:	ffffd097          	auipc	ra,0xffffd
    8000318a:	402080e7          	jalr	1026(ra) # 80000588 <printf>
      if(count[num] == 1)
    8000318e:	00299793          	slli	a5,s3,0x2
    80003192:	fc040713          	addi	a4,s0,-64
    80003196:	97ba                	add	a5,a5,a4
    80003198:	ed07a703          	lw	a4,-304(a5)
    8000319c:	4785                	li	a5,1
    8000319e:	04f70163          	beq	a4,a5,800031e0 <syscall+0xee>
    int arg2 = p->trapframe->a1;
    800031a2:	2a81                	sext.w	s5,s5
      {
       printf("%d", arg1); 
      }
      if(count[num] == 2)
    800031a4:	00299793          	slli	a5,s3,0x2
    800031a8:	fc040713          	addi	a4,s0,-64
    800031ac:	97ba                	add	a5,a5,a4
    800031ae:	ed07a703          	lw	a4,-304(a5)
    800031b2:	4789                	li	a5,2
    800031b4:	04f70063          	beq	a4,a5,800031f4 <syscall+0x102>
      {
        printf("%d %d", arg1, arg2);
      }
      if(count[num] == 3)
    800031b8:	098a                	slli	s3,s3,0x2
    800031ba:	fc040793          	addi	a5,s0,-64
    800031be:	99be                	add	s3,s3,a5
    800031c0:	ed09a703          	lw	a4,-304(s3)
    800031c4:	478d                	li	a5,3
    800031c6:	04f70263          	beq	a4,a5,8000320a <syscall+0x118>
      {
        printf("%d %d %d", arg1, arg2, arg3);
      }
      printf(") ->%d\n",p->trapframe->a0);
    800031ca:	6cbc                	ld	a5,88(s1)
    800031cc:	7bac                	ld	a1,112(a5)
    800031ce:	00005517          	auipc	a0,0x5
    800031d2:	39250513          	addi	a0,a0,914 # 80008560 <states.2470+0x240>
    800031d6:	ffffd097          	auipc	ra,0xffffd
    800031da:	3b2080e7          	jalr	946(ra) # 80000588 <printf>
    800031de:	a095                	j	80003242 <syscall+0x150>
       printf("%d", arg1); 
    800031e0:	85d2                	mv	a1,s4
    800031e2:	00005517          	auipc	a0,0x5
    800031e6:	35e50513          	addi	a0,a0,862 # 80008540 <states.2470+0x220>
    800031ea:	ffffd097          	auipc	ra,0xffffd
    800031ee:	39e080e7          	jalr	926(ra) # 80000588 <printf>
    800031f2:	bf45                	j	800031a2 <syscall+0xb0>
        printf("%d %d", arg1, arg2);
    800031f4:	8656                	mv	a2,s5
    800031f6:	85d2                	mv	a1,s4
    800031f8:	00005517          	auipc	a0,0x5
    800031fc:	35050513          	addi	a0,a0,848 # 80008548 <states.2470+0x228>
    80003200:	ffffd097          	auipc	ra,0xffffd
    80003204:	388080e7          	jalr	904(ra) # 80000588 <printf>
    80003208:	bf45                	j	800031b8 <syscall+0xc6>
        printf("%d %d %d", arg1, arg2, arg3);
    8000320a:	000b069b          	sext.w	a3,s6
    8000320e:	8656                	mv	a2,s5
    80003210:	85d2                	mv	a1,s4
    80003212:	00005517          	auipc	a0,0x5
    80003216:	33e50513          	addi	a0,a0,830 # 80008550 <states.2470+0x230>
    8000321a:	ffffd097          	auipc	ra,0xffffd
    8000321e:	36e080e7          	jalr	878(ra) # 80000588 <printf>
    80003222:	b765                	j	800031ca <syscall+0xd8>
    }
  } 
  else 
  {
    printf("%d %s: unknown sys call %d\n",
    80003224:	86ce                	mv	a3,s3
    80003226:	15848613          	addi	a2,s1,344
    8000322a:	588c                	lw	a1,48(s1)
    8000322c:	00005517          	auipc	a0,0x5
    80003230:	33c50513          	addi	a0,a0,828 # 80008568 <states.2470+0x248>
    80003234:	ffffd097          	auipc	ra,0xffffd
    80003238:	354080e7          	jalr	852(ra) # 80000588 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
    8000323c:	6cbc                	ld	a5,88(s1)
    8000323e:	577d                	li	a4,-1
    80003240:	fbb8                	sd	a4,112(a5)
  }
}
    80003242:	70b6                	ld	ra,360(sp)
    80003244:	7416                	ld	s0,352(sp)
    80003246:	64f6                	ld	s1,344(sp)
    80003248:	6956                	ld	s2,336(sp)
    8000324a:	69b6                	ld	s3,328(sp)
    8000324c:	6a16                	ld	s4,320(sp)
    8000324e:	7af2                	ld	s5,312(sp)
    80003250:	7b52                	ld	s6,304(sp)
    80003252:	6175                	addi	sp,sp,368
    80003254:	8082                	ret
...
sys_exit(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80003268:	ce2080e7          	jalr	-798(ra) # 80002f46 <argint>
    return -1;
    8000326c:	57fd                	li	a5,-1
  if(argint(0, &n) < 0)
    8000326e:	00054963          	bltz	a0,80003280 <sys_exit+0x2a>
  exit(n);
    80003272:	fec42503          	lw	a0,-20(s0)
    80003276:	fffff097          	auipc	ra,0xfffff
    8000327a:	fdc080e7          	jalr	-36(ra) # 80002252 <exit>
...
000000008000328a <sys_getpid>:

uint64
sys_getpid(void)
{
    8000328a:	1141                	addi	sp,sp,-16
    8000328c:	e406                	sd	ra,8(sp)
    8000328e:	e022                	sd	s0,0(sp)
    80003290:	0800                	addi	s0,sp,16
  return myproc()->pid;
    80003292:	ffffe097          	auipc	ra,0xffffe
    80003296:	71e080e7          	jalr	1822(ra) # 800019b0 <myproc>
}
    8000329a:	5908                	lw	a0,48(a0)
    8000329c:	60a2                	ld	ra,8(sp)
    8000329e:	6402                	ld	s0,0(sp)
    800032a0:	0141                	addi	sp,sp,16
    800032a2:	8082                	ret

00000000800032a4 <sys_fork>:
...
sys_fork(void)
{
  ...
  return fork();
    ...
    800032b0:	af4080e7          	jalr	-1292(ra) # 80001da0 <fork>
}
...
sys_wait(void)
{
  ...
  if(argaddr(0, &p) < 0)
    ...
    800032ce:	c9e080e7          	jalr	-866(ra) # 80002f68 <argaddr>
    800032d2:	87aa                	mv	a5,a0
    return -1;
    800032d4:	557d                	li	a0,-1
  if(argaddr(0, &p) < 0)
    800032d6:	0007c863          	bltz	a5,800032e6 <sys_wait+0x2a>
  return wait(p);
    800032da:	fe843503          	ld	a0,-24(s0)
    800032de:	fffff097          	auipc	ra,0xfffff
    800032e2:	d7c080e7          	jalr	-644(ra) # 8000205a <wait>
}
...
sys_sbrk(void)
{
  ...
  if(argint(0, &n) < 0)
    800032f8:	fdc40593          	addi	a1,s0,-36
    800032fc:	4501                	li	a0,0
    800032fe:	00000097          	auipc	ra,0x0
    80003302:	c48080e7          	jalr	-952(ra) # 80002f46 <argint>
    80003306:	87aa                	mv	a5,a0
    return -1;
    80003308:	557d                	li	a0,-1
  if(argint(0, &n) < 0)
    8000330a:	0207c063          	bltz	a5,8000332a <sys_sbrk+0x3c>
  addr = myproc()->sz;
    8000330e:	ffffe097          	auipc	ra,0xffffe
    80003312:	6a2080e7          	jalr	1698(ra) # 800019b0 <myproc>
    80003316:	4524                	lw	s1,72(a0)
  if(growproc(n) < 0)
    80003318:	fdc42503          	lw	a0,-36(s0)
    8000331c:	fffff097          	auipc	ra,0xfffff
    80003320:	a10080e7          	jalr	-1520(ra) # 80001d2c <growproc>
    80003324:	00054863          	bltz	a0,80003334 <sys_sbrk+0x46>
    return -1;
  return addr;
    ...
    80003336:	bfd5                	j	8000332a <sys_sbrk+0x3c>

0000000080003338 <sys_sleep>:
...
sys_sleep(void)
{
  ...
  if(argint(0, &n) < 0)
    80003346:	fcc40593          	addi	a1,s0,-52
    8000334a:	4501                	li	a0,0
    8000334c:	00000097          	auipc	ra,0x0
    80003350:	bfa080e7          	jalr	-1030(ra) # 80002f46 <argint>
    return -1;
    80003354:	57fd                	li	a5,-1
  if(argint(0, &n) < 0)
    80003356:	06054563          	bltz	a0,800033c0 <sys_sleep+0x88>
  acquire(&tickslock);
    8000335a:	00016517          	auipc	a0,0x16
    8000335e:	9ee50513          	addi	a0,a0,-1554 # 80018d48 <tickslock>
    80003362:	ffffe097          	auipc	ra,0xffffe
    80003366:	882080e7          	jalr	-1918(ra) # 80000be4 <acquire>
  ticks0 = ticks;
    8000336a:	00006917          	auipc	s2,0x6
    8000336e:	cce92903          	lw	s2,-818(s2) # 80009038 <ticks>
  while(ticks - ticks0 < n){
    80003372:	fcc42783          	lw	a5,-52(s0)
    80003376:	cf85                	beqz	a5,800033ae <sys_sleep+0x76>
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
    80003378:	00016997          	auipc	s3,0x16
    8000337c:	9d098993          	addi	s3,s3,-1584 # 80018d48 <tickslock>
    80003380:	00006497          	auipc	s1,0x6
    80003384:	cb848493          	addi	s1,s1,-840 # 80009038 <ticks>
    if(myproc()->killed){
    80003388:	ffffe097          	auipc	ra,0xffffe
    8000338c:	628080e7          	jalr	1576(ra) # 800019b0 <myproc>
    80003390:	551c                	lw	a5,40(a0)
    80003392:	ef9d                	bnez	a5,800033d0 <sys_sleep+0x98>
    sleep(&ticks, &tickslock);
    80003394:	85ce                	mv	a1,s3
    80003396:	8526                	mv	a0,s1
    80003398:	fffff097          	auipc	ra,0xfffff
    8000339c:	c5e080e7          	jalr	-930(ra) # 80001ff6 <sleep>
  while(ticks - ticks0 < n){
    800033a0:	409c                	lw	a5,0(s1)
    800033a2:	412787bb          	subw	a5,a5,s2
    800033a6:	fcc42703          	lw	a4,-52(s0)
    800033aa:	fce7efe3          	bltu	a5,a4,80003388 <sys_sleep+0x50>
  }
  release(&tickslock);
  ...
  return 0;
    ...
    800033c2:	70e2                	ld	ra,56(sp)
    800033c4:	7442                	ld	s0,48(sp)
    800033c6:	74a2                	ld	s1,40(sp)
    800033c8:	7902                	ld	s2,32(sp)
    800033ca:	69e2                	ld	s3,24(sp)
    800033cc:	6121                	addi	sp,sp,64
    800033ce:	8082                	ret
      release(&tickslock);
    800033d0:	00016517          	auipc	a0,0x16
    800033d4:	97850513          	addi	a0,a0,-1672 # 80018d48 <tickslock>
    800033d8:	ffffe097          	auipc	ra,0xffffe
    800033dc:	8c0080e7          	jalr	-1856(ra) # 80000c98 <release>
      return -1;
    800033e0:	57fd                	li	a5,-1
    800033e2:	bff9                	j	800033c0 <sys_sleep+0x88>

00000000800033e4 <sys_kill>:
...
sys_kill(void)
{
  ...
  if(argint(0, &pid) < 0)
    800033ec:	fec40593          	addi	a1,s0,-20
    800033f0:	4501                	li	a0,0
    800033f2:	00000097          	auipc	ra,0x0
    800033f6:	b54080e7          	jalr	-1196(ra) # 80002f46 <argint>
    800033fa:	87aa                	mv	a5,a0
    return -1;
    800033fc:	557d                	li	a0,-1
  if(argint(0, &pid) < 0)
    800033fe:	0007c863          	bltz	a5,8000340e <sys_kill+0x2a>
  return kill(pid);
    80003402:	fec42503          	lw	a0,-20(s0)
    80003406:	fffff097          	auipc	ra,0xfffff
    8000340a:	f2e080e7          	jalr	-210(ra) # 80002334 <kill>
}
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    80003420:	00016517          	auipc	a0,0x16
    80003424:	92850513          	addi	a0,a0,-1752 # 80018d48 <tickslock>
    80003428:	ffffd097          	auipc	ra,0xffffd
    8000342c:	7bc080e7          	jalr	1980(ra) # 80000be4 <acquire>
  xticks = ticks;
    80003430:	00006497          	auipc	s1,0x6
    80003434:	c084a483          	lw	s1,-1016(s1) # 80009038 <ticks>
  release(&tickslock);
    80003438:	00016517          	auipc	a0,0x16
    8000343c:	91050513          	addi	a0,a0,-1776 # 80018d48 <tickslock>
    80003440:	ffffe097          	auipc	ra,0xffffe
    80003444:	858080e7          	jalr	-1960(ra) # 80000c98 <release>
  return xticks;
}
    80003448:	02049513          	slli	a0,s1,0x20
    8000344c:	9101                	srli	a0,a0,0x20
...
sys_trace(void)
{
  ...
  int mask=0;
    80003460:	fe042623          	sw	zero,-20(s0)
  if(argint(0,&mask)<0)
    80003464:	fec40593          	addi	a1,s0,-20
    80003468:	4501                	li	a0,0
    8000346a:	00000097          	auipc	ra,0x0
    8000346e:	adc080e7          	jalr	-1316(ra) # 80002f46 <argint>
  {
    return -1;
    80003472:	57fd                	li	a5,-1
  if(argint(0,&mask)<0)
    80003474:	00054b63          	bltz	a0,8000348a <sys_trace+0x32>
  }
  myproc()->mask = mask;
    80003478:	ffffe097          	auipc	ra,0xffffe
    8000347c:	538080e7          	jalr	1336(ra) # 800019b0 <myproc>
    80003480:	fec42783          	lw	a5,-20(s0)
    80003484:	16f52423          	sw	a5,360(a0)
  return 0;
...
sys_waitx(void)
{
  ...
  uint wtime, rtime;
  if(argaddr(0, &addr) < 0)
    800034a0:	fd840593          	addi	a1,s0,-40
    800034a4:	4501                	li	a0,0
    800034a6:	00000097          	auipc	ra,0x0
    800034aa:	ac2080e7          	jalr	-1342(ra) # 80002f68 <argaddr>
    return -1;
    800034ae:	57fd                	li	a5,-1
  if(argaddr(0, &addr) < 0)
    800034b0:	08054063          	bltz	a0,80003530 <sys_waitx+0x9c>
  if(argaddr(1, &addr1) < 0) // user virtual memory
    800034b4:	fd040593          	addi	a1,s0,-48
    800034b8:	4505                	li	a0,1
    800034ba:	00000097          	auipc	ra,0x0
    800034be:	aae080e7          	jalr	-1362(ra) # 80002f68 <argaddr>
    return -1;
    800034c2:	57fd                	li	a5,-1
  if(argaddr(1, &addr1) < 0) // user virtual memory
    800034c4:	06054663          	bltz	a0,80003530 <sys_waitx+0x9c>
  if(argaddr(2, &addr2) < 0)
    800034c8:	fc840593          	addi	a1,s0,-56
    800034cc:	4509                	li	a0,2
    800034ce:	00000097          	auipc	ra,0x0
    800034d2:	a9a080e7          	jalr	-1382(ra) # 80002f68 <argaddr>
    return -1;
    800034d6:	57fd                	li	a5,-1
  if(argaddr(2, &addr2) < 0)
    800034d8:	04054c63          	bltz	a0,80003530 <sys_waitx+0x9c>
  int ret = waitx(addr, &wtime, &rtime);
    800034dc:	fc040613          	addi	a2,s0,-64
    800034e0:	fc440593          	addi	a1,s0,-60
    800034e4:	fd843503          	ld	a0,-40(s0)
    800034e8:	fffff097          	auipc	ra,0xfffff
    800034ec:	0f4080e7          	jalr	244(ra) # 800025dc <waitx>
    800034f0:	892a                	mv	s2,a0
  struct proc* p = myproc();
    800034f2:	ffffe097          	auipc	ra,0xffffe
    800034f6:	4be080e7          	jalr	1214(ra) # 800019b0 <myproc>
    800034fa:	84aa                	mv	s1,a0
  if (copyout(p->pagetable, addr1,(char*)&wtime, sizeof(int)) < 0)
    800034fc:	4691                	li	a3,4
    800034fe:	fc440613          	addi	a2,s0,-60
    80003502:	fd043583          	ld	a1,-48(s0)
    80003506:	6928                	ld	a0,80(a0)
    80003508:	ffffe097          	auipc	ra,0xffffe
    8000350c:	16a080e7          	jalr	362(ra) # 80001672 <copyout>
    return -1;
    80003510:	57fd                	li	a5,-1
  if (copyout(p->pagetable, addr1,(char*)&wtime, sizeof(int)) < 0)
    80003512:	00054f63          	bltz	a0,80003530 <sys_waitx+0x9c>
  if (copyout(p->pagetable, addr2,(char*)&rtime, sizeof(int)) < 0)
    80003516:	4691                	li	a3,4
    80003518:	fc040613          	addi	a2,s0,-64
    8000351c:	fc843583          	ld	a1,-56(s0)
    80003520:	68a8                	ld	a0,80(s1)
    80003522:	ffffe097          	auipc	ra,0xffffe
    80003526:	150080e7          	jalr	336(ra) # 80001672 <copyout>
    8000352a:	00054a63          	bltz	a0,8000353e <sys_waitx+0xaa>
    return -1;
  return ret;
    8000352e:	87ca                	mv	a5,s2
}
    80003530:	853e                	mv	a0,a5
    80003532:	70e2                	ld	ra,56(sp)
    80003534:	7442                	ld	s0,48(sp)
    80003536:	74a2                	ld	s1,40(sp)
    80003538:	7902                	ld	s2,32(sp)
    8000353a:	6121                	addi	sp,sp,64
    8000353c:	8082                	ret
    return -1;
    8000353e:	57fd                	li	a5,-1
    80003540:	bfc5                	j	80003530 <sys_waitx+0x9c>

0000000080003542 <sys_set_priority>:
...
sys_set_priority(void)
{
    ...
    8000354a:	fec40593          	addi	a1,s0,-20
    8000354e:	4501                	li	a0,0
    80003550:	00000097          	auipc	ra,0x0
    80003554:	9f6080e7          	jalr	-1546(ra) # 80002f46 <argint>
		return -1;
    80003558:	57fd                	li	a5,-1
	if (argint(0, &new_priority) < 0) 
    8000355a:	02054b63          	bltz	a0,80003590 <sys_set_priority+0x4e>
	
	if (argint(1, &pid) < 0) 
    8000355e:	fe840593          	addi	a1,s0,-24
    80003562:	4505                	li	a0,1
    80003564:	00000097          	auipc	ra,0x0
    80003568:	9e2080e7          	jalr	-1566(ra) # 80002f46 <argint>
    8000356c:	02054763          	bltz	a0,8000359a <sys_set_priority+0x58>
		return -1;
	
	if (new_priority > 100 || new_priority < 0) 
    80003570:	fec42503          	lw	a0,-20(s0)
    80003574:	0005069b          	sext.w	a3,a0
    80003578:	06400713          	li	a4,100
		return -1;
    8000357c:	57fd                	li	a5,-1
	if (new_priority > 100 || new_priority < 0) 
    8000357e:	00d76963          	bltu	a4,a3,80003590 <sys_set_priority+0x4e>
	

	return actually_set_priority(new_priority, pid);
    80003582:	fe842583          	lw	a1,-24(s0)
    80003586:	fffff097          	auipc	ra,0xfffff
    8000358a:	204080e7          	jalr	516(ra) # 8000278a <actually_set_priority>
    ...
    80003598:	8082                	ret
		return -1;
    8000359a:	57fd                	li	a5,-1
    8000359c:	bfd5                	j	80003590 <sys_set_priority+0x4e>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800035b2:	0ba58593          	addi	a1,a1,186 # 80008668 <syscalls+0xc8>
    800035b6:	00015517          	auipc	a0,0x15
    800035ba:	7aa50513          	addi	a0,a0,1962 # 80018d60 <bcache>
    800035be:	ffffd097          	auipc	ra,0xffffd
    800035c2:	596080e7          	jalr	1430(ra) # 80000b54 <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    800035c6:	0001d797          	auipc	a5,0x1d
    800035ca:	79a78793          	addi	a5,a5,1946 # 80020d60 <bcache+0x8000>
    800035ce:	0001e717          	auipc	a4,0x1e
    800035d2:	9fa70713          	addi	a4,a4,-1542 # 80020fc8 <bcache+0x8268>
    800035d6:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    800035da:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    800035de:	00015497          	auipc	s1,0x15
    800035e2:	79a48493          	addi	s1,s1,1946 # 80018d78 <bcache+0x18>
    ...
    800035ee:	086a0a13          	addi	s4,s4,134 # 80008670 <syscalls+0xd0>
    b->next = bcache.head.next;
    ...
    80003606:	4bc080e7          	jalr	1212(ra) # 80004abe <initsleeplock>
...
bread(uint dev, uint blockno)
{
    ...
    8000363c:	892e                	mv	s2,a1
  acquire(&bcache.lock);
    8000363e:	00015517          	auipc	a0,0x15
    80003642:	72250513          	addi	a0,a0,1826 # 80018d60 <bcache>
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80003652:	9ca4b483          	ld	s1,-1590(s1) # 80021018 <bcache+0x82b8>
    80003656:	0001e797          	auipc	a5,0x1e
    8000365a:	97278793          	addi	a5,a5,-1678 # 80020fc8 <bcache+0x8268>
    ...
    8000366e:	ff379ce3          	bne	a5,s3,80003666 <bread+0x3a>
    80003672:	44dc                	lw	a5,12(s1)
    80003674:	ff2799e3          	bne	a5,s2,80003666 <bread+0x3a>
      b->refcnt++;
    ...
    80003682:	6e250513          	addi	a0,a0,1762 # 80018d60 <bcache>
    ...
    80003696:	466080e7          	jalr	1126(ra) # 80004af8 <acquiresleep>
      return b;
    8000369a:	a8b9                	j	800036f8 <bread+0xcc>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    8000369c:	0001e497          	auipc	s1,0x1e
    800036a0:	9744b483          	ld	s1,-1676(s1) # 80021010 <bcache+0x82b0>
    800036a4:	0001e797          	auipc	a5,0x1e
    800036a8:	92478793          	addi	a5,a5,-1756 # 80020fc8 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    800036c0:	fbc50513          	addi	a0,a0,-68 # 80008678 <syscalls+0xd8>
    800036c4:	ffffd097          	auipc	ra,0xffffd
    800036c8:	e7a080e7          	jalr	-390(ra) # 8000053e <panic>
      b->dev = dev;
    800036cc:	0134a423          	sw	s3,8(s1)
      b->blockno = blockno;
    800036d0:	0124a623          	sw	s2,12(s1)
      b->valid = 0;
    ...
    800036e0:	68450513          	addi	a0,a0,1668 # 80018d60 <bcache>
    800036e4:	ffffd097          	auipc	ra,0xffffd
    800036e8:	5b4080e7          	jalr	1460(ra) # 80000c98 <release>
      acquiresleep(&b->lock);
    800036ec:	01048513          	addi	a0,s1,16
    800036f0:	00001097          	auipc	ra,0x1
    800036f4:	408080e7          	jalr	1032(ra) # 80004af8 <acquiresleep>
  struct buf *b;
  ...
  return b;
    ...
    80003714:	f06080e7          	jalr	-250(ra) # 80006616 <virtio_disk_rw>
    b->valid = 1;
...
bwrite(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    80003730:	466080e7          	jalr	1126(ra) # 80004b92 <holdingsleep>
  ...
  virtio_disk_rw(b, 1);
    ...
    8000373e:	edc080e7          	jalr	-292(ra) # 80006616 <virtio_disk_rw>
}
    ...
    80003750:	f4450513          	addi	a0,a0,-188 # 80008690 <syscalls+0xf0>
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    80003774:	422080e7          	jalr	1058(ra) # 80004b92 <holdingsleep>
    80003778:	c92d                	beqz	a0,800037ea <brelse+0x8e>
    panic("brelse");

  releasesleep(&b->lock);
    8000377a:	854a                	mv	a0,s2
    8000377c:	00001097          	auipc	ra,0x1
    80003780:	3d2080e7          	jalr	978(ra) # 80004b4e <releasesleep>

  acquire(&bcache.lock);
    80003784:	00015517          	auipc	a0,0x15
    80003788:	5dc50513          	addi	a0,a0,1500 # 80018d60 <bcache>
  ...
  if (b->refcnt == 0) {
    8000379e:	eb05                	bnez	a4,800037ce <brelse+0x72>
    // no one is waiting for it.
    b->next->prev = b->prev;
    800037a0:	68bc                	ld	a5,80(s1)
    800037a2:	64b8                	ld	a4,72(s1)
    800037a4:	e7b8                	sd	a4,72(a5)
    b->prev->next = b->next;
    800037a6:	64bc                	ld	a5,72(s1)
    800037a8:	68b8                	ld	a4,80(s1)
    800037aa:	ebb8                	sd	a4,80(a5)
    b->next = bcache.head.next;
    800037ac:	0001d797          	auipc	a5,0x1d
    800037b0:	5b478793          	addi	a5,a5,1460 # 80020d60 <bcache+0x8000>
    800037b4:	2b87b703          	ld	a4,696(a5)
    800037b8:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    800037ba:	0001e717          	auipc	a4,0x1e
    800037be:	80e70713          	addi	a4,a4,-2034 # 80020fc8 <bcache+0x8268>
    800037c2:	e4b8                	sd	a4,72(s1)
    bcache.head.next->prev = b;
    800037c4:	2b87b703          	ld	a4,696(a5)
    800037c8:	e724                	sd	s1,72(a4)
    bcache.head.next = b;
    800037ca:	2a97bc23          	sd	s1,696(a5)
  }
  
  release(&bcache.lock);
    800037ce:	00015517          	auipc	a0,0x15
    800037d2:	59250513          	addi	a0,a0,1426 # 80018d60 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000380a:	55a50513          	addi	a0,a0,1370 # 80018d60 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003820:	54450513          	addi	a0,a0,1348 # 80018d60 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    80003842:	00015517          	auipc	a0,0x15
    80003846:	51e50513          	addi	a0,a0,1310 # 80018d60 <bcache>
  ...
  release(&bcache.lock);
    ...
    8000385c:	50850513          	addi	a0,a0,1288 # 80018d60 <bcache>
    80003860:	ffffd097          	auipc	ra,0xffffd
    80003864:	438080e7          	jalr	1080(ra) # 80000c98 <release>
}
...
bfree(int dev, uint b)
{
    ...
    8000387e:	84ae                	mv	s1,a1
  struct buf *bp;
  int bi, m;

  bp = bread(dev, BBLOCK(b, sb));
    80003880:	00d5d59b          	srliw	a1,a1,0xd
    80003884:	0001e797          	auipc	a5,0x1e
    80003888:	bb87a783          	lw	a5,-1096(a5) # 8002143c <sb+0x1c>
    8000388c:	9dbd                	addw	a1,a1,a5
    8000388e:	00000097          	auipc	ra,0x0
    80003892:	d9e080e7          	jalr	-610(ra) # 8000362c <bread>
  bi = b % BPB;
  m = 1 << (bi % 8);
    80003896:	0074f713          	andi	a4,s1,7
    8000389a:	4785                	li	a5,1
    8000389c:	00e797bb          	sllw	a5,a5,a4
  if((bp->data[bi/8] & m) == 0)
    800038a0:	14ce                	slli	s1,s1,0x33
    800038a2:	90d9                	srli	s1,s1,0x36
    800038a4:	00950733          	add	a4,a0,s1
    800038a8:	05874703          	lbu	a4,88(a4)
    800038ac:	00e7f6b3          	and	a3,a5,a4
    800038b0:	c69d                	beqz	a3,800038de <bfree+0x6c>
    800038b2:	892a                	mv	s2,a0
    panic("freeing free block");
  bp->data[bi/8] &= ~m;
    800038b4:	94aa                	add	s1,s1,a0
    800038b6:	fff7c793          	not	a5,a5
    800038ba:	8ff9                	and	a5,a5,a4
    800038bc:	04f48c23          	sb	a5,88(s1)
  log_write(bp);
    800038c0:	00001097          	auipc	ra,0x1
    800038c4:	118080e7          	jalr	280(ra) # 800049d8 <log_write>
  brelse(bp);
    800038c8:	854a                	mv	a0,s2
    800038ca:	00000097          	auipc	ra,0x0
    800038ce:	e92080e7          	jalr	-366(ra) # 8000375c <brelse>
}
    ...
    800038e2:	dc250513          	addi	a0,a0,-574 # 800086a0 <syscalls+0x100>
    800038e6:	ffffd097          	auipc	ra,0xffffd
    800038ea:	c58080e7          	jalr	-936(ra) # 8000053e <panic>

00000000800038ee <balloc>:
{
    800038ee:	711d                	addi	sp,sp,-96
    800038f0:	ec86                	sd	ra,88(sp)
    800038f2:	e8a2                	sd	s0,80(sp)
    800038f4:	e4a6                	sd	s1,72(sp)
    800038f6:	e0ca                	sd	s2,64(sp)
    800038f8:	fc4e                	sd	s3,56(sp)
    800038fa:	f852                	sd	s4,48(sp)
    800038fc:	f456                	sd	s5,40(sp)
    800038fe:	f05a                	sd	s6,32(sp)
    80003900:	ec5e                	sd	s7,24(sp)
    80003902:	e862                	sd	s8,16(sp)
    80003904:	e466                	sd	s9,8(sp)
    80003906:	1080                	addi	s0,sp,96
  for(b = 0; b < sb.size; b += BPB){
    80003908:	0001e797          	auipc	a5,0x1e
    8000390c:	b1c7a783          	lw	a5,-1252(a5) # 80021424 <sb+0x4>
    80003910:	cbd1                	beqz	a5,800039a4 <balloc+0xb6>
    80003912:	8baa                	mv	s7,a0
    80003914:	4a81                	li	s5,0
    bp = bread(dev, BBLOCK(b, sb));
    80003916:	0001eb17          	auipc	s6,0x1e
    8000391a:	b0ab0b13          	addi	s6,s6,-1270 # 80021420 <sb>
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    8000391e:	4c01                	li	s8,0
      m = 1 << (bi % 8);
    80003920:	4985                	li	s3,1
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80003922:	6a09                	lui	s4,0x2
  for(b = 0; b < sb.size; b += BPB){
    80003924:	6c89                	lui	s9,0x2
    80003926:	a831                	j	80003942 <balloc+0x54>
    brelse(bp);
    80003928:	854a                	mv	a0,s2
    8000392a:	00000097          	auipc	ra,0x0
    8000392e:	e32080e7          	jalr	-462(ra) # 8000375c <brelse>
  for(b = 0; b < sb.size; b += BPB){
    80003932:	015c87bb          	addw	a5,s9,s5
    80003936:	00078a9b          	sext.w	s5,a5
    8000393a:	004b2703          	lw	a4,4(s6)
    8000393e:	06eaf363          	bgeu	s5,a4,800039a4 <balloc+0xb6>
    bp = bread(dev, BBLOCK(b, sb));
    80003942:	41fad79b          	sraiw	a5,s5,0x1f
    80003946:	0137d79b          	srliw	a5,a5,0x13
    8000394a:	015787bb          	addw	a5,a5,s5
    8000394e:	40d7d79b          	sraiw	a5,a5,0xd
    80003952:	01cb2583          	lw	a1,28(s6)
    80003956:	9dbd                	addw	a1,a1,a5
    80003958:	855e                	mv	a0,s7
    8000395a:	00000097          	auipc	ra,0x0
    8000395e:	cd2080e7          	jalr	-814(ra) # 8000362c <bread>
    80003962:	892a                	mv	s2,a0
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80003964:	004b2503          	lw	a0,4(s6)
    80003968:	000a849b          	sext.w	s1,s5
    8000396c:	8662                	mv	a2,s8
    8000396e:	faa4fde3          	bgeu	s1,a0,80003928 <balloc+0x3a>
      m = 1 << (bi % 8);
    80003972:	41f6579b          	sraiw	a5,a2,0x1f
    80003976:	01d7d69b          	srliw	a3,a5,0x1d
    8000397a:	00c6873b          	addw	a4,a3,a2
    8000397e:	00777793          	andi	a5,a4,7
    80003982:	9f95                	subw	a5,a5,a3
    80003984:	00f997bb          	sllw	a5,s3,a5
      if((bp->data[bi/8] & m) == 0){  // Is block free?
    80003988:	4037571b          	sraiw	a4,a4,0x3
    8000398c:	00e906b3          	add	a3,s2,a4
    80003990:	0586c683          	lbu	a3,88(a3)
    80003994:	00d7f5b3          	and	a1,a5,a3
    80003998:	cd91                	beqz	a1,800039b4 <balloc+0xc6>
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    8000399a:	2605                	addiw	a2,a2,1
    8000399c:	2485                	addiw	s1,s1,1
    8000399e:	fd4618e3          	bne	a2,s4,8000396e <balloc+0x80>
    800039a2:	b759                	j	80003928 <balloc+0x3a>
  panic("balloc: out of blocks");
    800039a4:	00005517          	auipc	a0,0x5
    800039a8:	d1450513          	addi	a0,a0,-748 # 800086b8 <syscalls+0x118>
    800039ac:	ffffd097          	auipc	ra,0xffffd
    800039b0:	b92080e7          	jalr	-1134(ra) # 8000053e <panic>
        bp->data[bi/8] |= m;  // Mark block in use.
    800039b4:	974a                	add	a4,a4,s2
    800039b6:	8fd5                	or	a5,a5,a3
    800039b8:	04f70c23          	sb	a5,88(a4)
        log_write(bp);
    800039bc:	854a                	mv	a0,s2
    800039be:	00001097          	auipc	ra,0x1
    800039c2:	01a080e7          	jalr	26(ra) # 800049d8 <log_write>
        brelse(bp);
    800039c6:	854a                	mv	a0,s2
    800039c8:	00000097          	auipc	ra,0x0
    800039cc:	d94080e7          	jalr	-620(ra) # 8000375c <brelse>
  bp = bread(dev, bno);
    800039d0:	85a6                	mv	a1,s1
    800039d2:	855e                	mv	a0,s7
    800039d4:	00000097          	auipc	ra,0x0
    800039d8:	c58080e7          	jalr	-936(ra) # 8000362c <bread>
  ...
  log_write(bp);
    ...
    800039f6:	fe6080e7          	jalr	-26(ra) # 800049d8 <log_write>
  brelse(bp);
    800039fa:	854a                	mv	a0,s2
    800039fc:	00000097          	auipc	ra,0x0
    80003a00:	d60080e7          	jalr	-672(ra) # 8000375c <brelse>
}
    80003a04:	8526                	mv	a0,s1
    80003a06:	60e6                	ld	ra,88(sp)
    80003a08:	6446                	ld	s0,80(sp)
    80003a0a:	64a6                	ld	s1,72(sp)
    80003a0c:	6906                	ld	s2,64(sp)
    80003a0e:	79e2                	ld	s3,56(sp)
    80003a10:	7a42                	ld	s4,48(sp)
    80003a12:	7aa2                	ld	s5,40(sp)
    80003a14:	7b02                	ld	s6,32(sp)
    80003a16:	6be2                	ld	s7,24(sp)
    80003a18:	6c42                	ld	s8,16(sp)
    80003a1a:	6ca2                	ld	s9,8(sp)
    80003a1c:	6125                	addi	sp,sp,96
    80003a1e:	8082                	ret

0000000080003a20 <bmap>:
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDIRECT){
    80003a32:	47ad                	li	a5,11
    80003a34:	04b7fe63          	bgeu	a5,a1,80003a90 <bmap+0x70>
    if((addr = ip->addrs[bn]) == 0)
      ip->addrs[bn] = addr = balloc(ip->dev);
    return addr;
  }
  bn -= NDIRECT;
    80003a38:	ff45849b          	addiw	s1,a1,-12
    80003a3c:	0004871b          	sext.w	a4,s1

  if(bn < NINDIRECT){
    80003a40:	0ff00793          	li	a5,255
    80003a44:	0ae7e363          	bltu	a5,a4,80003aea <bmap+0xca>
    // Load indirect block, allocating if necessary.
    if((addr = ip->addrs[NDIRECT]) == 0)
    80003a48:	08052583          	lw	a1,128(a0)
    80003a4c:	c5ad                	beqz	a1,80003ab6 <bmap+0x96>
      ip->addrs[NDIRECT] = addr = balloc(ip->dev);
    bp = bread(ip->dev, addr);
    80003a4e:	00092503          	lw	a0,0(s2)
    80003a52:	00000097          	auipc	ra,0x0
    80003a56:	bda080e7          	jalr	-1062(ra) # 8000362c <bread>
    80003a5a:	8a2a                	mv	s4,a0
    a = (uint*)bp->data;
    80003a5c:	05850793          	addi	a5,a0,88
    if((addr = a[bn]) == 0){
    80003a60:	02049593          	slli	a1,s1,0x20
    80003a64:	9181                	srli	a1,a1,0x20
    80003a66:	058a                	slli	a1,a1,0x2
    80003a68:	00b784b3          	add	s1,a5,a1
    80003a6c:	0004a983          	lw	s3,0(s1)
    80003a70:	04098d63          	beqz	s3,80003aca <bmap+0xaa>
    ...
    80003a7a:	ce6080e7          	jalr	-794(ra) # 8000375c <brelse>
    return addr;
  }
  ...
  panic("bmap: out of range");
    ...
    80003a8e:	8082                	ret
    if((addr = ip->addrs[bn]) == 0)
    80003a90:	02059493          	slli	s1,a1,0x20
    80003a94:	9081                	srli	s1,s1,0x20
    80003a96:	048a                	slli	s1,s1,0x2
    80003a98:	94aa                	add	s1,s1,a0
    80003a9a:	0504a983          	lw	s3,80(s1)
    80003a9e:	fe0990e3          	bnez	s3,80003a7e <bmap+0x5e>
      ip->addrs[bn] = addr = balloc(ip->dev);
    80003aa2:	4108                	lw	a0,0(a0)
    80003aa4:	00000097          	auipc	ra,0x0
    80003aa8:	e4a080e7          	jalr	-438(ra) # 800038ee <balloc>
    80003aac:	0005099b          	sext.w	s3,a0
    80003ab0:	0534a823          	sw	s3,80(s1)
    80003ab4:	b7e9                	j	80003a7e <bmap+0x5e>
      ip->addrs[NDIRECT] = addr = balloc(ip->dev);
    80003ab6:	4108                	lw	a0,0(a0)
    80003ab8:	00000097          	auipc	ra,0x0
    80003abc:	e36080e7          	jalr	-458(ra) # 800038ee <balloc>
    80003ac0:	0005059b          	sext.w	a1,a0
    80003ac4:	08b92023          	sw	a1,128(s2)
    80003ac8:	b759                	j	80003a4e <bmap+0x2e>
      a[bn] = addr = balloc(ip->dev);
    80003aca:	00092503          	lw	a0,0(s2)
    80003ace:	00000097          	auipc	ra,0x0
    80003ad2:	e20080e7          	jalr	-480(ra) # 800038ee <balloc>
    80003ad6:	0005099b          	sext.w	s3,a0
    80003ada:	0134a023          	sw	s3,0(s1)
      log_write(bp);
    80003ade:	8552                	mv	a0,s4
    80003ae0:	00001097          	auipc	ra,0x1
    80003ae4:	ef8080e7          	jalr	-264(ra) # 800049d8 <log_write>
    80003ae8:	b771                	j	80003a74 <bmap+0x54>
  panic("bmap: out of range");
    80003aea:	00005517          	auipc	a0,0x5
    80003aee:	be650513          	addi	a0,a0,-1050 # 800086d0 <syscalls+0x130>
    80003af2:	ffffd097          	auipc	ra,0xffffd
    80003af6:	a4c080e7          	jalr	-1460(ra) # 8000053e <panic>

0000000080003afa <iget>:
{
    ...
    80003b0c:	8a2e                	mv	s4,a1
  acquire(&itable.lock);
    80003b0e:	0001e517          	auipc	a0,0x1e
    80003b12:	93250513          	addi	a0,a0,-1742 # 80021440 <itable>
    80003b16:	ffffd097          	auipc	ra,0xffffd
    80003b1a:	0ce080e7          	jalr	206(ra) # 80000be4 <acquire>
  empty = 0;
    80003b1e:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80003b20:	0001e497          	auipc	s1,0x1e
    80003b24:	93848493          	addi	s1,s1,-1736 # 80021458 <itable+0x18>
    80003b28:	0001f697          	auipc	a3,0x1f
    80003b2c:	3c068693          	addi	a3,a3,960 # 80022ee8 <log>
    80003b30:	a039                	j	80003b3e <iget+0x44>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    80003b32:	02090b63          	beqz	s2,80003b68 <iget+0x6e>
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80003b36:	08848493          	addi	s1,s1,136
    80003b3a:	02d48a63          	beq	s1,a3,80003b6e <iget+0x74>
    if(ip->ref > 0 && ip->dev == dev && ip->inum == inum){
    80003b3e:	449c                	lw	a5,8(s1)
    80003b40:	fef059e3          	blez	a5,80003b32 <iget+0x38>
    80003b44:	4098                	lw	a4,0(s1)
    80003b46:	ff3716e3          	bne	a4,s3,80003b32 <iget+0x38>
    80003b4a:	40d8                	lw	a4,4(s1)
    80003b4c:	ff4713e3          	bne	a4,s4,80003b32 <iget+0x38>
      ip->ref++;
    80003b50:	2785                	addiw	a5,a5,1
    80003b52:	c49c                	sw	a5,8(s1)
      release(&itable.lock);
    80003b54:	0001e517          	auipc	a0,0x1e
    80003b58:	8ec50513          	addi	a0,a0,-1812 # 80021440 <itable>
    80003b5c:	ffffd097          	auipc	ra,0xffffd
    80003b60:	13c080e7          	jalr	316(ra) # 80000c98 <release>
      return ip;
    80003b64:	8926                	mv	s2,s1
    80003b66:	a03d                	j	80003b94 <iget+0x9a>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    80003b68:	f7f9                	bnez	a5,80003b36 <iget+0x3c>
    80003b6a:	8926                	mv	s2,s1
    80003b6c:	b7e9                	j	80003b36 <iget+0x3c>
  if(empty == 0)
    80003b6e:	02090c63          	beqz	s2,80003ba6 <iget+0xac>
  ip->dev = dev;
    80003b72:	01392023          	sw	s3,0(s2)
  ip->inum = inum;
    80003b76:	01492223          	sw	s4,4(s2)
  ip->ref = 1;
    80003b7a:	4785                	li	a5,1
    80003b7c:	00f92423          	sw	a5,8(s2)
  ip->valid = 0;
    80003b80:	04092023          	sw	zero,64(s2)
  release(&itable.lock);
    80003b84:	0001e517          	auipc	a0,0x1e
    80003b88:	8bc50513          	addi	a0,a0,-1860 # 80021440 <itable>
    ...
    80003baa:	b4250513          	addi	a0,a0,-1214 # 800086e8 <syscalls+0x148>
    80003bae:	ffffd097          	auipc	ra,0xffffd
    80003bb2:	990080e7          	jalr	-1648(ra) # 8000053e <panic>

0000000080003bb6 <fsinit>:
fsinit(int dev) {
  ...
  bp = bread(dev, 1);
    ...
    80003bcc:	a64080e7          	jalr	-1436(ra) # 8000362c <bread>
    80003bd0:	84aa                	mv	s1,a0
  memmove(sb, bp->data, sizeof(*sb));
    80003bd2:	0001e997          	auipc	s3,0x1e
    80003bd6:	84e98993          	addi	s3,s3,-1970 # 80021420 <sb>
    80003bda:	02000613          	li	a2,32
    80003bde:	05850593          	addi	a1,a0,88
    80003be2:	854e                	mv	a0,s3
    80003be4:	ffffd097          	auipc	ra,0xffffd
    80003be8:	15c080e7          	jalr	348(ra) # 80000d40 <memmove>
  brelse(bp);
    80003bec:	8526                	mv	a0,s1
    80003bee:	00000097          	auipc	ra,0x0
    80003bf2:	b6e080e7          	jalr	-1170(ra) # 8000375c <brelse>
  if(sb.magic != FSMAGIC)
    80003bf6:	0009a703          	lw	a4,0(s3)
    80003bfa:	102037b7          	lui	a5,0x10203
    80003bfe:	04078793          	addi	a5,a5,64 # 10203040 <_entry-0x6fdfcfc0>
    80003c02:	02f71263          	bne	a4,a5,80003c26 <fsinit+0x70>
  initlog(dev, &sb);
    80003c06:	0001e597          	auipc	a1,0x1e
    80003c0a:	81a58593          	addi	a1,a1,-2022 # 80021420 <sb>
    80003c0e:	854a                	mv	a0,s2
    80003c10:	00001097          	auipc	ra,0x1
    80003c14:	b4c080e7          	jalr	-1204(ra) # 8000475c <initlog>
}
    ...
    80003c2a:	ad250513          	addi	a0,a0,-1326 # 800086f8 <syscalls+0x158>
    80003c2e:	ffffd097          	auipc	ra,0xffffd
    80003c32:	910080e7          	jalr	-1776(ra) # 8000053e <panic>

0000000080003c36 <iinit>:
{
    80003c36:	7179                	addi	sp,sp,-48
    80003c38:	f406                	sd	ra,40(sp)
    80003c3a:	f022                	sd	s0,32(sp)
    80003c3c:	ec26                	sd	s1,24(sp)
    80003c3e:	e84a                	sd	s2,16(sp)
    80003c40:	e44e                	sd	s3,8(sp)
    80003c42:	1800                	addi	s0,sp,48
  initlock(&itable.lock, "itable");
    80003c44:	00005597          	auipc	a1,0x5
    80003c48:	acc58593          	addi	a1,a1,-1332 # 80008710 <syscalls+0x170>
    80003c4c:	0001d517          	auipc	a0,0x1d
    80003c50:	7f450513          	addi	a0,a0,2036 # 80021440 <itable>
    80003c54:	ffffd097          	auipc	ra,0xffffd
    80003c58:	f00080e7          	jalr	-256(ra) # 80000b54 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003c5c:	0001e497          	auipc	s1,0x1e
    80003c60:	80c48493          	addi	s1,s1,-2036 # 80021468 <itable+0x28>
    80003c64:	0001f997          	auipc	s3,0x1f
    80003c68:	29498993          	addi	s3,s3,660 # 80022ef8 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    80003c6c:	00005917          	auipc	s2,0x5
    80003c70:	aac90913          	addi	s2,s2,-1364 # 80008718 <syscalls+0x178>
    80003c74:	85ca                	mv	a1,s2
    80003c76:	8526                	mv	a0,s1
    80003c78:	00001097          	auipc	ra,0x1
    80003c7c:	e46080e7          	jalr	-442(ra) # 80004abe <initsleeplock>
  for(i = 0; i < NINODE; i++) {
    80003c80:	08848493          	addi	s1,s1,136
    80003c84:	ff3498e3          	bne	s1,s3,80003c74 <iinit+0x3e>
}
...
0000000080003c96 <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    80003cac:	0001d717          	auipc	a4,0x1d
    80003cb0:	78072703          	lw	a4,1920(a4) # 8002142c <sb+0xc>
    80003cb4:	4785                	li	a5,1
    80003cb6:	04e7fa63          	bgeu	a5,a4,80003d0a <ialloc+0x74>
    80003cba:	8aaa                	mv	s5,a0
    80003cbc:	8bae                	mv	s7,a1
    80003cbe:	4485                	li	s1,1
    bp = bread(dev, IBLOCK(inum, sb));
    80003cc0:	0001da17          	auipc	s4,0x1d
    80003cc4:	760a0a13          	addi	s4,s4,1888 # 80021420 <sb>
    80003cc8:	00048b1b          	sext.w	s6,s1
    80003ccc:	0044d593          	srli	a1,s1,0x4
    80003cd0:	018a2783          	lw	a5,24(s4)
    80003cd4:	9dbd                	addw	a1,a1,a5
    80003cd6:	8556                	mv	a0,s5
    80003cd8:	00000097          	auipc	ra,0x0
    80003cdc:	954080e7          	jalr	-1708(ra) # 8000362c <bread>
    80003ce0:	892a                	mv	s2,a0
    dip = (struct dinode*)bp->data + inum%IPB;
    80003ce2:	05850993          	addi	s3,a0,88
    80003ce6:	00f4f793          	andi	a5,s1,15
    80003cea:	079a                	slli	a5,a5,0x6
    80003cec:	99be                	add	s3,s3,a5
    if(dip->type == 0){  // a free inode
    80003cee:	00099783          	lh	a5,0(s3)
    80003cf2:	c785                	beqz	a5,80003d1a <ialloc+0x84>
    brelse(bp);
    80003cf4:	00000097          	auipc	ra,0x0
    80003cf8:	a68080e7          	jalr	-1432(ra) # 8000375c <brelse>
  for(inum = 1; inum < sb.ninodes; inum++){
    80003cfc:	0485                	addi	s1,s1,1
    80003cfe:	00ca2703          	lw	a4,12(s4)
    80003d02:	0004879b          	sext.w	a5,s1
    80003d06:	fce7e1e3          	bltu	a5,a4,80003cc8 <ialloc+0x32>
  panic("ialloc: no inodes");
    80003d0a:	00005517          	auipc	a0,0x5
    80003d0e:	a1650513          	addi	a0,a0,-1514 # 80008720 <syscalls+0x180>
    80003d12:	ffffd097          	auipc	ra,0xffffd
    80003d16:	82c080e7          	jalr	-2004(ra) # 8000053e <panic>
      memset(dip, 0, sizeof(*dip));
    80003d1a:	04000613          	li	a2,64
    80003d1e:	4581                	li	a1,0
    80003d20:	854e                	mv	a0,s3
    80003d22:	ffffd097          	auipc	ra,0xffffd
    80003d26:	fbe080e7          	jalr	-66(ra) # 80000ce0 <memset>
      dip->type = type;
    80003d2a:	01799023          	sh	s7,0(s3)
      log_write(bp);   // mark it allocated on the disk
    80003d2e:	854a                	mv	a0,s2
    80003d30:	00001097          	auipc	ra,0x1
    80003d34:	ca8080e7          	jalr	-856(ra) # 800049d8 <log_write>
      brelse(bp);
    80003d38:	854a                	mv	a0,s2
    80003d3a:	00000097          	auipc	ra,0x0
    80003d3e:	a22080e7          	jalr	-1502(ra) # 8000375c <brelse>
      return iget(dev, inum);
    80003d42:	85da                	mv	a1,s6
    80003d44:	8556                	mv	a0,s5
    80003d46:	00000097          	auipc	ra,0x0
    80003d4a:	db4080e7          	jalr	-588(ra) # 80003afa <iget>
}
...
0000000080003d64 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    80003d72:	415c                	lw	a5,4(a0)
    80003d74:	0047d79b          	srliw	a5,a5,0x4
    80003d78:	0001d597          	auipc	a1,0x1d
    80003d7c:	6c05a583          	lw	a1,1728(a1) # 80021438 <sb+0x18>
    80003d80:	9dbd                	addw	a1,a1,a5
    80003d82:	4108                	lw	a0,0(a0)
    80003d84:	00000097          	auipc	ra,0x0
    80003d88:	8a8080e7          	jalr	-1880(ra) # 8000362c <bread>
    80003d8c:	892a                	mv	s2,a0
  dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003d8e:	05850793          	addi	a5,a0,88
    80003d92:	40c8                	lw	a0,4(s1)
    80003d94:	893d                	andi	a0,a0,15
    80003d96:	051a                	slli	a0,a0,0x6
    80003d98:	953e                	add	a0,a0,a5
  dip->type = ip->type;
    80003d9a:	04449703          	lh	a4,68(s1)
    80003d9e:	00e51023          	sh	a4,0(a0)
  dip->major = ip->major;
    80003da2:	04649703          	lh	a4,70(s1)
    80003da6:	00e51123          	sh	a4,2(a0)
  dip->minor = ip->minor;
    80003daa:	04849703          	lh	a4,72(s1)
    80003dae:	00e51223          	sh	a4,4(a0)
  dip->nlink = ip->nlink;
    80003db2:	04a49703          	lh	a4,74(s1)
    80003db6:	00e51323          	sh	a4,6(a0)
  dip->size = ip->size;
    80003dba:	44f8                	lw	a4,76(s1)
    80003dbc:	c518                	sw	a4,8(a0)
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    80003dbe:	03400613          	li	a2,52
    80003dc2:	05048593          	addi	a1,s1,80
    80003dc6:	0531                	addi	a0,a0,12
    80003dc8:	ffffd097          	auipc	ra,0xffffd
    80003dcc:	f78080e7          	jalr	-136(ra) # 80000d40 <memmove>
  log_write(bp);
    80003dd0:	854a                	mv	a0,s2
    80003dd2:	00001097          	auipc	ra,0x1
    80003dd6:	c06080e7          	jalr	-1018(ra) # 800049d8 <log_write>
  brelse(bp);
    80003dda:	854a                	mv	a0,s2
    80003ddc:	00000097          	auipc	ra,0x0
    80003de0:	980080e7          	jalr	-1664(ra) # 8000375c <brelse>
}
...
0000000080003df0 <idup>:
{
  ...
  acquire(&itable.lock);
    80003dfc:	0001d517          	auipc	a0,0x1d
    80003e00:	64450513          	addi	a0,a0,1604 # 80021440 <itable>
    80003e04:	ffffd097          	auipc	ra,0xffffd
    80003e08:	de0080e7          	jalr	-544(ra) # 80000be4 <acquire>
  ip->ref++;
    80003e0c:	449c                	lw	a5,8(s1)
    80003e0e:	2785                	addiw	a5,a5,1
    80003e10:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    80003e12:	0001d517          	auipc	a0,0x1d
    80003e16:	62e50513          	addi	a0,a0,1582 # 80021440 <itable>
    80003e1a:	ffffd097          	auipc	ra,0xffffd
    80003e1e:	e7e080e7          	jalr	-386(ra) # 80000c98 <release>
}
...
0000000080003e2e <ilock>:
{
  ...
  if(ip == 0 || ip->ref < 1)
    80003e3a:	c115                	beqz	a0,80003e5e <ilock+0x30>
    80003e3c:	84aa                	mv	s1,a0
    80003e3e:	451c                	lw	a5,8(a0)
    80003e40:	00f05f63          	blez	a5,80003e5e <ilock+0x30>
  acquiresleep(&ip->lock);
    80003e44:	0541                	addi	a0,a0,16
    80003e46:	00001097          	auipc	ra,0x1
    80003e4a:	cb2080e7          	jalr	-846(ra) # 80004af8 <acquiresleep>
  if(ip->valid == 0){
    80003e4e:	40bc                	lw	a5,64(s1)
    80003e50:	cf99                	beqz	a5,80003e6e <ilock+0x40>
}
    ...
    80003e62:	8da50513          	addi	a0,a0,-1830 # 80008738 <syscalls+0x198>
    80003e66:	ffffc097          	auipc	ra,0xffffc
    80003e6a:	6d8080e7          	jalr	1752(ra) # 8000053e <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    80003e6e:	40dc                	lw	a5,4(s1)
    80003e70:	0047d79b          	srliw	a5,a5,0x4
    80003e74:	0001d597          	auipc	a1,0x1d
    80003e78:	5c45a583          	lw	a1,1476(a1) # 80021438 <sb+0x18>
    80003e7c:	9dbd                	addw	a1,a1,a5
    80003e7e:	4088                	lw	a0,0(s1)
    80003e80:	fffff097          	auipc	ra,0xfffff
    80003e84:	7ac080e7          	jalr	1964(ra) # 8000362c <bread>
    80003e88:	892a                	mv	s2,a0
    dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003e8a:	05850593          	addi	a1,a0,88
    80003e8e:	40dc                	lw	a5,4(s1)
    80003e90:	8bbd                	andi	a5,a5,15
    80003e92:	079a                	slli	a5,a5,0x6
    80003e94:	95be                	add	a1,a1,a5
    ip->type = dip->type;
    80003e96:	00059783          	lh	a5,0(a1)
    80003e9a:	04f49223          	sh	a5,68(s1)
    ip->major = dip->major;
    80003e9e:	00259783          	lh	a5,2(a1)
    80003ea2:	04f49323          	sh	a5,70(s1)
    ip->minor = dip->minor;
    80003ea6:	00459783          	lh	a5,4(a1)
    80003eaa:	04f49423          	sh	a5,72(s1)
    ip->nlink = dip->nlink;
    80003eae:	00659783          	lh	a5,6(a1)
    80003eb2:	04f49523          	sh	a5,74(s1)
    ip->size = dip->size;
    80003eb6:	459c                	lw	a5,8(a1)
    80003eb8:	c4fc                	sw	a5,76(s1)
    memmove(ip->addrs, dip->addrs, sizeof(ip->addrs));
    80003eba:	03400613          	li	a2,52
    80003ebe:	05b1                	addi	a1,a1,12
    80003ec0:	05048513          	addi	a0,s1,80
    80003ec4:	ffffd097          	auipc	ra,0xffffd
    80003ec8:	e7c080e7          	jalr	-388(ra) # 80000d40 <memmove>
    brelse(bp);
    80003ecc:	854a                	mv	a0,s2
    80003ece:	00000097          	auipc	ra,0x0
    80003ed2:	88e080e7          	jalr	-1906(ra) # 8000375c <brelse>
    ip->valid = 1;
    80003ed6:	4785                	li	a5,1
    80003ed8:	c0bc                	sw	a5,64(s1)
    if(ip->type == 0)
    80003eda:	04449783          	lh	a5,68(s1)
    80003ede:	fbb5                	bnez	a5,80003e52 <ilock+0x24>
      panic("ilock: no type");
    80003ee0:	00005517          	auipc	a0,0x5
    80003ee4:	86050513          	addi	a0,a0,-1952 # 80008740 <syscalls+0x1a0>
    80003ee8:	ffffc097          	auipc	ra,0xffffc
    80003eec:	656080e7          	jalr	1622(ra) # 8000053e <panic>

0000000080003ef0 <iunlock>:
{
  ...
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    80003efc:	c905                	beqz	a0,80003f2c <iunlock+0x3c>
    80003efe:	84aa                	mv	s1,a0
    80003f00:	01050913          	addi	s2,a0,16
    80003f04:	854a                	mv	a0,s2
    80003f06:	00001097          	auipc	ra,0x1
    80003f0a:	c8c080e7          	jalr	-884(ra) # 80004b92 <holdingsleep>
    80003f0e:	cd19                	beqz	a0,80003f2c <iunlock+0x3c>
    80003f10:	449c                	lw	a5,8(s1)
    80003f12:	00f05d63          	blez	a5,80003f2c <iunlock+0x3c>
  releasesleep(&ip->lock);
    80003f16:	854a                	mv	a0,s2
    80003f18:	00001097          	auipc	ra,0x1
    80003f1c:	c36080e7          	jalr	-970(ra) # 80004b4e <releasesleep>
}
    ...
    80003f30:	82450513          	addi	a0,a0,-2012 # 80008750 <syscalls+0x1b0>
    80003f34:	ffffc097          	auipc	ra,0xffffc
    80003f38:	60a080e7          	jalr	1546(ra) # 8000053e <panic>

0000000080003f3c <itrunc>:
...
itrunc(struct inode *ip)
{
  ...
  for(i = 0; i < NDIRECT; i++){
    80003f4e:	05050493          	addi	s1,a0,80
    80003f52:	08050913          	addi	s2,a0,128
    80003f56:	a021                	j	80003f5e <itrunc+0x22>
    80003f58:	0491                	addi	s1,s1,4
    80003f5a:	01248d63          	beq	s1,s2,80003f74 <itrunc+0x38>
    if(ip->addrs[i]){
    80003f5e:	408c                	lw	a1,0(s1)
    80003f60:	dde5                	beqz	a1,80003f58 <itrunc+0x1c>
      bfree(ip->dev, ip->addrs[i]);
    80003f62:	0009a503          	lw	a0,0(s3)
    80003f66:	00000097          	auipc	ra,0x0
    80003f6a:	90c080e7          	jalr	-1780(ra) # 80003872 <bfree>
      ip->addrs[i] = 0;
    80003f6e:	0004a023          	sw	zero,0(s1)
    80003f72:	b7dd                	j	80003f58 <itrunc+0x1c>
    }
  }

  if(ip->addrs[NDIRECT]){
    80003f74:	0809a583          	lw	a1,128(s3)
    80003f78:	e185                	bnez	a1,80003f98 <itrunc+0x5c>
    brelse(bp);
  ...
  ip->size = 0;
    80003f7a:	0409a623          	sw	zero,76(s3)
  iupdate(ip);
    80003f7e:	854e                	mv	a0,s3
    80003f80:	00000097          	auipc	ra,0x0
    80003f84:	de4080e7          	jalr	-540(ra) # 80003d64 <iupdate>
}
    ...
    80003fa0:	690080e7          	jalr	1680(ra) # 8000362c <bread>
    80003fa4:	8a2a                	mv	s4,a0
    for(j = 0; j < NINDIRECT; j++){
    80003fa6:	05850493          	addi	s1,a0,88
    80003faa:	45850913          	addi	s2,a0,1112
    80003fae:	a811                	j	80003fc2 <itrunc+0x86>
        bfree(ip->dev, a[j]);
    80003fb0:	0009a503          	lw	a0,0(s3)
    80003fb4:	00000097          	auipc	ra,0x0
    80003fb8:	8be080e7          	jalr	-1858(ra) # 80003872 <bfree>
    for(j = 0; j < NINDIRECT; j++){
    80003fbc:	0491                	addi	s1,s1,4
    80003fbe:	01248563          	beq	s1,s2,80003fc8 <itrunc+0x8c>
      if(a[j])
    80003fc2:	408c                	lw	a1,0(s1)
    80003fc4:	dde5                	beqz	a1,80003fbc <itrunc+0x80>
    80003fc6:	b7ed                	j	80003fb0 <itrunc+0x74>
    brelse(bp);
    80003fc8:	8552                	mv	a0,s4
    80003fca:	fffff097          	auipc	ra,0xfffff
    80003fce:	792080e7          	jalr	1938(ra) # 8000375c <brelse>
    bfree(ip->dev, ip->addrs[NDIRECT]);
    80003fd2:	0809a583          	lw	a1,128(s3)
    80003fd6:	0009a503          	lw	a0,0(s3)
    80003fda:	00000097          	auipc	ra,0x0
    80003fde:	898080e7          	jalr	-1896(ra) # 80003872 <bfree>
    ip->addrs[NDIRECT] = 0;
    80003fe2:	0809a023          	sw	zero,128(s3)
    80003fe6:	bf51                	j	80003f7a <itrunc+0x3e>

0000000080003fe8 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80003ffa:	44a50513          	addi	a0,a0,1098 # 80021440 <itable>
    80003ffe:	ffffd097          	auipc	ra,0xffffd
    80004002:	be6080e7          	jalr	-1050(ra) # 80000be4 <acquire>
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    80004006:	4498                	lw	a4,8(s1)
    80004008:	4785                	li	a5,1
    8000400a:	02f70363          	beq	a4,a5,80004030 <iput+0x48>
  ip->ref--;
  ...
  release(&itable.lock);
    ...
    80004018:	42c50513          	addi	a0,a0,1068 # 80021440 <itable>
    8000401c:	ffffd097          	auipc	ra,0xffffd
    80004020:	c7c080e7          	jalr	-900(ra) # 80000c98 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80004032:	dff1                	beqz	a5,8000400e <iput+0x26>
    80004034:	04a49783          	lh	a5,74(s1)
    80004038:	fbf9                	bnez	a5,8000400e <iput+0x26>
    acquiresleep(&ip->lock);
    8000403a:	01048913          	addi	s2,s1,16
    8000403e:	854a                	mv	a0,s2
    80004040:	00001097          	auipc	ra,0x1
    80004044:	ab8080e7          	jalr	-1352(ra) # 80004af8 <acquiresleep>
    release(&itable.lock);
    80004048:	0001d517          	auipc	a0,0x1d
    8000404c:	3f850513          	addi	a0,a0,1016 # 80021440 <itable>
    80004050:	ffffd097          	auipc	ra,0xffffd
    80004054:	c48080e7          	jalr	-952(ra) # 80000c98 <release>
    itrunc(ip);
    80004058:	8526                	mv	a0,s1
    8000405a:	00000097          	auipc	ra,0x0
    8000405e:	ee2080e7          	jalr	-286(ra) # 80003f3c <itrunc>
    ip->type = 0;
    80004062:	04049223          	sh	zero,68(s1)
    iupdate(ip);
    80004066:	8526                	mv	a0,s1
    80004068:	00000097          	auipc	ra,0x0
    8000406c:	cfc080e7          	jalr	-772(ra) # 80003d64 <iupdate>
    ip->valid = 0;
    80004070:	0404a023          	sw	zero,64(s1)
    releasesleep(&ip->lock);
    80004074:	854a                	mv	a0,s2
    80004076:	00001097          	auipc	ra,0x1
    8000407a:	ad8080e7          	jalr	-1320(ra) # 80004b4e <releasesleep>
    acquire(&itable.lock);
    8000407e:	0001d517          	auipc	a0,0x1d
    80004082:	3c250513          	addi	a0,a0,962 # 80021440 <itable>
    80004086:	ffffd097          	auipc	ra,0xffffd
    8000408a:	b5e080e7          	jalr	-1186(ra) # 80000be4 <acquire>
    8000408e:	b741                	j	8000400e <iput+0x26>

0000000080004090 <iunlockput>:
{
  ...
  iunlock(ip);
    ...
    800040a0:	e54080e7          	jalr	-428(ra) # 80003ef0 <iunlock>
  iput(ip);
    800040a4:	8526                	mv	a0,s1
    800040a6:	00000097          	auipc	ra,0x0
    800040aa:	f42080e7          	jalr	-190(ra) # 80003fe8 <iput>
}
...
stati(struct inode *ip, struct stat *st)
{
    ...
    800040ba:	e422                	sd	s0,8(sp)
    800040bc:	0800                	addi	s0,sp,16
  st->dev = ip->dev;
    800040be:	411c                	lw	a5,0(a0)
    800040c0:	c19c                	sw	a5,0(a1)
  st->ino = ip->inum;
    800040c2:	415c                	lw	a5,4(a0)
    800040c4:	c1dc                	sw	a5,4(a1)
  st->type = ip->type;
    800040c6:	04451783          	lh	a5,68(a0)
    800040ca:	00f59423          	sh	a5,8(a1)
  st->nlink = ip->nlink;
    800040ce:	04a51783          	lh	a5,74(a0)
    800040d2:	00f59523          	sh	a5,10(a1)
  st->size = ip->size;
    800040d6:	04c56783          	lwu	a5,76(a0)
    800040da:	e99c                	sd	a5,16(a1)
}
    800040dc:	6422                	ld	s0,8(sp)
    800040de:	0141                	addi	sp,sp,16
    800040e0:	8082                	ret

00000000800040e2 <readi>:
readi(struct inode *ip, int user_dst, uint64 dst, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    ...
    800040e4:	0ed7e963          	bltu	a5,a3,800041d6 <readi+0xf4>
{
    800040e8:	7159                	addi	sp,sp,-112
    800040ea:	f486                	sd	ra,104(sp)
    800040ec:	f0a2                	sd	s0,96(sp)
    800040ee:	eca6                	sd	s1,88(sp)
    800040f0:	e8ca                	sd	s2,80(sp)
    800040f2:	e4ce                	sd	s3,72(sp)
    800040f4:	e0d2                	sd	s4,64(sp)
    800040f6:	fc56                	sd	s5,56(sp)
    800040f8:	f85a                	sd	s6,48(sp)
    800040fa:	f45e                	sd	s7,40(sp)
    800040fc:	f062                	sd	s8,32(sp)
    800040fe:	ec66                	sd	s9,24(sp)
    80004100:	e86a                	sd	s10,16(sp)
    80004102:	e46e                	sd	s11,8(sp)
    80004104:	1880                	addi	s0,sp,112
    80004106:	8baa                	mv	s7,a0
    80004108:	8c2e                	mv	s8,a1
    8000410a:	8ab2                	mv	s5,a2
    8000410c:	84b6                	mv	s1,a3
    8000410e:	8b3a                	mv	s6,a4
  if(off > ip->size || off + n < off)
    80004110:	9f35                	addw	a4,a4,a3
    return 0;
    80004112:	4501                	li	a0,0
  if(off > ip->size || off + n < off)
    80004114:	0ad76063          	bltu	a4,a3,800041b4 <readi+0xd2>
  if(off + n > ip->size)
    80004118:	00e7f463          	bgeu	a5,a4,80004120 <readi+0x3e>
    n = ip->size - off;
    8000411c:	40d78b3b          	subw	s6,a5,a3

  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80004120:	0a0b0963          	beqz	s6,800041d2 <readi+0xf0>
    80004124:	4981                	li	s3,0
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    m = min(n - tot, BSIZE - off%BSIZE);
    80004126:	40000d13          	li	s10,1024
    if(either_copyout(user_dst, dst, bp->data + (off % BSIZE), m) == -1) {
    8000412a:	5cfd                	li	s9,-1
    8000412c:	a82d                	j	80004166 <readi+0x84>
    8000412e:	020a1d93          	slli	s11,s4,0x20
    80004132:	020ddd93          	srli	s11,s11,0x20
    80004136:	05890613          	addi	a2,s2,88
    8000413a:	86ee                	mv	a3,s11
    8000413c:	963a                	add	a2,a2,a4
    8000413e:	85d6                	mv	a1,s5
    80004140:	8562                	mv	a0,s8
    80004142:	ffffe097          	auipc	ra,0xffffe
    80004146:	264080e7          	jalr	612(ra) # 800023a6 <either_copyout>
    8000414a:	05950d63          	beq	a0,s9,800041a4 <readi+0xc2>
      brelse(bp);
      tot = -1;
      break;
    }
    ...
    80004154:	60c080e7          	jalr	1548(ra) # 8000375c <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80004158:	013a09bb          	addw	s3,s4,s3
    8000415c:	009a04bb          	addw	s1,s4,s1
    80004160:	9aee                	add	s5,s5,s11
    80004162:	0569f763          	bgeu	s3,s6,800041b0 <readi+0xce>
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    80004166:	000ba903          	lw	s2,0(s7)
    8000416a:	00a4d59b          	srliw	a1,s1,0xa
    8000416e:	855e                	mv	a0,s7
    80004170:	00000097          	auipc	ra,0x0
    80004174:	8b0080e7          	jalr	-1872(ra) # 80003a20 <bmap>
    80004178:	0005059b          	sext.w	a1,a0
    8000417c:	854a                	mv	a0,s2
    8000417e:	fffff097          	auipc	ra,0xfffff
    80004182:	4ae080e7          	jalr	1198(ra) # 8000362c <bread>
    80004186:	892a                	mv	s2,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80004188:	3ff4f713          	andi	a4,s1,1023
    8000418c:	40ed07bb          	subw	a5,s10,a4
    80004190:	413b06bb          	subw	a3,s6,s3
    80004194:	8a3e                	mv	s4,a5
    80004196:	2781                	sext.w	a5,a5
    80004198:	0006861b          	sext.w	a2,a3
    8000419c:	f8f679e3          	bgeu	a2,a5,8000412e <readi+0x4c>
    800041a0:	8a36                	mv	s4,a3
    800041a2:	b771                	j	8000412e <readi+0x4c>
      brelse(bp);
    800041a4:	854a                	mv	a0,s2
    800041a6:	fffff097          	auipc	ra,0xfffff
    800041aa:	5b6080e7          	jalr	1462(ra) # 8000375c <brelse>
      tot = -1;
    800041ae:	59fd                	li	s3,-1
  }
  return tot;
    800041b0:	0009851b          	sext.w	a0,s3
}
    800041b4:	70a6                	ld	ra,104(sp)
    800041b6:	7406                	ld	s0,96(sp)
    800041b8:	64e6                	ld	s1,88(sp)
    800041ba:	6946                	ld	s2,80(sp)
    800041bc:	69a6                	ld	s3,72(sp)
    800041be:	6a06                	ld	s4,64(sp)
    800041c0:	7ae2                	ld	s5,56(sp)
    800041c2:	7b42                	ld	s6,48(sp)
    800041c4:	7ba2                	ld	s7,40(sp)
    800041c6:	7c02                	ld	s8,32(sp)
    800041c8:	6ce2                	ld	s9,24(sp)
    800041ca:	6d42                	ld	s10,16(sp)
    800041cc:	6da2                	ld	s11,8(sp)
    800041ce:	6165                	addi	sp,sp,112
    800041d0:	8082                	ret
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    800041d2:	89da                	mv	s3,s6
    800041d4:	bff1                	j	800041b0 <readi+0xce>
    return 0;
    800041d6:	4501                	li	a0,0
}
    800041d8:	8082                	ret

00000000800041da <writei>:
writei(struct inode *ip, int user_src, uint64 src, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    ...
    800041dc:	10d7e863          	bltu	a5,a3,800042ec <writei+0x112>
{
    ...
    80004200:	8c2e                	mv	s8,a1
    80004202:	8ab2                	mv	s5,a2
    80004204:	8936                	mv	s2,a3
    80004206:	8bba                	mv	s7,a4
  if(off > ip->size || off + n < off)
    80004208:	00e687bb          	addw	a5,a3,a4
    8000420c:	0ed7e263          	bltu	a5,a3,800042f0 <writei+0x116>
    return -1;
  if(off + n > MAXFILE*BSIZE)
    80004210:	00043737          	lui	a4,0x43
    80004214:	0ef76063          	bltu	a4,a5,800042f4 <writei+0x11a>
    return -1;

  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80004218:	0c0b8863          	beqz	s7,800042e8 <writei+0x10e>
    8000421c:	4a01                	li	s4,0
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    m = min(n - tot, BSIZE - off%BSIZE);
    8000421e:	40000d13          	li	s10,1024
    if(either_copyin(bp->data + (off % BSIZE), user_src, src, m) == -1) {
    80004222:	5cfd                	li	s9,-1
    80004224:	a091                	j	80004268 <writei+0x8e>
    80004226:	02099d93          	slli	s11,s3,0x20
    8000422a:	020ddd93          	srli	s11,s11,0x20
    8000422e:	05848513          	addi	a0,s1,88
    80004232:	86ee                	mv	a3,s11
    80004234:	8656                	mv	a2,s5
    80004236:	85e2                	mv	a1,s8
    80004238:	953a                	add	a0,a0,a4
    8000423a:	ffffe097          	auipc	ra,0xffffe
    8000423e:	1c2080e7          	jalr	450(ra) # 800023fc <either_copyin>
    80004242:	07950263          	beq	a0,s9,800042a6 <writei+0xcc>
      brelse(bp);
      break;
    }
    log_write(bp);
    ...
    8000424c:	790080e7          	jalr	1936(ra) # 800049d8 <log_write>
    brelse(bp);
    80004250:	8526                	mv	a0,s1
    80004252:	fffff097          	auipc	ra,0xfffff
    80004256:	50a080e7          	jalr	1290(ra) # 8000375c <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    8000425a:	01498a3b          	addw	s4,s3,s4
    8000425e:	0129893b          	addw	s2,s3,s2
    80004262:	9aee                	add	s5,s5,s11
    80004264:	057a7663          	bgeu	s4,s7,800042b0 <writei+0xd6>
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    80004268:	000b2483          	lw	s1,0(s6)
    8000426c:	00a9559b          	srliw	a1,s2,0xa
    80004270:	855a                	mv	a0,s6
    80004272:	fffff097          	auipc	ra,0xfffff
    80004276:	7ae080e7          	jalr	1966(ra) # 80003a20 <bmap>
    8000427a:	0005059b          	sext.w	a1,a0
    8000427e:	8526                	mv	a0,s1
    80004280:	fffff097          	auipc	ra,0xfffff
    80004284:	3ac080e7          	jalr	940(ra) # 8000362c <bread>
    80004288:	84aa                	mv	s1,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    8000428a:	3ff97713          	andi	a4,s2,1023
    8000428e:	40ed07bb          	subw	a5,s10,a4
    80004292:	414b86bb          	subw	a3,s7,s4
    80004296:	89be                	mv	s3,a5
    80004298:	2781                	sext.w	a5,a5
    8000429a:	0006861b          	sext.w	a2,a3
    8000429e:	f8f674e3          	bgeu	a2,a5,80004226 <writei+0x4c>
    800042a2:	89b6                	mv	s3,a3
    800042a4:	b749                	j	80004226 <writei+0x4c>
      brelse(bp);
    800042a6:	8526                	mv	a0,s1
    800042a8:	fffff097          	auipc	ra,0xfffff
    800042ac:	4b4080e7          	jalr	1204(ra) # 8000375c <brelse>
  }

  if(off > ip->size)
    800042b0:	04cb2783          	lw	a5,76(s6)
    800042b4:	0127f463          	bgeu	a5,s2,800042bc <writei+0xe2>
    ip->size = off;
    800042b8:	052b2623          	sw	s2,76(s6)
  ...
  iupdate(ip);
    ...
    800042c2:	aa6080e7          	jalr	-1370(ra) # 80003d64 <iupdate>

  return tot;
    800042c6:	000a051b          	sext.w	a0,s4
}
    ...
    800042e6:	8082                	ret
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    800042e8:	8a5e                	mv	s4,s7
    800042ea:	bfc9                	j	800042bc <writei+0xe2>
    return -1;
    800042ec:	557d                	li	a0,-1
}
    800042ee:	8082                	ret
    return -1;
    800042f0:	557d                	li	a0,-1
    800042f2:	bfe1                	j	800042ca <writei+0xf0>
    return -1;
    800042f4:	557d                	li	a0,-1
    800042f6:	bfd1                	j	800042ca <writei+0xf0>

00000000800042f8 <namecmp>:
...
{
    800042f8:	1141                	addi	sp,sp,-16
    800042fa:	e406                	sd	ra,8(sp)
    800042fc:	e022                	sd	s0,0(sp)
    800042fe:	0800                	addi	s0,sp,16
  return strncmp(s, t, DIRSIZ);
    80004300:	4639                	li	a2,14
    80004302:	ffffd097          	auipc	ra,0xffffd
    80004306:	ab6080e7          	jalr	-1354(ra) # 80000db8 <strncmp>
}
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  if(dp->type != T_DIR)
    80004322:	04451703          	lh	a4,68(a0)
    80004326:	4785                	li	a5,1
    80004328:	00f71a63          	bne	a4,a5,8000433c <dirlookup+0x2a>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    80004338:	e79d                	bnez	a5,80004366 <dirlookup+0x54>
    8000433a:	a8a5                	j	800043b2 <dirlookup+0xa0>
    panic("dirlookup not DIR");
    8000433c:	00004517          	auipc	a0,0x4
    80004340:	41c50513          	addi	a0,a0,1052 # 80008758 <syscalls+0x1b8>
    80004344:	ffffc097          	auipc	ra,0xffffc
    80004348:	1fa080e7          	jalr	506(ra) # 8000053e <panic>
      panic("dirlookup read");
    8000434c:	00004517          	auipc	a0,0x4
    80004350:	42450513          	addi	a0,a0,1060 # 80008770 <syscalls+0x1d0>
    80004354:	ffffc097          	auipc	ra,0xffffc
    80004358:	1ea080e7          	jalr	490(ra) # 8000053e <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
    8000435c:	24c1                	addiw	s1,s1,16
    8000435e:	04c92783          	lw	a5,76(s2)
    80004362:	04f4f763          	bgeu	s1,a5,800043b0 <dirlookup+0x9e>
    ...
    80004376:	d70080e7          	jalr	-656(ra) # 800040e2 <readi>
    8000437a:	47c1                	li	a5,16
    8000437c:	fcf518e3          	bne	a0,a5,8000434c <dirlookup+0x3a>
    if(de.inum == 0)
    80004380:	fc045783          	lhu	a5,-64(s0)
    80004384:	dfe1                	beqz	a5,8000435c <dirlookup+0x4a>
    if(namecmp(name, de.name) == 0){
    80004386:	fc240593          	addi	a1,s0,-62
    8000438a:	854e                	mv	a0,s3
    8000438c:	00000097          	auipc	ra,0x0
    80004390:	f6c080e7          	jalr	-148(ra) # 800042f8 <namecmp>
    80004394:	f561                	bnez	a0,8000435c <dirlookup+0x4a>
      if(poff)
    80004396:	000a0463          	beqz	s4,8000439e <dirlookup+0x8c>
        *poff = off;
    ...
    800043aa:	754080e7          	jalr	1876(ra) # 80003afa <iget>
    800043ae:	a011                	j	800043b2 <dirlookup+0xa0>
  return 0;
...
{
    800043c2:	711d                	addi	sp,sp,-96
    800043c4:	ec86                	sd	ra,88(sp)
    800043c6:	e8a2                	sd	s0,80(sp)
    800043c8:	e4a6                	sd	s1,72(sp)
    800043ca:	e0ca                	sd	s2,64(sp)
    800043cc:	fc4e                	sd	s3,56(sp)
    800043ce:	f852                	sd	s4,48(sp)
    800043d0:	f456                	sd	s5,40(sp)
    800043d2:	f05a                	sd	s6,32(sp)
    800043d4:	ec5e                	sd	s7,24(sp)
    800043d6:	e862                	sd	s8,16(sp)
    800043d8:	e466                	sd	s9,8(sp)
    800043da:	1080                	addi	s0,sp,96
    800043dc:	84aa                	mv	s1,a0
    800043de:	8b2e                	mv	s6,a1
    800043e0:	8ab2                	mv	s5,a2
  struct inode *ip, *next;

  if(*path == '/')
    800043e2:	00054703          	lbu	a4,0(a0)
    800043e6:	02f00793          	li	a5,47
    800043ea:	02f70363          	beq	a4,a5,80004410 <namex+0x4e>
    ip = iget(ROOTDEV, ROOTINO);
  else
    ip = idup(myproc()->cwd);
    800043ee:	ffffd097          	auipc	ra,0xffffd
    800043f2:	5c2080e7          	jalr	1474(ra) # 800019b0 <myproc>
    800043f6:	15053503          	ld	a0,336(a0)
    800043fa:	00000097          	auipc	ra,0x0
    800043fe:	9f6080e7          	jalr	-1546(ra) # 80003df0 <idup>
    80004402:	89aa                	mv	s3,a0
  while(*path == '/')
    80004404:	02f00913          	li	s2,47
  len = path - s;
    80004408:	4b81                	li	s7,0
  if(len >= DIRSIZ)
    8000440a:	4cb5                	li	s9,13

  while((path = skipelem(path, name)) != 0){
    ilock(ip);
    if(ip->type != T_DIR){
    8000440c:	4c05                	li	s8,1
    8000440e:	a865                	j	800044c6 <namex+0x104>
    ip = iget(ROOTDEV, ROOTINO);
    80004410:	4585                	li	a1,1
    80004412:	4505                	li	a0,1
    80004414:	fffff097          	auipc	ra,0xfffff
    80004418:	6e6080e7          	jalr	1766(ra) # 80003afa <iget>
    8000441c:	89aa                	mv	s3,a0
    8000441e:	b7dd                	j	80004404 <namex+0x42>
      iunlockput(ip);
    80004420:	854e                	mv	a0,s3
    80004422:	00000097          	auipc	ra,0x0
    80004426:	c6e080e7          	jalr	-914(ra) # 80004090 <iunlockput>
      return 0;
    8000442a:	4981                	li	s3,0
  if(nameiparent){
    iput(ip);
    return 0;
  }
  return ip;
    ...
    8000442e:	60e6                	ld	ra,88(sp)
    80004430:	6446                	ld	s0,80(sp)
    80004432:	64a6                	ld	s1,72(sp)
    80004434:	6906                	ld	s2,64(sp)
    80004436:	79e2                	ld	s3,56(sp)
    80004438:	7a42                	ld	s4,48(sp)
    8000443a:	7aa2                	ld	s5,40(sp)
    8000443c:	7b02                	ld	s6,32(sp)
    8000443e:	6be2                	ld	s7,24(sp)
    80004440:	6c42                	ld	s8,16(sp)
    80004442:	6ca2                	ld	s9,8(sp)
    80004444:	6125                	addi	sp,sp,96
    80004446:	8082                	ret
      iunlock(ip);
    80004448:	854e                	mv	a0,s3
    8000444a:	00000097          	auipc	ra,0x0
    8000444e:	aa6080e7          	jalr	-1370(ra) # 80003ef0 <iunlock>
      return ip;
    80004452:	bfe9                	j	8000442c <namex+0x6a>
      iunlockput(ip);
    80004454:	854e                	mv	a0,s3
    80004456:	00000097          	auipc	ra,0x0
    8000445a:	c3a080e7          	jalr	-966(ra) # 80004090 <iunlockput>
      return 0;
    8000445e:	89d2                	mv	s3,s4
    80004460:	b7f1                	j	8000442c <namex+0x6a>
  len = path - s;
    80004462:	40b48633          	sub	a2,s1,a1
    80004466:	00060a1b          	sext.w	s4,a2
  if(len >= DIRSIZ)
    8000446a:	094cd463          	bge	s9,s4,800044f2 <namex+0x130>
    memmove(name, s, DIRSIZ);
    8000446e:	4639                	li	a2,14
    80004470:	8556                	mv	a0,s5
    80004472:	ffffd097          	auipc	ra,0xffffd
    80004476:	8ce080e7          	jalr	-1842(ra) # 80000d40 <memmove>
  while(*path == '/')
    8000447a:	0004c783          	lbu	a5,0(s1)
    8000447e:	01279763          	bne	a5,s2,8000448c <namex+0xca>
    path++;
    80004482:	0485                	addi	s1,s1,1
  while(*path == '/')
    80004484:	0004c783          	lbu	a5,0(s1)
    80004488:	ff278de3          	beq	a5,s2,80004482 <namex+0xc0>
    ilock(ip);
    8000448c:	854e                	mv	a0,s3
    8000448e:	00000097          	auipc	ra,0x0
    80004492:	9a0080e7          	jalr	-1632(ra) # 80003e2e <ilock>
    if(ip->type != T_DIR){
    80004496:	04499783          	lh	a5,68(s3)
    8000449a:	f98793e3          	bne	a5,s8,80004420 <namex+0x5e>
    if(nameiparent && *path == '\0'){
    8000449e:	000b0563          	beqz	s6,800044a8 <namex+0xe6>
    800044a2:	0004c783          	lbu	a5,0(s1)
    800044a6:	d3cd                	beqz	a5,80004448 <namex+0x86>
    if((next = dirlookup(ip, name, 0)) == 0){
    800044a8:	865e                	mv	a2,s7
    800044aa:	85d6                	mv	a1,s5
    800044ac:	854e                	mv	a0,s3
    800044ae:	00000097          	auipc	ra,0x0
    800044b2:	e64080e7          	jalr	-412(ra) # 80004312 <dirlookup>
    800044b6:	8a2a                	mv	s4,a0
    800044b8:	dd51                	beqz	a0,80004454 <namex+0x92>
    iunlockput(ip);
    800044ba:	854e                	mv	a0,s3
    800044bc:	00000097          	auipc	ra,0x0
    800044c0:	bd4080e7          	jalr	-1068(ra) # 80004090 <iunlockput>
    ip = next;
    800044c4:	89d2                	mv	s3,s4
  while(*path == '/')
    800044c6:	0004c783          	lbu	a5,0(s1)
    800044ca:	05279763          	bne	a5,s2,80004518 <namex+0x156>
    path++;
    800044ce:	0485                	addi	s1,s1,1
  while(*path == '/')
    800044d0:	0004c783          	lbu	a5,0(s1)
    800044d4:	ff278de3          	beq	a5,s2,800044ce <namex+0x10c>
  if(*path == 0)
    800044d8:	c79d                	beqz	a5,80004506 <namex+0x144>
    path++;
    800044da:	85a6                	mv	a1,s1
  len = path - s;
    800044dc:	8a5e                	mv	s4,s7
    800044de:	865e                	mv	a2,s7
  while(*path != '/' && *path != 0)
    800044e0:	01278963          	beq	a5,s2,800044f2 <namex+0x130>
    800044e4:	dfbd                	beqz	a5,80004462 <namex+0xa0>
    path++;
    800044e6:	0485                	addi	s1,s1,1
  while(*path != '/' && *path != 0)
    800044e8:	0004c783          	lbu	a5,0(s1)
    800044ec:	ff279ce3          	bne	a5,s2,800044e4 <namex+0x122>
    800044f0:	bf8d                	j	80004462 <namex+0xa0>
    memmove(name, s, len);
    800044f2:	2601                	sext.w	a2,a2
    800044f4:	8556                	mv	a0,s5
    800044f6:	ffffd097          	auipc	ra,0xffffd
    800044fa:	84a080e7          	jalr	-1974(ra) # 80000d40 <memmove>
    name[len] = 0;
    800044fe:	9a56                	add	s4,s4,s5
    80004500:	000a0023          	sb	zero,0(s4)
    80004504:	bf9d                	j	8000447a <namex+0xb8>
  if(nameiparent){
    80004506:	f20b03e3          	beqz	s6,8000442c <namex+0x6a>
    iput(ip);
    8000450a:	854e                	mv	a0,s3
    8000450c:	00000097          	auipc	ra,0x0
    80004510:	adc080e7          	jalr	-1316(ra) # 80003fe8 <iput>
    return 0;
    80004514:	4981                	li	s3,0
    80004516:	bf19                	j	8000442c <namex+0x6a>
  if(*path == 0)
    80004518:	d7fd                	beqz	a5,80004506 <namex+0x144>
  while(*path != '/' && *path != 0)
    8000451a:	0004c783          	lbu	a5,0(s1)
    8000451e:	85a6                	mv	a1,s1
    80004520:	b7d1                	j	800044e4 <namex+0x122>

0000000080004522 <dirlink>:
{
    ...
    80004534:	8a2e                	mv	s4,a1
    80004536:	89b2                	mv	s3,a2
  if((ip = dirlookup(dp, name, 0)) != 0){
    80004538:	4601                	li	a2,0
    8000453a:	00000097          	auipc	ra,0x0
    8000453e:	dd8080e7          	jalr	-552(ra) # 80004312 <dirlookup>
    80004542:	e93d                	bnez	a0,800045b8 <dirlink+0x96>
  for(off = 0; off < dp->size; off += sizeof(de)){
    80004544:	04c92483          	lw	s1,76(s2)
    80004548:	c49d                	beqz	s1,80004576 <dirlink+0x54>
    8000454a:	4481                	li	s1,0
    if(readi(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    8000454c:	4741                	li	a4,16
    8000454e:	86a6                	mv	a3,s1
    80004550:	fc040613          	addi	a2,s0,-64
    80004554:	4581                	li	a1,0
    80004556:	854a                	mv	a0,s2
    80004558:	00000097          	auipc	ra,0x0
    8000455c:	b8a080e7          	jalr	-1142(ra) # 800040e2 <readi>
    80004560:	47c1                	li	a5,16
    80004562:	06f51163          	bne	a0,a5,800045c4 <dirlink+0xa2>
    if(de.inum == 0)
    80004566:	fc045783          	lhu	a5,-64(s0)
    8000456a:	c791                	beqz	a5,80004576 <dirlink+0x54>
  for(off = 0; off < dp->size; off += sizeof(de)){
    8000456c:	24c1                	addiw	s1,s1,16
    8000456e:	04c92783          	lw	a5,76(s2)
    80004572:	fcf4ede3          	bltu	s1,a5,8000454c <dirlink+0x2a>
  strncpy(de.name, name, DIRSIZ);
    80004576:	4639                	li	a2,14
    80004578:	85d2                	mv	a1,s4
    8000457a:	fc240513          	addi	a0,s0,-62
    8000457e:	ffffd097          	auipc	ra,0xffffd
    80004582:	876080e7          	jalr	-1930(ra) # 80000df4 <strncpy>
  de.inum = inum;
    80004586:	fd341023          	sh	s3,-64(s0)
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    8000458a:	4741                	li	a4,16
    8000458c:	86a6                	mv	a3,s1
    8000458e:	fc040613          	addi	a2,s0,-64
    80004592:	4581                	li	a1,0
    80004594:	854a                	mv	a0,s2
    80004596:	00000097          	auipc	ra,0x0
    8000459a:	c44080e7          	jalr	-956(ra) # 800041da <writei>
    8000459e:	872a                	mv	a4,a0
    800045a0:	47c1                	li	a5,16
  return 0;
    800045a2:	4501                	li	a0,0
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    800045a4:	02f71863          	bne	a4,a5,800045d4 <dirlink+0xb2>
}
...
namei(char *path)
{
  ...
  return namex(path, 0, name);
    800045ec:	fe040613          	addi	a2,s0,-32
    800045f0:	4581                	li	a1,0
    800045f2:	00000097          	auipc	ra,0x0
    800045f6:	dd0080e7          	jalr	-560(ra) # 800043c2 <namex>
}
...
nameiparent(char *path, char *name)
{
  ...
  return namex(path, 1, name);
    ...
    80004612:	db4080e7          	jalr	-588(ra) # 800043c2 <namex>
}
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    8000462a:	0001f917          	auipc	s2,0x1f
    8000462e:	8be90913          	addi	s2,s2,-1858 # 80022ee8 <log>
    80004632:	01892583          	lw	a1,24(s2)
    80004636:	02892503          	lw	a0,40(s2)
    8000463a:	fffff097          	auipc	ra,0xfffff
    8000463e:	ff2080e7          	jalr	-14(ra) # 8000362c <bread>
    80004642:	84aa                	mv	s1,a0
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
    80004644:	02c92683          	lw	a3,44(s2)
    80004648:	cd34                	sw	a3,88(a0)
  for (i = 0; i < log.lh.n; i++) {
    8000464a:	02d05763          	blez	a3,80004678 <write_head+0x5a>
    8000464e:	0001f797          	auipc	a5,0x1f
    80004652:	8ca78793          	addi	a5,a5,-1846 # 80022f18 <log+0x30>
    80004656:	05c50713          	addi	a4,a0,92
    8000465a:	36fd                	addiw	a3,a3,-1
    8000465c:	1682                	slli	a3,a3,0x20
    8000465e:	9281                	srli	a3,a3,0x20
    80004660:	068a                	slli	a3,a3,0x2
    80004662:	0001f617          	auipc	a2,0x1f
    80004666:	8ba60613          	addi	a2,a2,-1862 # 80022f1c <log+0x34>
    8000466a:	96b2                	add	a3,a3,a2
    hb->block[i] = log.lh.block[i];
    8000466c:	4390                	lw	a2,0(a5)
    8000466e:	c310                	sw	a2,0(a4)
  for (i = 0; i < log.lh.n; i++) {
    80004670:	0791                	addi	a5,a5,4
    80004672:	0711                	addi	a4,a4,4
    80004674:	fed79ce3          	bne	a5,a3,8000466c <write_head+0x4e>
  }
  bwrite(buf);
    80004678:	8526                	mv	a0,s1
    8000467a:	fffff097          	auipc	ra,0xfffff
    8000467e:	0a4080e7          	jalr	164(ra) # 8000371e <bwrite>
  brelse(buf);
    80004682:	8526                	mv	a0,s1
    80004684:	fffff097          	auipc	ra,0xfffff
    80004688:	0d8080e7          	jalr	216(ra) # 8000375c <brelse>
}
...
0000000080004698 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    80004698:	0001f797          	auipc	a5,0x1f
    8000469c:	87c7a783          	lw	a5,-1924(a5) # 80022f14 <log+0x2c>
    800046a0:	0af05d63          	blez	a5,8000475a <install_trans+0xc2>
{
    800046a4:	7139                	addi	sp,sp,-64
    ...
    800046b4:	e05a                	sd	s6,0(sp)
    800046b6:	0080                	addi	s0,sp,64
    800046b8:	8b2a                	mv	s6,a0
    800046ba:	0001fa97          	auipc	s5,0x1f
    800046be:	85ea8a93          	addi	s5,s5,-1954 # 80022f18 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    800046c2:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    800046c4:	0001f997          	auipc	s3,0x1f
    800046c8:	82498993          	addi	s3,s3,-2012 # 80022ee8 <log>
    800046cc:	a035                	j	800046f8 <install_trans+0x60>
      bunpin(dbuf);
    800046ce:	8526                	mv	a0,s1
    800046d0:	fffff097          	auipc	ra,0xfffff
    800046d4:	166080e7          	jalr	358(ra) # 80003836 <bunpin>
    brelse(lbuf);
    800046d8:	854a                	mv	a0,s2
    800046da:	fffff097          	auipc	ra,0xfffff
    800046de:	082080e7          	jalr	130(ra) # 8000375c <brelse>
    brelse(dbuf);
    800046e2:	8526                	mv	a0,s1
    800046e4:	fffff097          	auipc	ra,0xfffff
    800046e8:	078080e7          	jalr	120(ra) # 8000375c <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    800046ec:	2a05                	addiw	s4,s4,1
    800046ee:	0a91                	addi	s5,s5,4
    800046f0:	02c9a783          	lw	a5,44(s3)
    800046f4:	04fa5963          	bge	s4,a5,80004746 <install_trans+0xae>
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    800046f8:	0189a583          	lw	a1,24(s3)
    800046fc:	014585bb          	addw	a1,a1,s4
    80004700:	2585                	addiw	a1,a1,1
    80004702:	0289a503          	lw	a0,40(s3)
    80004706:	fffff097          	auipc	ra,0xfffff
    8000470a:	f26080e7          	jalr	-218(ra) # 8000362c <bread>
    ...
    8000471c:	f14080e7          	jalr	-236(ra) # 8000362c <bread>
    80004720:	84aa                	mv	s1,a0
    memmove(dbuf->data, lbuf->data, BSIZE);  // copy block to dst
    80004722:	40000613          	li	a2,1024
    80004726:	05890593          	addi	a1,s2,88
    8000472a:	05850513          	addi	a0,a0,88
    8000472e:	ffffc097          	auipc	ra,0xffffc
    80004732:	612080e7          	jalr	1554(ra) # 80000d40 <memmove>
    bwrite(dbuf);  // write dst to disk
    80004736:	8526                	mv	a0,s1
    80004738:	fffff097          	auipc	ra,0xfffff
    8000473c:	fe6080e7          	jalr	-26(ra) # 8000371e <bwrite>
    if(recovering == 0)
    80004740:	f80b1ce3          	bnez	s6,800046d8 <install_trans+0x40>
    80004744:	b769                	j	800046ce <install_trans+0x36>
}
    ...
    80004754:	6b02                	ld	s6,0(sp)
    80004756:	6121                	addi	sp,sp,64
    80004758:	8082                	ret
    8000475a:	8082                	ret

000000008000475c <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80004772:	77a48493          	addi	s1,s1,1914 # 80022ee8 <log>
    80004776:	00004597          	auipc	a1,0x4
    8000477a:	01a58593          	addi	a1,a1,26 # 80008790 <syscalls+0x1f0>
    8000477e:	8526                	mv	a0,s1
    80004780:	ffffc097          	auipc	ra,0xffffc
    80004784:	3d4080e7          	jalr	980(ra) # 80000b54 <initlock>
  log.start = sb->logstart;
    80004788:	0149a583          	lw	a1,20(s3)
    8000478c:	cc8c                	sw	a1,24(s1)
  log.size = sb->nlog;
    8000478e:	0109a783          	lw	a5,16(s3)
    80004792:	ccdc                	sw	a5,28(s1)
  log.dev = dev;
    80004794:	0324a423          	sw	s2,40(s1)
  struct buf *buf = bread(log.dev, log.start);
    80004798:	854a                	mv	a0,s2
    8000479a:	fffff097          	auipc	ra,0xfffff
    8000479e:	e92080e7          	jalr	-366(ra) # 8000362c <bread>
  log.lh.n = lh->n;
    800047a2:	4d3c                	lw	a5,88(a0)
    800047a4:	d4dc                	sw	a5,44(s1)
  for (i = 0; i < log.lh.n; i++) {
    800047a6:	02f05563          	blez	a5,800047d0 <initlog+0x74>
    800047aa:	05c50713          	addi	a4,a0,92
    800047ae:	0001e697          	auipc	a3,0x1e
    800047b2:	76a68693          	addi	a3,a3,1898 # 80022f18 <log+0x30>
    800047b6:	37fd                	addiw	a5,a5,-1
    800047b8:	1782                	slli	a5,a5,0x20
    800047ba:	9381                	srli	a5,a5,0x20
    800047bc:	078a                	slli	a5,a5,0x2
    800047be:	06050613          	addi	a2,a0,96
    800047c2:	97b2                	add	a5,a5,a2
    log.lh.block[i] = lh->block[i];
    800047c4:	4310                	lw	a2,0(a4)
    800047c6:	c290                	sw	a2,0(a3)
  for (i = 0; i < log.lh.n; i++) {
    800047c8:	0711                	addi	a4,a4,4
    800047ca:	0691                	addi	a3,a3,4
    800047cc:	fef71ce3          	bne	a4,a5,800047c4 <initlog+0x68>
  brelse(buf);
    800047d0:	fffff097          	auipc	ra,0xfffff
    800047d4:	f8c080e7          	jalr	-116(ra) # 8000375c <brelse>
...
recover_from_log(void)
{
  ...
  install_trans(1); // if committed, copy from log to disk
    ...
    800047de:	ebe080e7          	jalr	-322(ra) # 80004698 <install_trans>
  log.lh.n = 0;
    800047e2:	0001e797          	auipc	a5,0x1e
    800047e6:	7207a923          	sw	zero,1842(a5) # 80022f14 <log+0x2c>
  write_head(); // clear the log
    800047ea:	00000097          	auipc	ra,0x0
    800047ee:	e34080e7          	jalr	-460(ra) # 8000461e <write_head>
}
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80004810:	6dc50513          	addi	a0,a0,1756 # 80022ee8 <log>
    80004814:	ffffc097          	auipc	ra,0xffffc
    80004818:	3d0080e7          	jalr	976(ra) # 80000be4 <acquire>
  while(1){
    if(log.committing){
    8000481c:	0001e497          	auipc	s1,0x1e
    80004820:	6cc48493          	addi	s1,s1,1740 # 80022ee8 <log>
      sleep(&log, &log.lock);
    ...
    80004830:	7ca080e7          	jalr	1994(ra) # 80001ff6 <sleep>
    if(log.committing){
    ...
    8000485c:	79e080e7          	jalr	1950(ra) # 80001ff6 <sleep>
    80004860:	bfd1                	j	80004834 <begin_op+0x34>
    } else {
      log.outstanding += 1;
    80004862:	0001e517          	auipc	a0,0x1e
    80004866:	68650513          	addi	a0,a0,1670 # 80022ee8 <log>
    8000486a:	d114                	sw	a3,32(a0)
      release(&log.lock);
    8000486c:	ffffc097          	auipc	ra,0xffffc
    80004870:	42c080e7          	jalr	1068(ra) # 80000c98 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80004896:	65648493          	addi	s1,s1,1622 # 80022ee8 <log>
  ...
  if(log.committing)
    ...
    800048b0:	efb9                	bnez	a5,8000490e <end_op+0x8e>
    panic("log.committing");
  if(log.outstanding == 0){
    800048b2:	06091663          	bnez	s2,8000491e <end_op+0x9e>
    do_commit = 1;
    log.committing = 1;
    800048b6:	0001e497          	auipc	s1,0x1e
    800048ba:	63248493          	addi	s1,s1,1586 # 80022ee8 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    acquire(&log.lock);
    800048d2:	0001e497          	auipc	s1,0x1e
    800048d6:	61648493          	addi	s1,s1,1558 # 80022ee8 <log>
    800048da:	8526                	mv	a0,s1
    800048dc:	ffffc097          	auipc	ra,0xffffc
    800048e0:	308080e7          	jalr	776(ra) # 80000be4 <acquire>
    log.committing = 0;
    800048e4:	0204a223          	sw	zero,36(s1)
    wakeup(&log);
    800048e8:	8526                	mv	a0,s1
    800048ea:	ffffe097          	auipc	ra,0xffffe
    800048ee:	898080e7          	jalr	-1896(ra) # 80002182 <wakeup>
    release(&log.lock);
    ...
    80004912:	e8a50513          	addi	a0,a0,-374 # 80008798 <syscalls+0x1f8>
    80004916:	ffffc097          	auipc	ra,0xffffc
    8000491a:	c28080e7          	jalr	-984(ra) # 8000053e <panic>
    wakeup(&log);
    8000491e:	0001e497          	auipc	s1,0x1e
    80004922:	5ca48493          	addi	s1,s1,1482 # 80022ee8 <log>
    80004926:	8526                	mv	a0,s1
    80004928:	ffffe097          	auipc	ra,0xffffe
    8000492c:	85a080e7          	jalr	-1958(ra) # 80002182 <wakeup>
  release(&log.lock);
    80004930:	8526                	mv	a0,s1
    80004932:	ffffc097          	auipc	ra,0xffffc
    80004936:	366080e7          	jalr	870(ra) # 80000c98 <release>
  if(do_commit){
    8000493a:	b7c9                	j	800048fc <end_op+0x7c>
  for (tail = 0; tail < log.lh.n; tail++) {
    8000493c:	0001ea97          	auipc	s5,0x1e
    80004940:	5dca8a93          	addi	s5,s5,1500 # 80022f18 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004944:	0001ea17          	auipc	s4,0x1e
    80004948:	5a4a0a13          	addi	s4,s4,1444 # 80022ee8 <log>
    ...
    8000495e:	cd2080e7          	jalr	-814(ra) # 8000362c <bread>
    ...
    80004970:	cc0080e7          	jalr	-832(ra) # 8000362c <bread>
    ...
    80004986:	3be080e7          	jalr	958(ra) # 80000d40 <memmove>
    bwrite(to);  // write the log
    8000498a:	8526                	mv	a0,s1
    8000498c:	fffff097          	auipc	ra,0xfffff
    80004990:	d92080e7          	jalr	-622(ra) # 8000371e <bwrite>
    brelse(from);
    80004994:	854e                	mv	a0,s3
    80004996:	fffff097          	auipc	ra,0xfffff
    8000499a:	dc6080e7          	jalr	-570(ra) # 8000375c <brelse>
    brelse(to);
    8000499e:	8526                	mv	a0,s1
    800049a0:	fffff097          	auipc	ra,0xfffff
    800049a4:	dbc080e7          	jalr	-580(ra) # 8000375c <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800049b8:	c6a080e7          	jalr	-918(ra) # 8000461e <write_head>
    install_trans(0); // Now install writes to home locations
    800049bc:	4501                	li	a0,0
    800049be:	00000097          	auipc	ra,0x0
    800049c2:	cda080e7          	jalr	-806(ra) # 80004698 <install_trans>
    log.lh.n = 0;
    800049c6:	0001e797          	auipc	a5,0x1e
    800049ca:	5407a723          	sw	zero,1358(a5) # 80022f14 <log+0x2c>
    write_head();    // Erase the transaction from the log
    800049ce:	00000097          	auipc	ra,0x0
    800049d2:	c50080e7          	jalr	-944(ra) # 8000461e <write_head>
    800049d6:	bdf5                	j	800048d2 <end_op+0x52>

00000000800049d8 <log_write>:
//   modify bp->data[]
//   log_write(bp)
//   brelse(bp)
void
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    800049e6:	0001e917          	auipc	s2,0x1e
    800049ea:	50290913          	addi	s2,s2,1282 # 80022ee8 <log>
    800049ee:	854a                	mv	a0,s2
    800049f0:	ffffc097          	auipc	ra,0xffffc
    800049f4:	1f4080e7          	jalr	500(ra) # 80000be4 <acquire>
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    800049f8:	02c92603          	lw	a2,44(s2)
    800049fc:	47f5                	li	a5,29
    800049fe:	06c7c563          	blt	a5,a2,80004a68 <log_write+0x90>
    80004a02:	0001e797          	auipc	a5,0x1e
    80004a06:	5027a783          	lw	a5,1282(a5) # 80022f04 <log+0x1c>
    80004a0a:	37fd                	addiw	a5,a5,-1
    80004a0c:	04f65e63          	bge	a2,a5,80004a68 <log_write+0x90>
    panic("too big a transaction");
  if (log.outstanding < 1)
    80004a10:	0001e797          	auipc	a5,0x1e
    80004a14:	4f87a783          	lw	a5,1272(a5) # 80022f08 <log+0x20>
    80004a18:	06f05063          	blez	a5,80004a78 <log_write+0xa0>
    panic("log_write outside of trans");

  for (i = 0; i < log.lh.n; i++) {
    80004a1c:	4781                	li	a5,0
    80004a1e:	06c05563          	blez	a2,80004a88 <log_write+0xb0>
    if (log.lh.block[i] == b->blockno)   // log absorption
    80004a22:	44cc                	lw	a1,12(s1)
    80004a24:	0001e717          	auipc	a4,0x1e
    80004a28:	4f470713          	addi	a4,a4,1268 # 80022f18 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
    80004a2c:	4781                	li	a5,0
    if (log.lh.block[i] == b->blockno)   // log absorption
    80004a2e:	4314                	lw	a3,0(a4)
    80004a30:	04b68c63          	beq	a3,a1,80004a88 <log_write+0xb0>
  for (i = 0; i < log.lh.n; i++) {
    80004a34:	2785                	addiw	a5,a5,1
    80004a36:	0711                	addi	a4,a4,4
    80004a38:	fef61be3          	bne	a2,a5,80004a2e <log_write+0x56>
      break;
  }
  log.lh.block[i] = b->blockno;
    80004a3c:	0621                	addi	a2,a2,8
    80004a3e:	060a                	slli	a2,a2,0x2
    80004a40:	0001e797          	auipc	a5,0x1e
    80004a44:	4a878793          	addi	a5,a5,1192 # 80022ee8 <log>
    80004a48:	963e                	add	a2,a2,a5
    80004a4a:	44dc                	lw	a5,12(s1)
    80004a4c:	ca1c                	sw	a5,16(a2)
  if (i == log.lh.n) {  // Add new block to log?
    bpin(b);
    80004a4e:	8526                	mv	a0,s1
    80004a50:	fffff097          	auipc	ra,0xfffff
    80004a54:	daa080e7          	jalr	-598(ra) # 800037fa <bpin>
    log.lh.n++;
    80004a58:	0001e717          	auipc	a4,0x1e
    80004a5c:	49070713          	addi	a4,a4,1168 # 80022ee8 <log>
    80004a60:	575c                	lw	a5,44(a4)
    80004a62:	2785                	addiw	a5,a5,1
    80004a64:	d75c                	sw	a5,44(a4)
    80004a66:	a835                	j	80004aa2 <log_write+0xca>
    panic("too big a transaction");
    80004a68:	00004517          	auipc	a0,0x4
    80004a6c:	d4050513          	addi	a0,a0,-704 # 800087a8 <syscalls+0x208>
    80004a70:	ffffc097          	auipc	ra,0xffffc
    80004a74:	ace080e7          	jalr	-1330(ra) # 8000053e <panic>
    panic("log_write outside of trans");
    80004a78:	00004517          	auipc	a0,0x4
    80004a7c:	d4850513          	addi	a0,a0,-696 # 800087c0 <syscalls+0x220>
    80004a80:	ffffc097          	auipc	ra,0xffffc
    80004a84:	abe080e7          	jalr	-1346(ra) # 8000053e <panic>
  log.lh.block[i] = b->blockno;
    80004a88:	00878713          	addi	a4,a5,8
    80004a8c:	00271693          	slli	a3,a4,0x2
    80004a90:	0001e717          	auipc	a4,0x1e
    80004a94:	45870713          	addi	a4,a4,1112 # 80022ee8 <log>
    80004a98:	9736                	add	a4,a4,a3
    80004a9a:	44d4                	lw	a3,12(s1)
    80004a9c:	cb14                	sw	a3,16(a4)
  if (i == log.lh.n) {  // Add new block to log?
    80004a9e:	faf608e3          	beq	a2,a5,80004a4e <log_write+0x76>
  }
  release(&log.lock);
    80004aa2:	0001e517          	auipc	a0,0x1e
    80004aa6:	44650513          	addi	a0,a0,1094 # 80022ee8 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80004ad2:	d1258593          	addi	a1,a1,-750 # 800087e0 <syscalls+0x240>
    80004ad6:	0521                	addi	a0,a0,8
    80004ad8:	ffffc097          	auipc	ra,0xffffc
    80004adc:	07c080e7          	jalr	124(ra) # 80000b54 <initlock>
  lk->name = name;
    80004ae0:	0324b023          	sd	s2,32(s1)
  lk->locked = 0;
    80004ae4:	0004a023          	sw	zero,0(s1)
  lk->pid = 0;
    80004ae8:	0204a423          	sw	zero,40(s1)
}
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    80004b06:	00850913          	addi	s2,a0,8
    80004b0a:	854a                	mv	a0,s2
    80004b0c:	ffffc097          	auipc	ra,0xffffc
    80004b10:	0d8080e7          	jalr	216(ra) # 80000be4 <acquire>
  while (lk->locked) {
    80004b14:	409c                	lw	a5,0(s1)
    80004b16:	cb89                	beqz	a5,80004b28 <acquiresleep+0x30>
    sleep(lk, &lk->lk);
    80004b18:	85ca                	mv	a1,s2
    80004b1a:	8526                	mv	a0,s1
    80004b1c:	ffffd097          	auipc	ra,0xffffd
    80004b20:	4da080e7          	jalr	1242(ra) # 80001ff6 <sleep>
  while (lk->locked) {
    80004b24:	409c                	lw	a5,0(s1)
    80004b26:	fbed                	bnez	a5,80004b18 <acquiresleep+0x20>
  }
  lk->locked = 1;
    80004b28:	4785                	li	a5,1
    80004b2a:	c09c                	sw	a5,0(s1)
  lk->pid = myproc()->pid;
    80004b2c:	ffffd097          	auipc	ra,0xffffd
    80004b30:	e84080e7          	jalr	-380(ra) # 800019b0 <myproc>
    80004b34:	591c                	lw	a5,48(a0)
    80004b36:	d49c                	sw	a5,40(s1)
  release(&lk->lk);
...
releasesleep(struct sleeplock *lk)
{
  ...
  lk->pid = 0;
    80004b6e:	0204a423          	sw	zero,40(s1)
  wakeup(lk);
    80004b72:	8526                	mv	a0,s1
    80004b74:	ffffd097          	auipc	ra,0xffffd
    80004b78:	60e080e7          	jalr	1550(ra) # 80002182 <wakeup>
  release(&lk->lk);
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    80004ba2:	00850913          	addi	s2,a0,8
    80004ba6:	854a                	mv	a0,s2
    80004ba8:	ffffc097          	auipc	ra,0xffffc
    80004bac:	03c080e7          	jalr	60(ra) # 80000be4 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
    80004bb0:	409c                	lw	a5,0(s1)
    80004bb2:	ef99                	bnez	a5,80004bd0 <holdingsleep+0x3e>
    80004bb4:	4481                	li	s1,0
  release(&lk->lk);
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80004bf4:	c0058593          	addi	a1,a1,-1024 # 800087f0 <syscalls+0x250>
    80004bf8:	0001e517          	auipc	a0,0x1e
    80004bfc:	43850513          	addi	a0,a0,1080 # 80023030 <ftable>
...
filealloc(void)
{
  ...
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80004c2a:	0001e497          	auipc	s1,0x1e
    80004c2e:	41e48493          	addi	s1,s1,1054 # 80023048 <ftable+0x18>
    80004c32:	0001f717          	auipc	a4,0x1f
    80004c36:	3b670713          	addi	a4,a4,950 # 80023fe8 <ftable+0xfb8>
    if(f->ref == 0){
    80004c3a:	40dc                	lw	a5,4(s1)
    80004c3c:	cf99                	beqz	a5,80004c5a <filealloc+0x4a>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80004c3e:	02848493          	addi	s1,s1,40
    80004c42:	fee49ce3          	bne	s1,a4,80004c3a <filealloc+0x2a>
      f->ref = 1;
      release(&ftable.lock);
      return f;
    }
  ...
  release(&ftable.lock);
    80004c46:	0001e517          	auipc	a0,0x1e
    80004c4a:	3ea50513          	addi	a0,a0,1002 # 80023030 <ftable>
    80004c4e:	ffffc097          	auipc	ra,0xffffc
    80004c52:	04a080e7          	jalr	74(ra) # 80000c98 <release>
  return 0;
    80004c56:	4481                	li	s1,0
    80004c58:	a819                	j	80004c6e <filealloc+0x5e>
      f->ref = 1;
    80004c5a:	4785                	li	a5,1
    80004c5c:	c0dc                	sw	a5,4(s1)
      release(&ftable.lock);
    80004c5e:	0001e517          	auipc	a0,0x1e
    80004c62:	3d250513          	addi	a0,a0,978 # 80023030 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    80004c86:	0001e517          	auipc	a0,0x1e
    80004c8a:	3aa50513          	addi	a0,a0,938 # 80023030 <ftable>
    80004c8e:	ffffc097          	auipc	ra,0xffffc
    80004c92:	f56080e7          	jalr	-170(ra) # 80000be4 <acquire>
  if(f->ref < 1)
    80004c96:	40dc                	lw	a5,4(s1)
    80004c98:	02f05263          	blez	a5,80004cbc <filedup+0x42>
    panic("filedup");
  f->ref++;
    80004c9c:	2785                	addiw	a5,a5,1
    80004c9e:	c0dc                	sw	a5,4(s1)
  release(&ftable.lock);
    80004ca0:	0001e517          	auipc	a0,0x1e
    80004ca4:	39050513          	addi	a0,a0,912 # 80023030 <ftable>
    80004ca8:	ffffc097          	auipc	ra,0xffffc
    80004cac:	ff0080e7          	jalr	-16(ra) # 80000c98 <release>
  return f;
}
    ...
    80004cc0:	b3c50513          	addi	a0,a0,-1220 # 800087f8 <syscalls+0x258>
    80004cc4:	ffffc097          	auipc	ra,0xffffc
    80004cc8:	87a080e7          	jalr	-1926(ra) # 8000053e <panic>

0000000080004ccc <fileclose>:

// Close file f.  (Decrement ref count, close when reaches 0.)
void
fileclose(struct file *f)
{
    80004ccc:	7139                	addi	sp,sp,-64
    80004cce:	fc06                	sd	ra,56(sp)
    80004cd0:	f822                	sd	s0,48(sp)
    80004cd2:	f426                	sd	s1,40(sp)
    80004cd4:	f04a                	sd	s2,32(sp)
    80004cd6:	ec4e                	sd	s3,24(sp)
    80004cd8:	e852                	sd	s4,16(sp)
    80004cda:	e456                	sd	s5,8(sp)
  ...
  acquire(&ftable.lock);
    ...
    80004ce4:	35050513          	addi	a0,a0,848 # 80023030 <ftable>
    80004ce8:	ffffc097          	auipc	ra,0xffffc
    80004cec:	efc080e7          	jalr	-260(ra) # 80000be4 <acquire>
  if(f->ref < 1)
    80004cf0:	40dc                	lw	a5,4(s1)
    80004cf2:	06f05163          	blez	a5,80004d54 <fileclose+0x88>
    panic("fileclose");
  if(--f->ref > 0){
    80004cf6:	37fd                	addiw	a5,a5,-1
    80004cf8:	0007871b          	sext.w	a4,a5
    80004cfc:	c0dc                	sw	a5,4(s1)
    80004cfe:	06e04363          	bgtz	a4,80004d64 <fileclose+0x98>
    release(&ftable.lock);
    return;
  }
  ff = *f;
    80004d02:	0004a903          	lw	s2,0(s1)
    80004d06:	0094ca83          	lbu	s5,9(s1)
    80004d0a:	0104ba03          	ld	s4,16(s1)
    80004d0e:	0184b983          	ld	s3,24(s1)
  f->ref = 0;
    80004d12:	0004a223          	sw	zero,4(s1)
  f->type = FD_NONE;
    80004d16:	0004a023          	sw	zero,0(s1)
  release(&ftable.lock);
    80004d1a:	0001e517          	auipc	a0,0x1e
    80004d1e:	31650513          	addi	a0,a0,790 # 80023030 <ftable>
    80004d22:	ffffc097          	auipc	ra,0xffffc
    80004d26:	f76080e7          	jalr	-138(ra) # 80000c98 <release>

  if(ff.type == FD_PIPE){
    80004d2a:	4785                	li	a5,1
    80004d2c:	04f90d63          	beq	s2,a5,80004d86 <fileclose+0xba>
    pipeclose(ff.pipe, ff.writable);
  } else if(ff.type == FD_INODE || ff.type == FD_DEVICE){
    80004d30:	3979                	addiw	s2,s2,-2
    80004d32:	4785                	li	a5,1
    80004d34:	0527e063          	bltu	a5,s2,80004d74 <fileclose+0xa8>
    begin_op();
    80004d38:	00000097          	auipc	ra,0x0
    80004d3c:	ac8080e7          	jalr	-1336(ra) # 80004800 <begin_op>
    iput(ff.ip);
    80004d40:	854e                	mv	a0,s3
    80004d42:	fffff097          	auipc	ra,0xfffff
    80004d46:	2a6080e7          	jalr	678(ra) # 80003fe8 <iput>
    end_op();
    80004d4a:	00000097          	auipc	ra,0x0
    80004d4e:	b36080e7          	jalr	-1226(ra) # 80004880 <end_op>
    80004d52:	a00d                	j	80004d74 <fileclose+0xa8>
    panic("fileclose");
    80004d54:	00004517          	auipc	a0,0x4
    80004d58:	aac50513          	addi	a0,a0,-1364 # 80008800 <syscalls+0x260>
    80004d5c:	ffffb097          	auipc	ra,0xffffb
    80004d60:	7e2080e7          	jalr	2018(ra) # 8000053e <panic>
    release(&ftable.lock);
    80004d64:	0001e517          	auipc	a0,0x1e
    80004d68:	2cc50513          	addi	a0,a0,716 # 80023030 <ftable>
    80004d6c:	ffffc097          	auipc	ra,0xffffc
    80004d70:	f2c080e7          	jalr	-212(ra) # 80000c98 <release>
  }
}
    80004d74:	70e2                	ld	ra,56(sp)
    80004d76:	7442                	ld	s0,48(sp)
    80004d78:	74a2                	ld	s1,40(sp)
    80004d7a:	7902                	ld	s2,32(sp)
    80004d7c:	69e2                	ld	s3,24(sp)
    80004d7e:	6a42                	ld	s4,16(sp)
    80004d80:	6aa2                	ld	s5,8(sp)
    80004d82:	6121                	addi	sp,sp,64
    80004d84:	8082                	ret
    pipeclose(ff.pipe, ff.writable);
    80004d86:	85d6                	mv	a1,s5
    80004d88:	8552                	mv	a0,s4
    80004d8a:	00000097          	auipc	ra,0x0
    80004d8e:	34c080e7          	jalr	844(ra) # 800050d6 <pipeclose>
    80004d92:	b7cd                	j	80004d74 <fileclose+0xa8>

0000000080004d94 <filestat>:
...
filestat(struct file *f, uint64 addr)
{
  ...
  struct proc *p = myproc();
    ...
    80004daa:	c0a080e7          	jalr	-1014(ra) # 800019b0 <myproc>
  struct stat st;
  
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    80004dae:	409c                	lw	a5,0(s1)
    80004db0:	37f9                	addiw	a5,a5,-2
    80004db2:	4705                	li	a4,1
    80004db4:	04f76763          	bltu	a4,a5,80004e02 <filestat+0x6e>
    80004db8:	892a                	mv	s2,a0
    ilock(f->ip);
    80004dba:	6c88                	ld	a0,24(s1)
    80004dbc:	fffff097          	auipc	ra,0xfffff
    80004dc0:	072080e7          	jalr	114(ra) # 80003e2e <ilock>
    stati(f->ip, &st);
    80004dc4:	fb840593          	addi	a1,s0,-72
    80004dc8:	6c88                	ld	a0,24(s1)
    80004dca:	fffff097          	auipc	ra,0xfffff
    80004dce:	2ee080e7          	jalr	750(ra) # 800040b8 <stati>
    iunlock(f->ip);
    80004dd2:	6c88                	ld	a0,24(s1)
    80004dd4:	fffff097          	auipc	ra,0xfffff
    80004dd8:	11c080e7          	jalr	284(ra) # 80003ef0 <iunlock>
    if(copyout(p->pagetable, addr, (char *)&st, sizeof(st)) < 0)
    80004ddc:	46e1                	li	a3,24
    80004dde:	fb840613          	addi	a2,s0,-72
    80004de2:	85ce                	mv	a1,s3
    80004de4:	05093503          	ld	a0,80(s2)
    80004de8:	ffffd097          	auipc	ra,0xffffd
    80004dec:	88a080e7          	jalr	-1910(ra) # 80001672 <copyout>
    80004df0:	41f5551b          	sraiw	a0,a0,0x1f
      return -1;
    return 0;
  }
  return -1;
  ...
  return -1;
    ...
    80004e04:	bfc5                	j	80004df4 <filestat+0x60>

0000000080004e06 <fileread>:
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->readable == 0)
    80004e14:	00854783          	lbu	a5,8(a0)
    80004e18:	c3d5                	beqz	a5,80004ebc <fileread+0xb6>
    80004e1a:	84aa                	mv	s1,a0
    80004e1c:	89ae                	mv	s3,a1
    80004e1e:	8932                	mv	s2,a2
    return -1;

  if(f->type == FD_PIPE){
    80004e20:	411c                	lw	a5,0(a0)
    80004e22:	4705                	li	a4,1
    80004e24:	04e78963          	beq	a5,a4,80004e76 <fileread+0x70>
    r = piperead(f->pipe, addr, n);
  } else if(f->type == FD_DEVICE){
    80004e28:	470d                	li	a4,3
    80004e2a:	04e78d63          	beq	a5,a4,80004e84 <fileread+0x7e>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].read)
      return -1;
    r = devsw[f->major].read(1, addr, n);
  } else if(f->type == FD_INODE){
    80004e2e:	4709                	li	a4,2
    80004e30:	06e79e63          	bne	a5,a4,80004eac <fileread+0xa6>
    ilock(f->ip);
    80004e34:	6d08                	ld	a0,24(a0)
    80004e36:	fffff097          	auipc	ra,0xfffff
    80004e3a:	ff8080e7          	jalr	-8(ra) # 80003e2e <ilock>
    if((r = readi(f->ip, 1, addr, f->off, n)) > 0)
    80004e3e:	874a                	mv	a4,s2
    80004e40:	5094                	lw	a3,32(s1)
    80004e42:	864e                	mv	a2,s3
    80004e44:	4585                	li	a1,1
    80004e46:	6c88                	ld	a0,24(s1)
    80004e48:	fffff097          	auipc	ra,0xfffff
    80004e4c:	29a080e7          	jalr	666(ra) # 800040e2 <readi>
    80004e50:	892a                	mv	s2,a0
    80004e52:	00a05563          	blez	a0,80004e5c <fileread+0x56>
      f->off += r;
    80004e56:	509c                	lw	a5,32(s1)
    80004e58:	9fa9                	addw	a5,a5,a0
    80004e5a:	d09c                	sw	a5,32(s1)
    iunlock(f->ip);
    80004e5c:	6c88                	ld	a0,24(s1)
    80004e5e:	fffff097          	auipc	ra,0xfffff
    80004e62:	092080e7          	jalr	146(ra) # 80003ef0 <iunlock>
  } else {
    panic("fileread");
  }
  ...
  return r;
    ...
    80004e74:	8082                	ret
    r = piperead(f->pipe, addr, n);
    80004e76:	6908                	ld	a0,16(a0)
    80004e78:	00000097          	auipc	ra,0x0
    80004e7c:	3c8080e7          	jalr	968(ra) # 80005240 <piperead>
    80004e80:	892a                	mv	s2,a0
    80004e82:	b7d5                	j	80004e66 <fileread+0x60>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].read)
    80004e84:	02451783          	lh	a5,36(a0)
    80004e88:	03079693          	slli	a3,a5,0x30
    80004e8c:	92c1                	srli	a3,a3,0x30
    80004e8e:	4725                	li	a4,9
    80004e90:	02d76863          	bltu	a4,a3,80004ec0 <fileread+0xba>
    80004e94:	0792                	slli	a5,a5,0x4
    80004e96:	0001e717          	auipc	a4,0x1e
    80004e9a:	0fa70713          	addi	a4,a4,250 # 80022f90 <devsw>
    80004e9e:	97ba                	add	a5,a5,a4
    80004ea0:	639c                	ld	a5,0(a5)
    80004ea2:	c38d                	beqz	a5,80004ec4 <fileread+0xbe>
    r = devsw[f->major].read(1, addr, n);
    80004ea4:	4505                	li	a0,1
    80004ea6:	9782                	jalr	a5
    80004ea8:	892a                	mv	s2,a0
    80004eaa:	bf75                	j	80004e66 <fileread+0x60>
    panic("fileread");
    80004eac:	00004517          	auipc	a0,0x4
    80004eb0:	96450513          	addi	a0,a0,-1692 # 80008810 <syscalls+0x270>
    80004eb4:	ffffb097          	auipc	ra,0xffffb
    80004eb8:	68a080e7          	jalr	1674(ra) # 8000053e <panic>
    return -1;
    80004ebc:	597d                	li	s2,-1
    80004ebe:	b765                	j	80004e66 <fileread+0x60>
      return -1;
    80004ec0:	597d                	li	s2,-1
    80004ec2:	b755                	j	80004e66 <fileread+0x60>
    80004ec4:	597d                	li	s2,-1
    80004ec6:	b745                	j	80004e66 <fileread+0x60>

0000000080004ec8 <filewrite>:
...
filewrite(struct file *f, uint64 addr, int n)
{
    ...
    80004eda:	e45e                	sd	s7,8(sp)
    80004edc:	e062                	sd	s8,0(sp)
    80004ede:	0880                	addi	s0,sp,80
  int r, ret = 0;

  if(f->writable == 0)
    80004ee0:	00954783          	lbu	a5,9(a0)
    80004ee4:	10078663          	beqz	a5,80004ff0 <filewrite+0x128>
  ...
  if(f->type == FD_PIPE){
    ...
    80004ef2:	02e78263          	beq	a5,a4,80004f16 <filewrite+0x4e>
    ret = pipewrite(f->pipe, addr, n);
  } else if(f->type == FD_DEVICE){
    80004ef6:	470d                	li	a4,3
    80004ef8:	02e78663          	beq	a5,a4,80004f24 <filewrite+0x5c>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
      return -1;
    ret = devsw[f->major].write(1, addr, n);
  } else if(f->type == FD_INODE){
    80004efc:	4709                	li	a4,2
    80004efe:	0ee79163          	bne	a5,a4,80004fe0 <filewrite+0x118>
    ...
    int i = 0;
    while(i < n){
    80004f02:	0ac05d63          	blez	a2,80004fbc <filewrite+0xf4>
    int i = 0;
    80004f06:	4981                	li	s3,0
    80004f08:	6b05                	lui	s6,0x1
    80004f0a:	c00b0b13          	addi	s6,s6,-1024 # c00 <_entry-0x7ffff400>
    80004f0e:	6b85                	lui	s7,0x1
    80004f10:	c00b8b9b          	addiw	s7,s7,-1024
    80004f14:	a861                	j	80004fac <filewrite+0xe4>
    ret = pipewrite(f->pipe, addr, n);
    80004f16:	6908                	ld	a0,16(a0)
    80004f18:	00000097          	auipc	ra,0x0
    80004f1c:	22e080e7          	jalr	558(ra) # 80005146 <pipewrite>
    80004f20:	8a2a                	mv	s4,a0
    80004f22:	a045                	j	80004fc2 <filewrite+0xfa>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
    80004f24:	02451783          	lh	a5,36(a0)
    80004f28:	03079693          	slli	a3,a5,0x30
    80004f2c:	92c1                	srli	a3,a3,0x30
    80004f2e:	4725                	li	a4,9
    80004f30:	0cd76263          	bltu	a4,a3,80004ff4 <filewrite+0x12c>
    80004f34:	0792                	slli	a5,a5,0x4
    80004f36:	0001e717          	auipc	a4,0x1e
    80004f3a:	05a70713          	addi	a4,a4,90 # 80022f90 <devsw>
    80004f3e:	97ba                	add	a5,a5,a4
    80004f40:	679c                	ld	a5,8(a5)
    80004f42:	cbdd                	beqz	a5,80004ff8 <filewrite+0x130>
    ret = devsw[f->major].write(1, addr, n);
    80004f44:	4505                	li	a0,1
    80004f46:	9782                	jalr	a5
    80004f48:	8a2a                	mv	s4,a0
    80004f4a:	a8a5                	j	80004fc2 <filewrite+0xfa>
    80004f4c:	00048c1b          	sext.w	s8,s1
      int n1 = n - i;
      if(n1 > max)
        n1 = max;
    ...
    80004f54:	8b0080e7          	jalr	-1872(ra) # 80004800 <begin_op>
      ilock(f->ip);
    80004f58:	01893503          	ld	a0,24(s2)
    80004f5c:	fffff097          	auipc	ra,0xfffff
    80004f60:	ed2080e7          	jalr	-302(ra) # 80003e2e <ilock>
      if ((r = writei(f->ip, 1, addr + i, f->off, n1)) > 0)
    80004f64:	8762                	mv	a4,s8
    80004f66:	02092683          	lw	a3,32(s2)
    80004f6a:	01598633          	add	a2,s3,s5
    80004f6e:	4585                	li	a1,1
    80004f70:	01893503          	ld	a0,24(s2)
    80004f74:	fffff097          	auipc	ra,0xfffff
    80004f78:	266080e7          	jalr	614(ra) # 800041da <writei>
    80004f7c:	84aa                	mv	s1,a0
    80004f7e:	00a05763          	blez	a0,80004f8c <filewrite+0xc4>
        f->off += r;
    80004f82:	02092783          	lw	a5,32(s2)
    80004f86:	9fa9                	addw	a5,a5,a0
    80004f88:	02f92023          	sw	a5,32(s2)
      iunlock(f->ip);
    80004f8c:	01893503          	ld	a0,24(s2)
    80004f90:	fffff097          	auipc	ra,0xfffff
    80004f94:	f60080e7          	jalr	-160(ra) # 80003ef0 <iunlock>
      end_op();
    80004f98:	00000097          	auipc	ra,0x0
    80004f9c:	8e8080e7          	jalr	-1816(ra) # 80004880 <end_op>

      if(r != n1){
    80004fa0:	009c1f63          	bne	s8,s1,80004fbe <filewrite+0xf6>
        // error from writei
        break;
      }
      i += r;
    80004fa4:	013489bb          	addw	s3,s1,s3
    while(i < n){
    80004fa8:	0149db63          	bge	s3,s4,80004fbe <filewrite+0xf6>
      int n1 = n - i;
    80004fac:	413a07bb          	subw	a5,s4,s3
      if(n1 > max)
    80004fb0:	84be                	mv	s1,a5
    80004fb2:	2781                	sext.w	a5,a5
    80004fb4:	f8fb5ce3          	bge	s6,a5,80004f4c <filewrite+0x84>
    80004fb8:	84de                	mv	s1,s7
    80004fba:	bf49                	j	80004f4c <filewrite+0x84>
    int i = 0;
    80004fbc:	4981                	li	s3,0
    }
    ret = (i == n ? n : -1);
    80004fbe:	013a1f63          	bne	s4,s3,80004fdc <filewrite+0x114>
  } else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80004fd4:	6ba2                	ld	s7,8(sp)
    80004fd6:	6c02                	ld	s8,0(sp)
    80004fd8:	6161                	addi	sp,sp,80
    80004fda:	8082                	ret
    ret = (i == n ? n : -1);
    80004fdc:	5a7d                	li	s4,-1
    80004fde:	b7d5                	j	80004fc2 <filewrite+0xfa>
    panic("filewrite");
    80004fe0:	00004517          	auipc	a0,0x4
    80004fe4:	84050513          	addi	a0,a0,-1984 # 80008820 <syscalls+0x280>
    80004fe8:	ffffb097          	auipc	ra,0xffffb
    80004fec:	556080e7          	jalr	1366(ra) # 8000053e <panic>
    return -1;
    80004ff0:	5a7d                	li	s4,-1
    80004ff2:	bfc1                	j	80004fc2 <filewrite+0xfa>
      return -1;
    80004ff4:	5a7d                	li	s4,-1
    80004ff6:	b7f1                	j	80004fc2 <filewrite+0xfa>
    80004ff8:	5a7d                	li	s4,-1
    80004ffa:	b7e1                	j	80004fc2 <filewrite+0xfa>
...
pipealloc(struct file **f0, struct file **f1)
{
    ...
    80005006:	e44e                	sd	s3,8(sp)
    80005008:	e052                	sd	s4,0(sp)
    8000500a:	1800                	addi	s0,sp,48
    8000500c:	84aa                	mv	s1,a0
    8000500e:	8a2e                	mv	s4,a1
  struct pipe *pi;

  pi = 0;
  *f0 = *f1 = 0;
    80005010:	0005b023          	sd	zero,0(a1)
    80005014:	00053023          	sd	zero,0(a0)
  if((*f0 = filealloc()) == 0 || (*f1 = filealloc()) == 0)
    80005018:	00000097          	auipc	ra,0x0
    8000501c:	bf8080e7          	jalr	-1032(ra) # 80004c10 <filealloc>
    80005020:	e088                	sd	a0,0(s1)
    80005022:	c551                	beqz	a0,800050ae <pipealloc+0xb2>
    80005024:	00000097          	auipc	ra,0x0
    80005028:	bec080e7          	jalr	-1044(ra) # 80004c10 <filealloc>
    8000502c:	00aa3023          	sd	a0,0(s4)
    80005030:	c92d                	beqz	a0,800050a2 <pipealloc+0xa6>
    goto bad;
  if((pi = (struct pipe*)kalloc()) == 0)
    80005032:	ffffc097          	auipc	ra,0xffffc
    80005036:	ac2080e7          	jalr	-1342(ra) # 80000af4 <kalloc>
    8000503a:	892a                	mv	s2,a0
    8000503c:	c125                	beqz	a0,8000509c <pipealloc+0xa0>
    goto bad;
  pi->readopen = 1;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80005054:	43858593          	addi	a1,a1,1080 # 80008488 <states.2470+0x168>
    80005058:	ffffc097          	auipc	ra,0xffffc
    8000505c:	afc080e7          	jalr	-1284(ra) # 80000b54 <initlock>
  (*f0)->type = FD_PIPE;
  ...
  return 0;
    ...
    8000509a:	a025                	j	800050c2 <pipealloc+0xc6>
 ...
 bad:
  ...
  if(*f0)
    ...
    8000509e:	e501                	bnez	a0,800050a6 <pipealloc+0xaa>
    800050a0:	a039                	j	800050ae <pipealloc+0xb2>
    800050a2:	6088                	ld	a0,0(s1)
    800050a4:	c51d                	beqz	a0,800050d2 <pipealloc+0xd6>
    fileclose(*f0);
    800050a6:	00000097          	auipc	ra,0x0
    800050aa:	c26080e7          	jalr	-986(ra) # 80004ccc <fileclose>
  if(*f1)
  ...
  if(*f1)
    800050b4:	c799                	beqz	a5,800050c2 <pipealloc+0xc6>
    fileclose(*f1);
    800050b6:	853e                	mv	a0,a5
    800050b8:	00000097          	auipc	ra,0x0
    800050bc:	c14080e7          	jalr	-1004(ra) # 80004ccc <fileclose>
  return -1;
    ...
    800050ca:	69a2                	ld	s3,8(sp)
    800050cc:	6a02                	ld	s4,0(sp)
    800050ce:	6145                	addi	sp,sp,48
    800050d0:	8082                	ret
  return -1;
    800050d2:	557d                	li	a0,-1
    800050d4:	b7fd                	j	800050c2 <pipealloc+0xc6>

00000000800050d6 <pipeclose>:
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    800050ea:	afe080e7          	jalr	-1282(ra) # 80000be4 <acquire>
  if(writable){
    800050ee:	02090d63          	beqz	s2,80005128 <pipeclose+0x52>
    pi->writeopen = 0;
    800050f2:	2204a223          	sw	zero,548(s1)
    wakeup(&pi->nread);
    800050f6:	21848513          	addi	a0,s1,536
    800050fa:	ffffd097          	auipc	ra,0xffffd
    800050fe:	088080e7          	jalr	136(ra) # 80002182 <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    80005102:	2204b783          	ld	a5,544(s1)
    80005106:	eb95                	bnez	a5,8000513a <pipeclose+0x64>
    release(&pi->lock);
    80005108:	8526                	mv	a0,s1
    8000510a:	ffffc097          	auipc	ra,0xffffc
    8000510e:	b8e080e7          	jalr	-1138(ra) # 80000c98 <release>
    kfree((char*)pi);
    80005112:	8526                	mv	a0,s1
    80005114:	ffffc097          	auipc	ra,0xffffc
    80005118:	8e4080e7          	jalr	-1820(ra) # 800009f8 <kfree>
  } else
    release(&pi->lock);
}
    ...
    80005126:	8082                	ret
    pi->readopen = 0;
    80005128:	2204a023          	sw	zero,544(s1)
    wakeup(&pi->nwrite);
    8000512c:	21c48513          	addi	a0,s1,540
    80005130:	ffffd097          	auipc	ra,0xffffd
    80005134:	052080e7          	jalr	82(ra) # 80002182 <wakeup>
    80005138:	b7e9                	j	80005102 <pipeclose+0x2c>
    release(&pi->lock);
    8000513a:	8526                	mv	a0,s1
    8000513c:	ffffc097          	auipc	ra,0xffffc
    80005140:	b5c080e7          	jalr	-1188(ra) # 80000c98 <release>
}
    80005144:	bfe1                	j	8000511c <pipeclose+0x46>

0000000080005146 <pipewrite>:

int
pipewrite(struct pipe *pi, uint64 addr, int n)
{
    80005146:	7159                	addi	sp,sp,-112
    80005148:	f486                	sd	ra,104(sp)
    8000514a:	f0a2                	sd	s0,96(sp)
    8000514c:	eca6                	sd	s1,88(sp)
    8000514e:	e8ca                	sd	s2,80(sp)
    80005150:	e4ce                	sd	s3,72(sp)
    80005152:	e0d2                	sd	s4,64(sp)
    80005154:	fc56                	sd	s5,56(sp)
    80005156:	f85a                	sd	s6,48(sp)
    80005158:	f45e                	sd	s7,40(sp)
    8000515a:	f062                	sd	s8,32(sp)
    8000515c:	ec66                	sd	s9,24(sp)
    8000515e:	1880                	addi	s0,sp,112
    80005160:	84aa                	mv	s1,a0
    80005162:	8aae                	mv	s5,a1
    80005164:	8a32                	mv	s4,a2
  int i = 0;
  ...
  acquire(&pi->lock);
    ...
    80005176:	a72080e7          	jalr	-1422(ra) # 80000be4 <acquire>
  while(i < n){
    8000517a:	0d405163          	blez	s4,8000523c <pipewrite+0xf6>
    8000517e:	8ba6                	mv	s7,s1
  int i = 0;
    ...
    80005182:	5b7d                	li	s6,-1
      wakeup(&pi->nread);
    80005184:	21848c93          	addi	s9,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80005188:	21c48c13          	addi	s8,s1,540
    8000518c:	a08d                	j	800051ee <pipewrite+0xa8>
      release(&pi->lock);
    8000518e:	8526                	mv	a0,s1
    80005190:	ffffc097          	auipc	ra,0xffffc
    80005194:	b08080e7          	jalr	-1272(ra) # 80000c98 <release>
      return -1;
    80005198:	597d                	li	s2,-1
  }
  wakeup(&pi->nread);
  release(&pi->lock);
  ...
  return i;
    ...
    8000519c:	70a6                	ld	ra,104(sp)
    8000519e:	7406                	ld	s0,96(sp)
    800051a0:	64e6                	ld	s1,88(sp)
    800051a2:	6946                	ld	s2,80(sp)
    800051a4:	69a6                	ld	s3,72(sp)
    800051a6:	6a06                	ld	s4,64(sp)
    800051a8:	7ae2                	ld	s5,56(sp)
    800051aa:	7b42                	ld	s6,48(sp)
    800051ac:	7ba2                	ld	s7,40(sp)
    800051ae:	7c02                	ld	s8,32(sp)
    800051b0:	6ce2                	ld	s9,24(sp)
    800051b2:	6165                	addi	sp,sp,112
    800051b4:	8082                	ret
      wakeup(&pi->nread);
    800051b6:	8566                	mv	a0,s9
    800051b8:	ffffd097          	auipc	ra,0xffffd
    800051bc:	fca080e7          	jalr	-54(ra) # 80002182 <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    800051c0:	85de                	mv	a1,s7
    800051c2:	8562                	mv	a0,s8
    800051c4:	ffffd097          	auipc	ra,0xffffd
    800051c8:	e32080e7          	jalr	-462(ra) # 80001ff6 <sleep>
    800051cc:	a839                	j	800051ea <pipewrite+0xa4>
      pi->data[pi->nwrite++ % PIPESIZE] = ch;
    800051ce:	21c4a783          	lw	a5,540(s1)
    800051d2:	0017871b          	addiw	a4,a5,1
    800051d6:	20e4ae23          	sw	a4,540(s1)
    800051da:	1ff7f793          	andi	a5,a5,511
    800051de:	97a6                	add	a5,a5,s1
    800051e0:	f9f44703          	lbu	a4,-97(s0)
    800051e4:	00e78c23          	sb	a4,24(a5)
      i++;
    800051e8:	2905                	addiw	s2,s2,1
  while(i < n){
    800051ea:	03495d63          	bge	s2,s4,80005224 <pipewrite+0xde>
    if(pi->readopen == 0 || pr->killed){
    800051ee:	2204a783          	lw	a5,544(s1)
    800051f2:	dfd1                	beqz	a5,8000518e <pipewrite+0x48>
    800051f4:	0289a783          	lw	a5,40(s3)
    800051f8:	fbd9                	bnez	a5,8000518e <pipewrite+0x48>
    if(pi->nwrite == pi->nread + PIPESIZE){ //DOC: pipewrite-full
    800051fa:	2184a783          	lw	a5,536(s1)
    800051fe:	21c4a703          	lw	a4,540(s1)
    80005202:	2007879b          	addiw	a5,a5,512
    80005206:	faf708e3          	beq	a4,a5,800051b6 <pipewrite+0x70>
      if(copyin(pr->pagetable, &ch, addr + i, 1) == -1)
    8000520a:	4685                	li	a3,1
    8000520c:	01590633          	add	a2,s2,s5
    80005210:	f9f40593          	addi	a1,s0,-97
    80005214:	0509b503          	ld	a0,80(s3)
    80005218:	ffffc097          	auipc	ra,0xffffc
    8000521c:	4e6080e7          	jalr	1254(ra) # 800016fe <copyin>
    80005220:	fb6517e3          	bne	a0,s6,800051ce <pipewrite+0x88>
  wakeup(&pi->nread);
    80005224:	21848513          	addi	a0,s1,536
    80005228:	ffffd097          	auipc	ra,0xffffd
    8000522c:	f5a080e7          	jalr	-166(ra) # 80002182 <wakeup>
  release(&pi->lock);
    80005230:	8526                	mv	a0,s1
    80005232:	ffffc097          	auipc	ra,0xffffc
    80005236:	a66080e7          	jalr	-1434(ra) # 80000c98 <release>
  return i;
    8000523a:	b785                	j	8000519a <pipewrite+0x54>
  int i = 0;
    8000523c:	4901                	li	s2,0
    8000523e:	b7dd                	j	80005224 <pipewrite+0xde>

0000000080005240 <piperead>:
...
piperead(struct pipe *pi, uint64 addr, int n)
{
    ...
    80005250:	e85a                	sd	s6,16(sp)
    80005252:	0880                	addi	s0,sp,80
  ...
  struct proc *pr = myproc();
    ...
    8000525e:	756080e7          	jalr	1878(ra) # 800019b0 <myproc>
    80005262:	8a2a                	mv	s4,a0
  char ch;

  acquire(&pi->lock);
    80005264:	8b26                	mv	s6,s1
    80005266:	8526                	mv	a0,s1
    80005268:	ffffc097          	auipc	ra,0xffffc
    8000526c:	97c080e7          	jalr	-1668(ra) # 80000be4 <acquire>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80005278:	21848993          	addi	s3,s1,536
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    8000527c:	02f71463          	bne	a4,a5,800052a4 <piperead+0x64>
    80005280:	2244a783          	lw	a5,548(s1)
    80005284:	c385                	beqz	a5,800052a4 <piperead+0x64>
    if(pr->killed){
    80005286:	028a2783          	lw	a5,40(s4)
    8000528a:	ebc1                	bnez	a5,8000531a <piperead+0xda>
    sleep(&pi->nread, &pi->lock); //DOC: piperead-sleep
    8000528c:	85da                	mv	a1,s6
    8000528e:	854e                	mv	a0,s3
    80005290:	ffffd097          	auipc	ra,0xffffd
    80005294:	d66080e7          	jalr	-666(ra) # 80001ff6 <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80005298:	2184a703          	lw	a4,536(s1)
    8000529c:	21c4a783          	lw	a5,540(s1)
    800052a0:	fef700e3          	beq	a4,a5,80005280 <piperead+0x40>
  }
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    800052a4:	09505263          	blez	s5,80005328 <piperead+0xe8>
    800052a8:	4981                	li	s3,0
    if(pi->nread == pi->nwrite)
      break;
    ch = pi->data[pi->nread++ % PIPESIZE];
    if(copyout(pr->pagetable, addr + i, &ch, 1) == -1)
    800052aa:	5b7d                	li	s6,-1
    if(pi->nread == pi->nwrite)
    800052ac:	2184a783          	lw	a5,536(s1)
    800052b0:	21c4a703          	lw	a4,540(s1)
    800052b4:	02f70d63          	beq	a4,a5,800052ee <piperead+0xae>
    ch = pi->data[pi->nread++ % PIPESIZE];
    800052b8:	0017871b          	addiw	a4,a5,1
    800052bc:	20e4ac23          	sw	a4,536(s1)
    800052c0:	1ff7f793          	andi	a5,a5,511
    800052c4:	97a6                	add	a5,a5,s1
    800052c6:	0187c783          	lbu	a5,24(a5)
    800052ca:	faf40fa3          	sb	a5,-65(s0)
    if(copyout(pr->pagetable, addr + i, &ch, 1) == -1)
    800052ce:	4685                	li	a3,1
    800052d0:	fbf40613          	addi	a2,s0,-65
    800052d4:	85ca                	mv	a1,s2
    800052d6:	050a3503          	ld	a0,80(s4)
    800052da:	ffffc097          	auipc	ra,0xffffc
    800052de:	398080e7          	jalr	920(ra) # 80001672 <copyout>
    800052e2:	01650663          	beq	a0,s6,800052ee <piperead+0xae>
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    800052e6:	2985                	addiw	s3,s3,1
    800052e8:	0905                	addi	s2,s2,1
    800052ea:	fd3a91e3          	bne	s5,s3,800052ac <piperead+0x6c>
      break;
  }
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    800052ee:	21c48513          	addi	a0,s1,540
    800052f2:	ffffd097          	auipc	ra,0xffffd
    800052f6:	e90080e7          	jalr	-368(ra) # 80002182 <wakeup>
  release(&pi->lock);
    800052fa:	8526                	mv	a0,s1
    800052fc:	ffffc097          	auipc	ra,0xffffc
    80005300:	99c080e7          	jalr	-1636(ra) # 80000c98 <release>
  return i;
}
    ...
    80005320:	97c080e7          	jalr	-1668(ra) # 80000c98 <release>
      return -1;
    80005324:	59fd                	li	s3,-1
    80005326:	bff9                	j	80005304 <piperead+0xc4>
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80005328:	4981                	li	s3,0
    8000532a:	b7d1                	j	800052ee <piperead+0xae>

000000008000532c <exec>:
...
{
    8000532c:	df010113          	addi	sp,sp,-528
    80005330:	20113423          	sd	ra,520(sp)
    80005334:	20813023          	sd	s0,512(sp)
    80005338:	ffa6                	sd	s1,504(sp)
    8000533a:	fbca                	sd	s2,496(sp)
    8000533c:	f7ce                	sd	s3,488(sp)
    8000533e:	f3d2                	sd	s4,480(sp)
    80005340:	efd6                	sd	s5,472(sp)
    80005342:	ebda                	sd	s6,464(sp)
    80005344:	e7de                	sd	s7,456(sp)
    80005346:	e3e2                	sd	s8,448(sp)
    80005348:	ff66                	sd	s9,440(sp)
    8000534a:	fb6a                	sd	s10,432(sp)
    8000534c:	f76e                	sd	s11,424(sp)
    8000534e:	0c00                	addi	s0,sp,528
    80005350:	84aa                	mv	s1,a0
    80005352:	dea43c23          	sd	a0,-520(s0)
    80005356:	e0b43023          	sd	a1,-512(s0)
  ...
  struct proc *p = myproc();
    ...
    8000535e:	656080e7          	jalr	1622(ra) # 800019b0 <myproc>
    80005362:	892a                	mv	s2,a0

  begin_op();
    80005364:	fffff097          	auipc	ra,0xfffff
    80005368:	49c080e7          	jalr	1180(ra) # 80004800 <begin_op>

  if((ip = namei(path)) == 0){
    8000536c:	8526                	mv	a0,s1
    8000536e:	fffff097          	auipc	ra,0xfffff
    80005372:	276080e7          	jalr	630(ra) # 800045e4 <namei>
    80005376:	c92d                	beqz	a0,800053e8 <exec+0xbc>
  ...
  ilock(ip);
    ...
    8000537e:	ab4080e7          	jalr	-1356(ra) # 80003e2e <ilock>
  ...
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    ...
    80005394:	d52080e7          	jalr	-686(ra) # 800040e2 <readi>
    80005398:	04000793          	li	a5,64
    8000539c:	00f51a63          	bne	a0,a5,800053b0 <exec+0x84>
    goto bad;
  if(elf.magic != ELF_MAGIC)
    ...
    800053ac:	04f70463          	beq	a4,a5,800053f4 <exec+0xc8>
 ...
 bad:
  ...
  if(ip){
    ...
    800053b6:	cde080e7          	jalr	-802(ra) # 80004090 <iunlockput>
    end_op();
    800053ba:	fffff097          	auipc	ra,0xfffff
    800053be:	4c6080e7          	jalr	1222(ra) # 80004880 <end_op>
  }
  return -1;
    800053c2:	557d                	li	a0,-1
}
    800053c4:	20813083          	ld	ra,520(sp)
    800053c8:	20013403          	ld	s0,512(sp)
    800053cc:	74fe                	ld	s1,504(sp)
    800053ce:	795e                	ld	s2,496(sp)
    800053d0:	79be                	ld	s3,488(sp)
    800053d2:	7a1e                	ld	s4,480(sp)
    800053d4:	6afe                	ld	s5,472(sp)
    800053d6:	6b5e                	ld	s6,464(sp)
    800053d8:	6bbe                	ld	s7,456(sp)
    800053da:	6c1e                	ld	s8,448(sp)
    800053dc:	7cfa                	ld	s9,440(sp)
    800053de:	7d5a                	ld	s10,432(sp)
    800053e0:	7dba                	ld	s11,424(sp)
    800053e2:	21010113          	addi	sp,sp,528
    800053e6:	8082                	ret
    end_op();
    800053e8:	fffff097          	auipc	ra,0xfffff
    800053ec:	498080e7          	jalr	1176(ra) # 80004880 <end_op>
    return -1;
    800053f0:	557d                	li	a0,-1
    800053f2:	bfc9                	j	800053c4 <exec+0x98>
  if((pagetable = proc_pagetable(p)) == 0)
    800053f4:	854a                	mv	a0,s2
    800053f6:	ffffc097          	auipc	ra,0xffffc
    800053fa:	67e080e7          	jalr	1662(ra) # 80001a74 <proc_pagetable>
    800053fe:	8baa                	mv	s7,a0
    80005400:	d945                	beqz	a0,800053b0 <exec+0x84>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80005402:	e7042983          	lw	s3,-400(s0)
    80005406:	e8845783          	lhu	a5,-376(s0)
    8000540a:	c7ad                	beqz	a5,80005474 <exec+0x148>
  uint64 argc, sz = 0, sp, ustack[MAXARG], stackbase;
    8000540c:	4901                	li	s2,0
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    8000540e:	4b01                	li	s6,0
    if((ph.vaddr % PGSIZE) != 0)
    80005410:	6c85                	lui	s9,0x1
    80005412:	fffc8793          	addi	a5,s9,-1 # fff <_entry-0x7ffff001>
    80005416:	def43823          	sd	a5,-528(s0)
    8000541a:	a42d                	j	80005644 <exec+0x318>
  uint64 pa;
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80005420:	41450513          	addi	a0,a0,1044 # 80008830 <syscalls+0x290>
    80005424:	ffffb097          	auipc	ra,0xffffb
    80005428:	11a080e7          	jalr	282(ra) # 8000053e <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
    if(readi(ip, 0, (uint64)pa, offset+i, n) != n)
    8000542c:	8756                	mv	a4,s5
    8000542e:	012d86bb          	addw	a3,s11,s2
    80005432:	4581                	li	a1,0
    80005434:	8526                	mv	a0,s1
    80005436:	fffff097          	auipc	ra,0xfffff
    8000543a:	cac080e7          	jalr	-852(ra) # 800040e2 <readi>
    8000543e:	2501                	sext.w	a0,a0
    80005440:	1aaa9963          	bne	s5,a0,800055f2 <exec+0x2c6>
  for(i = 0; i < sz; i += PGSIZE){
    80005444:	6785                	lui	a5,0x1
    80005446:	0127893b          	addw	s2,a5,s2
    8000544a:	77fd                	lui	a5,0xfffff
    8000544c:	01478a3b          	addw	s4,a5,s4
    80005450:	1f897163          	bgeu	s2,s8,80005632 <exec+0x306>
    pa = walkaddr(pagetable, va + i);
    80005454:	02091593          	slli	a1,s2,0x20
    80005458:	9181                	srli	a1,a1,0x20
    8000545a:	95ea                	add	a1,a1,s10
    8000545c:	855e                	mv	a0,s7
    8000545e:	ffffc097          	auipc	ra,0xffffc
    80005462:	c10080e7          	jalr	-1008(ra) # 8000106e <walkaddr>
    80005466:	862a                	mv	a2,a0
    if(pa == 0)
    80005468:	d955                	beqz	a0,8000541c <exec+0xf0>
      n = PGSIZE;
    8000546a:	8ae6                	mv	s5,s9
    if(sz - i < PGSIZE)
    8000546c:	fd9a70e3          	bgeu	s4,s9,8000542c <exec+0x100>
      n = sz - i;
    80005470:	8ad2                	mv	s5,s4
    80005472:	bf6d                	j	8000542c <exec+0x100>
  uint64 argc, sz = 0, sp, ustack[MAXARG], stackbase;
    80005474:	4901                	li	s2,0
  iunlockput(ip);
    80005476:	8526                	mv	a0,s1
    80005478:	fffff097          	auipc	ra,0xfffff
    8000547c:	c18080e7          	jalr	-1000(ra) # 80004090 <iunlockput>
  end_op();
    80005480:	fffff097          	auipc	ra,0xfffff
    80005484:	400080e7          	jalr	1024(ra) # 80004880 <end_op>
  p = myproc();
    80005488:	ffffc097          	auipc	ra,0xffffc
    8000548c:	528080e7          	jalr	1320(ra) # 800019b0 <myproc>
    80005490:	8aaa                	mv	s5,a0
  uint64 oldsz = p->sz;
    80005492:	04853d03          	ld	s10,72(a0)
  sz = PGROUNDUP(sz);
    80005496:	6785                	lui	a5,0x1
    80005498:	17fd                	addi	a5,a5,-1
    8000549a:	993e                	add	s2,s2,a5
    8000549c:	757d                	lui	a0,0xfffff
    8000549e:	00a977b3          	and	a5,s2,a0
    800054a2:	e0f43423          	sd	a5,-504(s0)
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    800054a6:	6609                	lui	a2,0x2
    800054a8:	963e                	add	a2,a2,a5
    800054aa:	85be                	mv	a1,a5
    800054ac:	855e                	mv	a0,s7
    800054ae:	ffffc097          	auipc	ra,0xffffc
    800054b2:	f74080e7          	jalr	-140(ra) # 80001422 <uvmalloc>
    800054b6:	8b2a                	mv	s6,a0
  ip = 0;
    800054b8:	4481                	li	s1,0
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    800054ba:	12050c63          	beqz	a0,800055f2 <exec+0x2c6>
  uvmclear(pagetable, sz-2*PGSIZE);
    800054be:	75f9                	lui	a1,0xffffe
    800054c0:	95aa                	add	a1,a1,a0
    800054c2:	855e                	mv	a0,s7
    800054c4:	ffffc097          	auipc	ra,0xffffc
    800054c8:	17c080e7          	jalr	380(ra) # 80001640 <uvmclear>
  stackbase = sp - PGSIZE;
    800054cc:	7c7d                	lui	s8,0xfffff
    800054ce:	9c5a                	add	s8,s8,s6
  for(argc = 0; argv[argc]; argc++) {
    800054d0:	e0043783          	ld	a5,-512(s0)
    800054d4:	6388                	ld	a0,0(a5)
    800054d6:	c535                	beqz	a0,80005542 <exec+0x216>
    800054d8:	e9040993          	addi	s3,s0,-368
    800054dc:	f9040c93          	addi	s9,s0,-112
  sp = sz;
    800054e0:	895a                	mv	s2,s6
    sp -= strlen(argv[argc]) + 1;
    800054e2:	ffffc097          	auipc	ra,0xffffc
    800054e6:	982080e7          	jalr	-1662(ra) # 80000e64 <strlen>
    800054ea:	2505                	addiw	a0,a0,1
    800054ec:	40a90933          	sub	s2,s2,a0
    sp -= sp % 16; // riscv sp must be 16-byte aligned
    800054f0:	ff097913          	andi	s2,s2,-16
    if(sp < stackbase)
    800054f4:	13896363          	bltu	s2,s8,8000561a <exec+0x2ee>
    if(copyout(pagetable, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
    800054f8:	e0043d83          	ld	s11,-512(s0)
    800054fc:	000dba03          	ld	s4,0(s11)
    80005500:	8552                	mv	a0,s4
    80005502:	ffffc097          	auipc	ra,0xffffc
    80005506:	962080e7          	jalr	-1694(ra) # 80000e64 <strlen>
    8000550a:	0015069b          	addiw	a3,a0,1
    8000550e:	8652                	mv	a2,s4
    80005510:	85ca                	mv	a1,s2
    80005512:	855e                	mv	a0,s7
    80005514:	ffffc097          	auipc	ra,0xffffc
    80005518:	15e080e7          	jalr	350(ra) # 80001672 <copyout>
    8000551c:	10054363          	bltz	a0,80005622 <exec+0x2f6>
    ustack[argc] = sp;
    80005520:	0129b023          	sd	s2,0(s3)
  for(argc = 0; argv[argc]; argc++) {
    80005524:	0485                	addi	s1,s1,1
    80005526:	008d8793          	addi	a5,s11,8
    8000552a:	e0f43023          	sd	a5,-512(s0)
    8000552e:	008db503          	ld	a0,8(s11)
    80005532:	c911                	beqz	a0,80005546 <exec+0x21a>
    if(argc >= MAXARG)
    80005534:	09a1                	addi	s3,s3,8
    80005536:	fb3c96e3          	bne	s9,s3,800054e2 <exec+0x1b6>
  sz = sz1;
    8000553a:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    8000553e:	4481                	li	s1,0
    80005540:	a84d                	j	800055f2 <exec+0x2c6>
  sp = sz;
    80005542:	895a                	mv	s2,s6
  for(argc = 0; argv[argc]; argc++) {
    80005544:	4481                	li	s1,0
  ustack[argc] = 0;
    80005546:	00349793          	slli	a5,s1,0x3
    8000554a:	f9040713          	addi	a4,s0,-112
    8000554e:	97ba                	add	a5,a5,a4
    80005550:	f007b023          	sd	zero,-256(a5) # f00 <_entry-0x7ffff100>
  sp -= (argc+1) * sizeof(uint64);
    80005554:	00148693          	addi	a3,s1,1
    80005558:	068e                	slli	a3,a3,0x3
    8000555a:	40d90933          	sub	s2,s2,a3
  sp -= sp % 16;
    8000555e:	ff097913          	andi	s2,s2,-16
  if(sp < stackbase)
    80005562:	01897663          	bgeu	s2,s8,8000556e <exec+0x242>
  sz = sz1;
    80005566:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    8000556a:	4481                	li	s1,0
    8000556c:	a059                	j	800055f2 <exec+0x2c6>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    ...
    8000557a:	0fc080e7          	jalr	252(ra) # 80001672 <copyout>
    8000557e:	0a054663          	bltz	a0,8000562a <exec+0x2fe>
  p->trapframe->a1 = sp;
    80005582:	058ab783          	ld	a5,88(s5)
    80005586:	0727bc23          	sd	s2,120(a5)
  for(last=s=path; *s; s++)
    8000558a:	df843783          	ld	a5,-520(s0)
    8000558e:	0007c703          	lbu	a4,0(a5)
    80005592:	cf11                	beqz	a4,800055ae <exec+0x282>
    80005594:	0785                	addi	a5,a5,1
    if(*s == '/')
    80005596:	02f00693          	li	a3,47
    8000559a:	a039                	j	800055a8 <exec+0x27c>
      last = s+1;
    8000559c:	def43c23          	sd	a5,-520(s0)
  for(last=s=path; *s; s++)
    800055a0:	0785                	addi	a5,a5,1
    800055a2:	fff7c703          	lbu	a4,-1(a5)
    800055a6:	c701                	beqz	a4,800055ae <exec+0x282>
    if(*s == '/')
    800055a8:	fed71ce3          	bne	a4,a3,800055a0 <exec+0x274>
    800055ac:	bfc5                	j	8000559c <exec+0x270>
  safestrcpy(p->name, last, sizeof(p->name));
    800055ae:	4641                	li	a2,16
    800055b0:	df843583          	ld	a1,-520(s0)
    800055b4:	158a8513          	addi	a0,s5,344
    800055b8:	ffffc097          	auipc	ra,0xffffc
    800055bc:	87a080e7          	jalr	-1926(ra) # 80000e32 <safestrcpy>
  oldpagetable = p->pagetable;
    800055c0:	050ab503          	ld	a0,80(s5)
  p->pagetable = pagetable;
    800055c4:	057ab823          	sd	s7,80(s5)
  p->sz = sz;
    800055c8:	056ab423          	sd	s6,72(s5)
  p->trapframe->epc = elf.entry;  // initial program counter = main
    800055cc:	058ab783          	ld	a5,88(s5)
    800055d0:	e6843703          	ld	a4,-408(s0)
    800055d4:	ef98                	sd	a4,24(a5)
  p->trapframe->sp = sp; // initial stack pointer
    800055d6:	058ab783          	ld	a5,88(s5)
    800055da:	0327b823          	sd	s2,48(a5)
  proc_freepagetable(oldpagetable, oldsz);
    800055de:	85ea                	mv	a1,s10
    800055e0:	ffffc097          	auipc	ra,0xffffc
    800055e4:	530080e7          	jalr	1328(ra) # 80001b10 <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    800055e8:	0004851b          	sext.w	a0,s1
    800055ec:	bbe1                	j	800053c4 <exec+0x98>
    800055ee:	e1243423          	sd	s2,-504(s0)
    proc_freepagetable(pagetable, sz);
    800055f2:	e0843583          	ld	a1,-504(s0)
    800055f6:	855e                	mv	a0,s7
    800055f8:	ffffc097          	auipc	ra,0xffffc
    800055fc:	518080e7          	jalr	1304(ra) # 80001b10 <proc_freepagetable>
  if(ip){
    80005600:	da0498e3          	bnez	s1,800053b0 <exec+0x84>
  return -1;
    80005604:	557d                	li	a0,-1
    80005606:	bb7d                	j	800053c4 <exec+0x98>
    80005608:	e1243423          	sd	s2,-504(s0)
    8000560c:	b7dd                	j	800055f2 <exec+0x2c6>
    8000560e:	e1243423          	sd	s2,-504(s0)
    80005612:	b7c5                	j	800055f2 <exec+0x2c6>
    80005614:	e1243423          	sd	s2,-504(s0)
    80005618:	bfe9                	j	800055f2 <exec+0x2c6>
  sz = sz1;
    8000561a:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    8000561e:	4481                	li	s1,0
    80005620:	bfc9                	j	800055f2 <exec+0x2c6>
  sz = sz1;
    80005622:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    80005626:	4481                	li	s1,0
    80005628:	b7e9                	j	800055f2 <exec+0x2c6>
  sz = sz1;
    8000562a:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    8000562e:	4481                	li	s1,0
    80005630:	b7c9                	j	800055f2 <exec+0x2c6>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz)) == 0)
    80005632:	e0843903          	ld	s2,-504(s0)
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80005636:	2b05                	addiw	s6,s6,1
    80005638:	0389899b          	addiw	s3,s3,56
    8000563c:	e8845783          	lhu	a5,-376(s0)
    80005640:	e2fb5be3          	bge	s6,a5,80005476 <exec+0x14a>
    if(readi(ip, 0, (uint64)&ph, off, sizeof(ph)) != sizeof(ph))
    80005644:	2981                	sext.w	s3,s3
    80005646:	03800713          	li	a4,56
    8000564a:	86ce                	mv	a3,s3
    8000564c:	e1840613          	addi	a2,s0,-488
    80005650:	4581                	li	a1,0
    80005652:	8526                	mv	a0,s1
    80005654:	fffff097          	auipc	ra,0xfffff
    80005658:	a8e080e7          	jalr	-1394(ra) # 800040e2 <readi>
    8000565c:	03800793          	li	a5,56
    80005660:	f8f517e3          	bne	a0,a5,800055ee <exec+0x2c2>
    if(ph.type != ELF_PROG_LOAD)
    80005664:	e1842783          	lw	a5,-488(s0)
    80005668:	4705                	li	a4,1
    8000566a:	fce796e3          	bne	a5,a4,80005636 <exec+0x30a>
    if(ph.memsz < ph.filesz)
    8000566e:	e4043603          	ld	a2,-448(s0)
    80005672:	e3843783          	ld	a5,-456(s0)
    80005676:	f8f669e3          	bltu	a2,a5,80005608 <exec+0x2dc>
    if(ph.vaddr + ph.memsz < ph.vaddr)
    8000567a:	e2843783          	ld	a5,-472(s0)
    8000567e:	963e                	add	a2,a2,a5
    80005680:	f8f667e3          	bltu	a2,a5,8000560e <exec+0x2e2>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz)) == 0)
    80005684:	85ca                	mv	a1,s2
    80005686:	855e                	mv	a0,s7
    80005688:	ffffc097          	auipc	ra,0xffffc
    8000568c:	d9a080e7          	jalr	-614(ra) # 80001422 <uvmalloc>
    80005690:	e0a43423          	sd	a0,-504(s0)
    80005694:	d141                	beqz	a0,80005614 <exec+0x2e8>
    if((ph.vaddr % PGSIZE) != 0)
    80005696:	e2843d03          	ld	s10,-472(s0)
    8000569a:	df043783          	ld	a5,-528(s0)
    8000569e:	00fd77b3          	and	a5,s10,a5
    800056a2:	fba1                	bnez	a5,800055f2 <exec+0x2c6>
    if(loadseg(pagetable, ph.vaddr, ip, ph.off, ph.filesz) < 0)
    800056a4:	e2042d83          	lw	s11,-480(s0)
    800056a8:	e3842c03          	lw	s8,-456(s0)
  for(i = 0; i < sz; i += PGSIZE){
    800056ac:	f80c03e3          	beqz	s8,80005632 <exec+0x306>
    800056b0:	8a62                	mv	s4,s8
    800056b2:	4901                	li	s2,0
    800056b4:	b345                	j	80005454 <exec+0x128>

00000000800056b6 <argfd>:
...
argfd(int n, int *pfd, struct file **pf)
{
    ...
    800056c4:	84b2                	mv	s1,a2
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
    800056c6:	fdc40593          	addi	a1,s0,-36
    800056ca:	ffffe097          	auipc	ra,0xffffe
    800056ce:	87c080e7          	jalr	-1924(ra) # 80002f46 <argint>
    800056d2:	04054063          	bltz	a0,80005712 <argfd+0x5c>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    800056d6:	fdc42703          	lw	a4,-36(s0)
    800056da:	47bd                	li	a5,15
    800056dc:	02e7ed63          	bltu	a5,a4,80005716 <argfd+0x60>
    800056e0:	ffffc097          	auipc	ra,0xffffc
    800056e4:	2d0080e7          	jalr	720(ra) # 800019b0 <myproc>
    800056e8:	fdc42703          	lw	a4,-36(s0)
    800056ec:	01a70793          	addi	a5,a4,26
    800056f0:	078e                	slli	a5,a5,0x3
    800056f2:	953e                	add	a0,a0,a5
    800056f4:	611c                	ld	a5,0(a0)
    800056f6:	c395                	beqz	a5,8000571a <argfd+0x64>
    return -1;
  if(pfd)
    800056f8:	00090463          	beqz	s2,80005700 <argfd+0x4a>
    *pfd = fd;
  ...
  if(pf)
    80005702:	c091                	beqz	s1,80005706 <argfd+0x50>
    *pf = f;
    ...
    80005714:	bfcd                	j	80005706 <argfd+0x50>
    return -1;
    80005716:	557d                	li	a0,-1
    80005718:	b7fd                	j	80005706 <argfd+0x50>
    8000571a:	557d                	li	a0,-1
    8000571c:	b7ed                	j	80005706 <argfd+0x50>

000000008000571e <fdalloc>:
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    8000572e:	286080e7          	jalr	646(ra) # 800019b0 <myproc>
    80005732:	862a                	mv	a2,a0

  for(fd = 0; fd < NOFILE; fd++){
    80005734:	0d050793          	addi	a5,a0,208 # fffffffffffff0d0 <end+0xffffffff7ffd80d0>
    80005738:	4501                	li	a0,0
    8000573a:	46c1                	li	a3,16
    if(p->ofile[fd] == 0){
    8000573c:	6398                	ld	a4,0(a5)
    8000573e:	cb19                	beqz	a4,80005754 <fdalloc+0x36>
  for(fd = 0; fd < NOFILE; fd++){
    80005740:	2505                	addiw	a0,a0,1
    80005742:	07a1                	addi	a5,a5,8
    80005744:	fed51ce3          	bne	a0,a3,8000573c <fdalloc+0x1e>
      p->ofile[fd] = f;
      return fd;
    }
  }
  return -1;
    ...
    80005752:	8082                	ret
      p->ofile[fd] = f;
    80005754:	01a50793          	addi	a5,a0,26
    80005758:	078e                	slli	a5,a5,0x3
    8000575a:	963e                	add	a2,a2,a5
    8000575c:	e204                	sd	s1,0(a2)
      return fd;
    8000575e:	b7f5                	j	8000574a <fdalloc+0x2c>

0000000080005760 <create>:
  return -1;
}
...
{
    80005760:	715d                	addi	sp,sp,-80
    80005762:	e486                	sd	ra,72(sp)
    80005764:	e0a2                	sd	s0,64(sp)
    80005766:	fc26                	sd	s1,56(sp)
    80005768:	f84a                	sd	s2,48(sp)
    8000576a:	f44e                	sd	s3,40(sp)
    8000576c:	f052                	sd	s4,32(sp)
    8000576e:	ec56                	sd	s5,24(sp)
    80005770:	0880                	addi	s0,sp,80
    80005772:	89ae                	mv	s3,a1
    80005774:	8ab2                	mv	s5,a2
    80005776:	8a36                	mv	s4,a3
  struct inode *ip, *dp;
  char name[DIRSIZ];
  ...
  if((dp = nameiparent(path, name)) == 0)
    ...
    80005780:	e86080e7          	jalr	-378(ra) # 80004602 <nameiparent>
    80005784:	892a                	mv	s2,a0
    80005786:	12050f63          	beqz	a0,800058c4 <create+0x164>
    return 0;

  ilock(dp);
    8000578a:	ffffe097          	auipc	ra,0xffffe
    8000578e:	6a4080e7          	jalr	1700(ra) # 80003e2e <ilock>
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    8000579e:	b78080e7          	jalr	-1160(ra) # 80004312 <dirlookup>
    800057a2:	84aa                	mv	s1,a0
    800057a4:	c921                	beqz	a0,800057f4 <create+0x94>
    iunlockput(dp);
    800057a6:	854a                	mv	a0,s2
    800057a8:	fffff097          	auipc	ra,0xfffff
    800057ac:	8e8080e7          	jalr	-1816(ra) # 80004090 <iunlockput>
    ilock(ip);
    800057b0:	8526                	mv	a0,s1
    800057b2:	ffffe097          	auipc	ra,0xffffe
    800057b6:	67c080e7          	jalr	1660(ra) # 80003e2e <ilock>
    if(type == T_FILE && (ip->type == T_FILE || ip->type == T_DEVICE))
    800057ba:	2981                	sext.w	s3,s3
    800057bc:	4789                	li	a5,2
    800057be:	02f99463          	bne	s3,a5,800057e6 <create+0x86>
    800057c2:	0444d783          	lhu	a5,68(s1)
    800057c6:	37f9                	addiw	a5,a5,-2
    800057c8:	17c2                	slli	a5,a5,0x30
    800057ca:	93c1                	srli	a5,a5,0x30
    800057cc:	4705                	li	a4,1
    800057ce:	00f76c63          	bltu	a4,a5,800057e6 <create+0x86>
  ...
  return ip;
    ...
    800057d4:	60a6                	ld	ra,72(sp)
    800057d6:	6406                	ld	s0,64(sp)
    800057d8:	74e2                	ld	s1,56(sp)
    800057da:	7942                	ld	s2,48(sp)
    800057dc:	79a2                	ld	s3,40(sp)
    800057de:	7a02                	ld	s4,32(sp)
    800057e0:	6ae2                	ld	s5,24(sp)
    800057e2:	6161                	addi	sp,sp,80
    800057e4:	8082                	ret
    iunlockput(ip);
    800057e6:	8526                	mv	a0,s1
    800057e8:	fffff097          	auipc	ra,0xfffff
    800057ec:	8a8080e7          	jalr	-1880(ra) # 80004090 <iunlockput>
    return 0;
    800057f0:	4481                	li	s1,0
    800057f2:	b7c5                	j	800057d2 <create+0x72>
  if((ip = ialloc(dp->dev, type)) == 0)
    800057f4:	85ce                	mv	a1,s3
    800057f6:	00092503          	lw	a0,0(s2)
    800057fa:	ffffe097          	auipc	ra,0xffffe
    800057fe:	49c080e7          	jalr	1180(ra) # 80003c96 <ialloc>
    80005802:	84aa                	mv	s1,a0
    80005804:	c529                	beqz	a0,8000584e <create+0xee>
  ilock(ip);
    80005806:	ffffe097          	auipc	ra,0xffffe
    8000580a:	628080e7          	jalr	1576(ra) # 80003e2e <ilock>
  ip->major = major;
    8000580e:	05549323          	sh	s5,70(s1)
  ip->minor = minor;
    80005812:	05449423          	sh	s4,72(s1)
  ip->nlink = 1;
  ...
  iupdate(ip);
    ...
    80005822:	546080e7          	jalr	1350(ra) # 80003d64 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
    80005826:	2981                	sext.w	s3,s3
    80005828:	4785                	li	a5,1
    8000582a:	02f98a63          	beq	s3,a5,8000585e <create+0xfe>
  if(dirlink(dp, name, ip->inum) < 0)
    8000582e:	40d0                	lw	a2,4(s1)
    80005830:	fb040593          	addi	a1,s0,-80
    80005834:	854a                	mv	a0,s2
    80005836:	fffff097          	auipc	ra,0xfffff
    8000583a:	cec080e7          	jalr	-788(ra) # 80004522 <dirlink>
    8000583e:	06054b63          	bltz	a0,800058b4 <create+0x154>
  iunlockput(dp);
    80005842:	854a                	mv	a0,s2
    80005844:	fffff097          	auipc	ra,0xfffff
    80005848:	84c080e7          	jalr	-1972(ra) # 80004090 <iunlockput>
  return ip;
    8000584c:	b759                	j	800057d2 <create+0x72>
    panic("create: ialloc");
    8000584e:	00003517          	auipc	a0,0x3
    80005852:	00250513          	addi	a0,a0,2 # 80008850 <syscalls+0x2b0>
    ...
    8000586e:	4fa080e7          	jalr	1274(ra) # 80003d64 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
    80005872:	40d0                	lw	a2,4(s1)
    80005874:	00003597          	auipc	a1,0x3
    80005878:	fec58593          	addi	a1,a1,-20 # 80008860 <syscalls+0x2c0>
    8000587c:	8526                	mv	a0,s1
    8000587e:	fffff097          	auipc	ra,0xfffff
    80005882:	ca4080e7          	jalr	-860(ra) # 80004522 <dirlink>
    80005886:	00054f63          	bltz	a0,800058a4 <create+0x144>
    8000588a:	00492603          	lw	a2,4(s2)
    8000588e:	00003597          	auipc	a1,0x3
    80005892:	fda58593          	addi	a1,a1,-38 # 80008868 <syscalls+0x2c8>
    80005896:	8526                	mv	a0,s1
    80005898:	fffff097          	auipc	ra,0xfffff
    8000589c:	c8a080e7          	jalr	-886(ra) # 80004522 <dirlink>
    800058a0:	f80557e3          	bgez	a0,8000582e <create+0xce>
      panic("create dots");
    800058a4:	00003517          	auipc	a0,0x3
    800058a8:	fcc50513          	addi	a0,a0,-52 # 80008870 <syscalls+0x2d0>
    800058ac:	ffffb097          	auipc	ra,0xffffb
    800058b0:	c92080e7          	jalr	-878(ra) # 8000053e <panic>
    panic("create: dirlink");
    800058b4:	00003517          	auipc	a0,0x3
    800058b8:	fcc50513          	addi	a0,a0,-52 # 80008880 <syscalls+0x2e0>
    800058bc:	ffffb097          	auipc	ra,0xffffb
    800058c0:	c82080e7          	jalr	-894(ra) # 8000053e <panic>
    return 0;
    800058c4:	84aa                	mv	s1,a0
    800058c6:	b731                	j	800057d2 <create+0x72>
...
00000000800058c8 <sys_dup>:
{
  ...
  if(argfd(0, 0, &f) < 0)
    800058d2:	fd840613          	addi	a2,s0,-40
    800058d6:	4581                	li	a1,0
    800058d8:	4501                	li	a0,0
    800058da:	00000097          	auipc	ra,0x0
    800058de:	ddc080e7          	jalr	-548(ra) # 800056b6 <argfd>
    return -1;
    800058e2:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0)
    800058e4:	02054363          	bltz	a0,8000590a <sys_dup+0x42>
  if((fd=fdalloc(f)) < 0)
    800058e8:	fd843503          	ld	a0,-40(s0)
    800058ec:	00000097          	auipc	ra,0x0
    800058f0:	e32080e7          	jalr	-462(ra) # 8000571e <fdalloc>
    800058f4:	84aa                	mv	s1,a0
    return -1;
    800058f6:	57fd                	li	a5,-1
  if((fd=fdalloc(f)) < 0)
    800058f8:	00054963          	bltz	a0,8000590a <sys_dup+0x42>
  filedup(f);
    800058fc:	fd843503          	ld	a0,-40(s0)
    80005900:	fffff097          	auipc	ra,0xfffff
    80005904:	37a080e7          	jalr	890(ra) # 80004c7a <filedup>
  return fd;
    80005908:	87a6                	mv	a5,s1
}
...
0000000080005916 <sys_read>:
{
    80005916:	7179                	addi	sp,sp,-48
    80005918:	f406                	sd	ra,40(sp)
    8000591a:	f022                	sd	s0,32(sp)
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    8000592a:	d90080e7          	jalr	-624(ra) # 800056b6 <argfd>
    return -1;
    8000592e:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005930:	04054163          	bltz	a0,80005972 <sys_read+0x5c>
    80005934:	fe440593          	addi	a1,s0,-28
    80005938:	4509                	li	a0,2
    8000593a:	ffffd097          	auipc	ra,0xffffd
    8000593e:	60c080e7          	jalr	1548(ra) # 80002f46 <argint>
    return -1;
    80005942:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005944:	02054763          	bltz	a0,80005972 <sys_read+0x5c>
    80005948:	fd840593          	addi	a1,s0,-40
    8000594c:	4505                	li	a0,1
    8000594e:	ffffd097          	auipc	ra,0xffffd
    80005952:	61a080e7          	jalr	1562(ra) # 80002f68 <argaddr>
    return -1;
    80005956:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005958:	00054d63          	bltz	a0,80005972 <sys_read+0x5c>
  return fileread(f, p, n);
    ...
    8000596c:	49e080e7          	jalr	1182(ra) # 80004e06 <fileread>
    80005970:	87aa                	mv	a5,a0
}
    80005972:	853e                	mv	a0,a5
    80005974:	70a2                	ld	ra,40(sp)
    80005976:	7402                	ld	s0,32(sp)
    80005978:	6145                	addi	sp,sp,48
    8000597a:	8082                	ret

000000008000597c <sys_write>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005984:	fe840613          	addi	a2,s0,-24
    80005988:	4581                	li	a1,0
    8000598a:	4501                	li	a0,0
    8000598c:	00000097          	auipc	ra,0x0
    80005990:	d2a080e7          	jalr	-726(ra) # 800056b6 <argfd>
    return -1;
    80005994:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005996:	04054163          	bltz	a0,800059d8 <sys_write+0x5c>
    8000599a:	fe440593          	addi	a1,s0,-28
    8000599e:	4509                	li	a0,2
    800059a0:	ffffd097          	auipc	ra,0xffffd
    800059a4:	5a6080e7          	jalr	1446(ra) # 80002f46 <argint>
    return -1;
    800059a8:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800059aa:	02054763          	bltz	a0,800059d8 <sys_write+0x5c>
    800059ae:	fd840593          	addi	a1,s0,-40
    800059b2:	4505                	li	a0,1
    800059b4:	ffffd097          	auipc	ra,0xffffd
    800059b8:	5b4080e7          	jalr	1460(ra) # 80002f68 <argaddr>
    return -1;
    800059bc:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800059be:	00054d63          	bltz	a0,800059d8 <sys_write+0x5c>
  return filewrite(f, p, n);
    ...
    800059d2:	4fa080e7          	jalr	1274(ra) # 80004ec8 <filewrite>
...
00000000800059e2 <sys_close>:
{
  ...
  if(argfd(0, &fd, &f) < 0)
    800059ea:	fe040613          	addi	a2,s0,-32
    800059ee:	fec40593          	addi	a1,s0,-20
    800059f2:	4501                	li	a0,0
    800059f4:	00000097          	auipc	ra,0x0
    800059f8:	cc2080e7          	jalr	-830(ra) # 800056b6 <argfd>
    return -1;
    800059fc:	57fd                	li	a5,-1
  if(argfd(0, &fd, &f) < 0)
    800059fe:	02054463          	bltz	a0,80005a26 <sys_close+0x44>
  myproc()->ofile[fd] = 0;
    80005a02:	ffffc097          	auipc	ra,0xffffc
    80005a06:	fae080e7          	jalr	-82(ra) # 800019b0 <myproc>
    80005a0a:	fec42783          	lw	a5,-20(s0)
    80005a0e:	07e9                	addi	a5,a5,26
    80005a10:	078e                	slli	a5,a5,0x3
    80005a12:	97aa                	add	a5,a5,a0
    80005a14:	0007b023          	sd	zero,0(a5)
  fileclose(f);
    80005a18:	fe043503          	ld	a0,-32(s0)
    80005a1c:	fffff097          	auipc	ra,0xfffff
    80005a20:	2b0080e7          	jalr	688(ra) # 80004ccc <fileclose>
  return 0;
...
0000000080005a30 <sys_fstat>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    80005a38:	fe840613          	addi	a2,s0,-24
    80005a3c:	4581                	li	a1,0
    80005a3e:	4501                	li	a0,0
    80005a40:	00000097          	auipc	ra,0x0
    80005a44:	c76080e7          	jalr	-906(ra) # 800056b6 <argfd>
    return -1;
    80005a48:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    80005a4a:	02054563          	bltz	a0,80005a74 <sys_fstat+0x44>
    80005a4e:	fe040593          	addi	a1,s0,-32
    80005a52:	4505                	li	a0,1
    80005a54:	ffffd097          	auipc	ra,0xffffd
    80005a58:	514080e7          	jalr	1300(ra) # 80002f68 <argaddr>
    return -1;
    80005a5c:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    80005a5e:	00054b63          	bltz	a0,80005a74 <sys_fstat+0x44>
  return filestat(f, st);
    80005a62:	fe043583          	ld	a1,-32(s0)
    80005a66:	fe843503          	ld	a0,-24(s0)
    80005a6a:	fffff097          	auipc	ra,0xfffff
    80005a6e:	32a080e7          	jalr	810(ra) # 80004d94 <filestat>
    80005a72:	87aa                	mv	a5,a0
}
...
0000000080005a7e <sys_link>:
{
    80005a7e:	7169                	addi	sp,sp,-304
    80005a80:	f606                	sd	ra,296(sp)
    80005a82:	f222                	sd	s0,288(sp)
    80005a84:	ee26                	sd	s1,280(sp)
    80005a86:	ea4a                	sd	s2,272(sp)
    80005a88:	1a00                	addi	s0,sp,304
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    80005a8a:	08000613          	li	a2,128
    80005a8e:	ed040593          	addi	a1,s0,-304
    80005a92:	4501                	li	a0,0
    80005a94:	ffffd097          	auipc	ra,0xffffd
    80005a98:	4f6080e7          	jalr	1270(ra) # 80002f8a <argstr>
    return -1;
    80005a9c:	57fd                	li	a5,-1
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    80005a9e:	10054e63          	bltz	a0,80005bba <sys_link+0x13c>
    80005aa2:	08000613          	li	a2,128
    80005aa6:	f5040593          	addi	a1,s0,-176
    80005aaa:	4505                	li	a0,1
    80005aac:	ffffd097          	auipc	ra,0xffffd
    80005ab0:	4de080e7          	jalr	1246(ra) # 80002f8a <argstr>
    return -1;
    80005ab4:	57fd                	li	a5,-1
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    80005ab6:	10054263          	bltz	a0,80005bba <sys_link+0x13c>
  begin_op();
    80005aba:	fffff097          	auipc	ra,0xfffff
    80005abe:	d46080e7          	jalr	-698(ra) # 80004800 <begin_op>
  if((ip = namei(old)) == 0){
    80005ac2:	ed040513          	addi	a0,s0,-304
    80005ac6:	fffff097          	auipc	ra,0xfffff
    80005aca:	b1e080e7          	jalr	-1250(ra) # 800045e4 <namei>
    80005ace:	84aa                	mv	s1,a0
    80005ad0:	c551                	beqz	a0,80005b5c <sys_link+0xde>
  ilock(ip);
    80005ad2:	ffffe097          	auipc	ra,0xffffe
    80005ad6:	35c080e7          	jalr	860(ra) # 80003e2e <ilock>
  if(ip->type == T_DIR){
    80005ada:	04449703          	lh	a4,68(s1)
    80005ade:	4785                	li	a5,1
    80005ae0:	08f70463          	beq	a4,a5,80005b68 <sys_link+0xea>
  ip->nlink++;
  ...
  iupdate(ip);
    ...
    80005af4:	274080e7          	jalr	628(ra) # 80003d64 <iupdate>
  iunlock(ip);
    80005af8:	8526                	mv	a0,s1
    80005afa:	ffffe097          	auipc	ra,0xffffe
    80005afe:	3f6080e7          	jalr	1014(ra) # 80003ef0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
    80005b02:	fd040593          	addi	a1,s0,-48
    80005b06:	f5040513          	addi	a0,s0,-176
    80005b0a:	fffff097          	auipc	ra,0xfffff
    80005b0e:	af8080e7          	jalr	-1288(ra) # 80004602 <nameiparent>
    80005b12:	892a                	mv	s2,a0
    80005b14:	c935                	beqz	a0,80005b88 <sys_link+0x10a>
  ilock(dp);
    80005b16:	ffffe097          	auipc	ra,0xffffe
    80005b1a:	318080e7          	jalr	792(ra) # 80003e2e <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    80005b1e:	00092703          	lw	a4,0(s2)
    80005b22:	409c                	lw	a5,0(s1)
    80005b24:	04f71d63          	bne	a4,a5,80005b7e <sys_link+0x100>
    80005b28:	40d0                	lw	a2,4(s1)
    80005b2a:	fd040593          	addi	a1,s0,-48
    80005b2e:	854a                	mv	a0,s2
    80005b30:	fffff097          	auipc	ra,0xfffff
    80005b34:	9f2080e7          	jalr	-1550(ra) # 80004522 <dirlink>
    80005b38:	04054363          	bltz	a0,80005b7e <sys_link+0x100>
  iunlockput(dp);
    80005b3c:	854a                	mv	a0,s2
    80005b3e:	ffffe097          	auipc	ra,0xffffe
    80005b42:	552080e7          	jalr	1362(ra) # 80004090 <iunlockput>
  iput(ip);
    80005b46:	8526                	mv	a0,s1
    80005b48:	ffffe097          	auipc	ra,0xffffe
    80005b4c:	4a0080e7          	jalr	1184(ra) # 80003fe8 <iput>
  end_op();
    80005b50:	fffff097          	auipc	ra,0xfffff
    80005b54:	d30080e7          	jalr	-720(ra) # 80004880 <end_op>
  return 0;
    80005b58:	4781                	li	a5,0
    80005b5a:	a085                	j	80005bba <sys_link+0x13c>
    end_op();
    80005b5c:	fffff097          	auipc	ra,0xfffff
    80005b60:	d24080e7          	jalr	-732(ra) # 80004880 <end_op>
    return -1;
    80005b64:	57fd                	li	a5,-1
    80005b66:	a891                	j	80005bba <sys_link+0x13c>
    iunlockput(ip);
    80005b68:	8526                	mv	a0,s1
    80005b6a:	ffffe097          	auipc	ra,0xffffe
    80005b6e:	526080e7          	jalr	1318(ra) # 80004090 <iunlockput>
    end_op();
    80005b72:	fffff097          	auipc	ra,0xfffff
    80005b76:	d0e080e7          	jalr	-754(ra) # 80004880 <end_op>
    return -1;
    80005b7a:	57fd                	li	a5,-1
    80005b7c:	a83d                	j	80005bba <sys_link+0x13c>
    iunlockput(dp);
    80005b7e:	854a                	mv	a0,s2
    80005b80:	ffffe097          	auipc	ra,0xffffe
    80005b84:	510080e7          	jalr	1296(ra) # 80004090 <iunlockput>
  ilock(ip);
    80005b88:	8526                	mv	a0,s1
    80005b8a:	ffffe097          	auipc	ra,0xffffe
    80005b8e:	2a4080e7          	jalr	676(ra) # 80003e2e <ilock>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    80005ba2:	1c6080e7          	jalr	454(ra) # 80003d64 <iupdate>
  iunlockput(ip);
    80005ba6:	8526                	mv	a0,s1
    80005ba8:	ffffe097          	auipc	ra,0xffffe
    80005bac:	4e8080e7          	jalr	1256(ra) # 80004090 <iunlockput>
  end_op();
    80005bb0:	fffff097          	auipc	ra,0xfffff
    80005bb4:	cd0080e7          	jalr	-816(ra) # 80004880 <end_op>
  return -1;
    80005bb8:	57fd                	li	a5,-1
}
    80005bba:	853e                	mv	a0,a5
    80005bbc:	70b2                	ld	ra,296(sp)
    80005bbe:	7412                	ld	s0,288(sp)
    80005bc0:	64f2                	ld	s1,280(sp)
    80005bc2:	6952                	ld	s2,272(sp)
    80005bc4:	6155                	addi	sp,sp,304
    80005bc6:	8082                	ret

0000000080005bc8 <sys_unlink>:
{
    80005bc8:	7151                	addi	sp,sp,-240
    80005bca:	f586                	sd	ra,232(sp)
    80005bcc:	f1a2                	sd	s0,224(sp)
    80005bce:	eda6                	sd	s1,216(sp)
    80005bd0:	e9ca                	sd	s2,208(sp)
    80005bd2:	e5ce                	sd	s3,200(sp)
    80005bd4:	1980                	addi	s0,sp,240
  if(argstr(0, path, MAXPATH) < 0)
    80005bd6:	08000613          	li	a2,128
    80005bda:	f3040593          	addi	a1,s0,-208
    80005bde:	4501                	li	a0,0
    80005be0:	ffffd097          	auipc	ra,0xffffd
    80005be4:	3aa080e7          	jalr	938(ra) # 80002f8a <argstr>
    80005be8:	18054163          	bltz	a0,80005d6a <sys_unlink+0x1a2>
  begin_op();
    80005bec:	fffff097          	auipc	ra,0xfffff
    80005bf0:	c14080e7          	jalr	-1004(ra) # 80004800 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
    80005bf4:	fb040593          	addi	a1,s0,-80
    80005bf8:	f3040513          	addi	a0,s0,-208
    80005bfc:	fffff097          	auipc	ra,0xfffff
    80005c00:	a06080e7          	jalr	-1530(ra) # 80004602 <nameiparent>
    80005c04:	84aa                	mv	s1,a0
    80005c06:	c979                	beqz	a0,80005cdc <sys_unlink+0x114>
  ilock(dp);
    80005c08:	ffffe097          	auipc	ra,0xffffe
    80005c0c:	226080e7          	jalr	550(ra) # 80003e2e <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    80005c10:	00003597          	auipc	a1,0x3
    80005c14:	c5058593          	addi	a1,a1,-944 # 80008860 <syscalls+0x2c0>
    80005c18:	fb040513          	addi	a0,s0,-80
    80005c1c:	ffffe097          	auipc	ra,0xffffe
    80005c20:	6dc080e7          	jalr	1756(ra) # 800042f8 <namecmp>
    80005c24:	14050a63          	beqz	a0,80005d78 <sys_unlink+0x1b0>
    80005c28:	00003597          	auipc	a1,0x3
    80005c2c:	c4058593          	addi	a1,a1,-960 # 80008868 <syscalls+0x2c8>
    80005c30:	fb040513          	addi	a0,s0,-80
    80005c34:	ffffe097          	auipc	ra,0xffffe
    80005c38:	6c4080e7          	jalr	1732(ra) # 800042f8 <namecmp>
    80005c3c:	12050e63          	beqz	a0,80005d78 <sys_unlink+0x1b0>
  if((ip = dirlookup(dp, name, &off)) == 0)
    80005c40:	f2c40613          	addi	a2,s0,-212
    80005c44:	fb040593          	addi	a1,s0,-80
    80005c48:	8526                	mv	a0,s1
    80005c4a:	ffffe097          	auipc	ra,0xffffe
    80005c4e:	6c8080e7          	jalr	1736(ra) # 80004312 <dirlookup>
    80005c52:	892a                	mv	s2,a0
    80005c54:	12050263          	beqz	a0,80005d78 <sys_unlink+0x1b0>
  ilock(ip);
    80005c58:	ffffe097          	auipc	ra,0xffffe
    80005c5c:	1d6080e7          	jalr	470(ra) # 80003e2e <ilock>
  if(ip->nlink < 1)
    80005c60:	04a91783          	lh	a5,74(s2)
    80005c64:	08f05263          	blez	a5,80005ce8 <sys_unlink+0x120>
  if(ip->type == T_DIR && !isdirempty(ip)){
    80005c68:	04491703          	lh	a4,68(s2)
    80005c6c:	4785                	li	a5,1
    80005c6e:	08f70563          	beq	a4,a5,80005cf8 <sys_unlink+0x130>
  memset(&de, 0, sizeof(de));
    80005c72:	4641                	li	a2,16
    80005c74:	4581                	li	a1,0
    80005c76:	fc040513          	addi	a0,s0,-64
    80005c7a:	ffffb097          	auipc	ra,0xffffb
    80005c7e:	066080e7          	jalr	102(ra) # 80000ce0 <memset>
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    80005c82:	4741                	li	a4,16
    80005c84:	f2c42683          	lw	a3,-212(s0)
    80005c88:	fc040613          	addi	a2,s0,-64
    80005c8c:	4581                	li	a1,0
    80005c8e:	8526                	mv	a0,s1
    80005c90:	ffffe097          	auipc	ra,0xffffe
    80005c94:	54a080e7          	jalr	1354(ra) # 800041da <writei>
    80005c98:	47c1                	li	a5,16
    80005c9a:	0af51563          	bne	a0,a5,80005d44 <sys_unlink+0x17c>
  if(ip->type == T_DIR){
    80005c9e:	04491703          	lh	a4,68(s2)
    80005ca2:	4785                	li	a5,1
    80005ca4:	0af70863          	beq	a4,a5,80005d54 <sys_unlink+0x18c>
  iunlockput(dp);
    80005ca8:	8526                	mv	a0,s1
    80005caa:	ffffe097          	auipc	ra,0xffffe
    80005cae:	3e6080e7          	jalr	998(ra) # 80004090 <iunlockput>
  ip->nlink--;
    80005cb2:	04a95783          	lhu	a5,74(s2)
    80005cb6:	37fd                	addiw	a5,a5,-1
    80005cb8:	04f91523          	sh	a5,74(s2)
  iupdate(ip);
    80005cbc:	854a                	mv	a0,s2
    80005cbe:	ffffe097          	auipc	ra,0xffffe
    80005cc2:	0a6080e7          	jalr	166(ra) # 80003d64 <iupdate>
  iunlockput(ip);
    80005cc6:	854a                	mv	a0,s2
    80005cc8:	ffffe097          	auipc	ra,0xffffe
    80005ccc:	3c8080e7          	jalr	968(ra) # 80004090 <iunlockput>
  end_op();
    80005cd0:	fffff097          	auipc	ra,0xfffff
    80005cd4:	bb0080e7          	jalr	-1104(ra) # 80004880 <end_op>
  return 0;
    80005cd8:	4501                	li	a0,0
    80005cda:	a84d                	j	80005d8c <sys_unlink+0x1c4>
    end_op();
    80005cdc:	fffff097          	auipc	ra,0xfffff
    80005ce0:	ba4080e7          	jalr	-1116(ra) # 80004880 <end_op>
    return -1;
    80005ce4:	557d                	li	a0,-1
    80005ce6:	a05d                	j	80005d8c <sys_unlink+0x1c4>
    panic("unlink: nlink < 1");
    80005ce8:	00003517          	auipc	a0,0x3
    80005cec:	ba850513          	addi	a0,a0,-1112 # 80008890 <syscalls+0x2f0>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80005d00:	f6e7f9e3          	bgeu	a5,a4,80005c72 <sys_unlink+0xaa>
    80005d04:	02000993          	li	s3,32
    if(readi(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    80005d08:	4741                	li	a4,16
    80005d0a:	86ce                	mv	a3,s3
    80005d0c:	f1840613          	addi	a2,s0,-232
    80005d10:	4581                	li	a1,0
    80005d12:	854a                	mv	a0,s2
    80005d14:	ffffe097          	auipc	ra,0xffffe
    80005d18:	3ce080e7          	jalr	974(ra) # 800040e2 <readi>
    80005d1c:	47c1                	li	a5,16
    80005d1e:	00f51b63          	bne	a0,a5,80005d34 <sys_unlink+0x16c>
    if(de.inum != 0)
    80005d22:	f1845783          	lhu	a5,-232(s0)
    80005d26:	e7a1                	bnez	a5,80005d6e <sys_unlink+0x1a6>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    80005d28:	29c1                	addiw	s3,s3,16
    80005d2a:	04c92783          	lw	a5,76(s2)
    80005d2e:	fcf9ede3          	bltu	s3,a5,80005d08 <sys_unlink+0x140>
    80005d32:	b781                	j	80005c72 <sys_unlink+0xaa>
      panic("isdirempty: readi");
    80005d34:	00003517          	auipc	a0,0x3
    80005d38:	b7450513          	addi	a0,a0,-1164 # 800088a8 <syscalls+0x308>
    80005d3c:	ffffb097          	auipc	ra,0xffffb
    80005d40:	802080e7          	jalr	-2046(ra) # 8000053e <panic>
    panic("unlink: writei");
    80005d44:	00003517          	auipc	a0,0x3
    80005d48:	b7c50513          	addi	a0,a0,-1156 # 800088c0 <syscalls+0x320>
    80005d4c:	ffffa097          	auipc	ra,0xffffa
    80005d50:	7f2080e7          	jalr	2034(ra) # 8000053e <panic>
    dp->nlink--;
    80005d54:	04a4d783          	lhu	a5,74(s1)
    80005d58:	37fd                	addiw	a5,a5,-1
    80005d5a:	04f49523          	sh	a5,74(s1)
    iupdate(dp);
    80005d5e:	8526                	mv	a0,s1
    80005d60:	ffffe097          	auipc	ra,0xffffe
    80005d64:	004080e7          	jalr	4(ra) # 80003d64 <iupdate>
    80005d68:	b781                	j	80005ca8 <sys_unlink+0xe0>
    return -1;
    80005d6a:	557d                	li	a0,-1
    80005d6c:	a005                	j	80005d8c <sys_unlink+0x1c4>
    iunlockput(ip);
    80005d6e:	854a                	mv	a0,s2
    80005d70:	ffffe097          	auipc	ra,0xffffe
    80005d74:	320080e7          	jalr	800(ra) # 80004090 <iunlockput>
  iunlockput(dp);
    80005d78:	8526                	mv	a0,s1
    80005d7a:	ffffe097          	auipc	ra,0xffffe
    80005d7e:	316080e7          	jalr	790(ra) # 80004090 <iunlockput>
  end_op();
    80005d82:	fffff097          	auipc	ra,0xfffff
    80005d86:	afe080e7          	jalr	-1282(ra) # 80004880 <end_op>
  return -1;
    80005d8a:	557d                	li	a0,-1
}
    80005d8c:	70ae                	ld	ra,232(sp)
    80005d8e:	740e                	ld	s0,224(sp)
    80005d90:	64ee                	ld	s1,216(sp)
    80005d92:	694e                	ld	s2,208(sp)
    80005d94:	69ae                	ld	s3,200(sp)
    80005d96:	616d                	addi	sp,sp,240
    80005d98:	8082                	ret

0000000080005d9a <sys_open>:

uint64
sys_open(void)
{
    80005d9a:	7131                	addi	sp,sp,-192
    80005d9c:	fd06                	sd	ra,184(sp)
    80005d9e:	f922                	sd	s0,176(sp)
    80005da0:	f526                	sd	s1,168(sp)
    80005da2:	f14a                	sd	s2,160(sp)
    80005da4:	ed4e                	sd	s3,152(sp)
    80005da6:	0180                	addi	s0,sp,192
  int fd, omode;
  struct file *f;
  struct inode *ip;
  int n;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    80005dac:	f5040593          	addi	a1,s0,-176
    80005db0:	4501                	li	a0,0
    80005db2:	ffffd097          	auipc	ra,0xffffd
    80005db6:	1d8080e7          	jalr	472(ra) # 80002f8a <argstr>
    return -1;
    80005dba:	54fd                	li	s1,-1
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    80005dbc:	0c054163          	bltz	a0,80005e7e <sys_open+0xe4>
    80005dc0:	f4c40593          	addi	a1,s0,-180
    80005dc4:	4505                	li	a0,1
    80005dc6:	ffffd097          	auipc	ra,0xffffd
    80005dca:	180080e7          	jalr	384(ra) # 80002f46 <argint>
    80005dce:	0a054863          	bltz	a0,80005e7e <sys_open+0xe4>

  begin_op();
    80005dd2:	fffff097          	auipc	ra,0xfffff
    80005dd6:	a2e080e7          	jalr	-1490(ra) # 80004800 <begin_op>

  if(omode & O_CREATE){
    80005dda:	f4c42783          	lw	a5,-180(s0)
    80005dde:	2007f793          	andi	a5,a5,512
    80005de2:	cbdd                	beqz	a5,80005e98 <sys_open+0xfe>
    ip = create(path, T_FILE, 0, 0);
    80005de4:	4681                	li	a3,0
    80005de6:	4601                	li	a2,0
    80005de8:	4589                	li	a1,2
    80005dea:	f5040513          	addi	a0,s0,-176
    80005dee:	00000097          	auipc	ra,0x0
    80005df2:	972080e7          	jalr	-1678(ra) # 80005760 <create>
    80005df6:	892a                	mv	s2,a0
    if(ip == 0){
    80005df8:	c959                	beqz	a0,80005e8e <sys_open+0xf4>
      end_op();
      return -1;
    }
  }
  ...
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    ...
    80005e00:	00f71763          	bne	a4,a5,80005e0e <sys_open+0x74>
    80005e04:	04695703          	lhu	a4,70(s2)
    80005e08:	47a5                	li	a5,9
    80005e0a:	0ce7ec63          	bltu	a5,a4,80005ee2 <sys_open+0x148>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    ...
    80005e12:	e02080e7          	jalr	-510(ra) # 80004c10 <filealloc>
    80005e16:	89aa                	mv	s3,a0
    80005e18:	10050263          	beqz	a0,80005f1c <sys_open+0x182>
    80005e1c:	00000097          	auipc	ra,0x0
    80005e20:	902080e7          	jalr	-1790(ra) # 8000571e <fdalloc>
    80005e24:	84aa                	mv	s1,a0
    80005e26:	0e054663          	bltz	a0,80005f12 <sys_open+0x178>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_DEVICE){
    ...
    80005e30:	0cf70463          	beq	a4,a5,80005ef8 <sys_open+0x15e>
    f->type = FD_DEVICE;
    f->major = ip->major;
  } else {
    f->type = FD_INODE;
    80005e34:	4789                	li	a5,2
    80005e36:	00f9a023          	sw	a5,0(s3)
    f->off = 0;
    80005e3a:	0209a023          	sw	zero,32(s3)
  }
  f->ip = ip;
    80005e3e:	0129bc23          	sd	s2,24(s3)
  f->readable = !(omode & O_WRONLY);
    80005e42:	f4c42783          	lw	a5,-180(s0)
    80005e46:	0017c713          	xori	a4,a5,1
    80005e4a:	8b05                	andi	a4,a4,1
    80005e4c:	00e98423          	sb	a4,8(s3)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
    80005e50:	0037f713          	andi	a4,a5,3
    80005e54:	00e03733          	snez	a4,a4
    80005e58:	00e984a3          	sb	a4,9(s3)

  if((omode & O_TRUNC) && ip->type == T_FILE){
    80005e5c:	4007f793          	andi	a5,a5,1024
    80005e60:	c791                	beqz	a5,80005e6c <sys_open+0xd2>
    80005e62:	04491703          	lh	a4,68(s2)
    80005e66:	4789                	li	a5,2
    80005e68:	08f70f63          	beq	a4,a5,80005f06 <sys_open+0x16c>
    itrunc(ip);
  }
  ...
  iunlock(ip);
    ...
    80005e72:	082080e7          	jalr	130(ra) # 80003ef0 <iunlock>
  end_op();
    80005e76:	fffff097          	auipc	ra,0xfffff
    80005e7a:	a0a080e7          	jalr	-1526(ra) # 80004880 <end_op>

  return fd;
}
    80005e7e:	8526                	mv	a0,s1
    80005e80:	70ea                	ld	ra,184(sp)
    80005e82:	744a                	ld	s0,176(sp)
    80005e84:	74aa                	ld	s1,168(sp)
    80005e86:	790a                	ld	s2,160(sp)
    80005e88:	69ea                	ld	s3,152(sp)
    80005e8a:	6129                	addi	sp,sp,192
    80005e8c:	8082                	ret
      end_op();
    80005e8e:	fffff097          	auipc	ra,0xfffff
    80005e92:	9f2080e7          	jalr	-1550(ra) # 80004880 <end_op>
      return -1;
    80005e96:	b7e5                	j	80005e7e <sys_open+0xe4>
    if((ip = namei(path)) == 0){
    80005e98:	f5040513          	addi	a0,s0,-176
    80005e9c:	ffffe097          	auipc	ra,0xffffe
    80005ea0:	748080e7          	jalr	1864(ra) # 800045e4 <namei>
    80005ea4:	892a                	mv	s2,a0
    80005ea6:	c905                	beqz	a0,80005ed6 <sys_open+0x13c>
    ilock(ip);
    80005ea8:	ffffe097          	auipc	ra,0xffffe
    80005eac:	f86080e7          	jalr	-122(ra) # 80003e2e <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
    80005eb0:	04491703          	lh	a4,68(s2)
    80005eb4:	4785                	li	a5,1
    80005eb6:	f4f712e3          	bne	a4,a5,80005dfa <sys_open+0x60>
    80005eba:	f4c42783          	lw	a5,-180(s0)
    80005ebe:	dba1                	beqz	a5,80005e0e <sys_open+0x74>
      iunlockput(ip);
    80005ec0:	854a                	mv	a0,s2
    80005ec2:	ffffe097          	auipc	ra,0xffffe
    80005ec6:	1ce080e7          	jalr	462(ra) # 80004090 <iunlockput>
      end_op();
    80005eca:	fffff097          	auipc	ra,0xfffff
    80005ece:	9b6080e7          	jalr	-1610(ra) # 80004880 <end_op>
      return -1;
    80005ed2:	54fd                	li	s1,-1
    80005ed4:	b76d                	j	80005e7e <sys_open+0xe4>
      end_op();
    80005ed6:	fffff097          	auipc	ra,0xfffff
    80005eda:	9aa080e7          	jalr	-1622(ra) # 80004880 <end_op>
      return -1;
    80005ede:	54fd                	li	s1,-1
    80005ee0:	bf79                	j	80005e7e <sys_open+0xe4>
    iunlockput(ip);
    80005ee2:	854a                	mv	a0,s2
    80005ee4:	ffffe097          	auipc	ra,0xffffe
    80005ee8:	1ac080e7          	jalr	428(ra) # 80004090 <iunlockput>
    end_op();
    80005eec:	fffff097          	auipc	ra,0xfffff
    80005ef0:	994080e7          	jalr	-1644(ra) # 80004880 <end_op>
    return -1;
    80005ef4:	54fd                	li	s1,-1
    80005ef6:	b761                	j	80005e7e <sys_open+0xe4>
    f->type = FD_DEVICE;
    80005ef8:	00f9a023          	sw	a5,0(s3)
    f->major = ip->major;
    80005efc:	04691783          	lh	a5,70(s2)
    80005f00:	02f99223          	sh	a5,36(s3)
    80005f04:	bf2d                	j	80005e3e <sys_open+0xa4>
    itrunc(ip);
    80005f06:	854a                	mv	a0,s2
    80005f08:	ffffe097          	auipc	ra,0xffffe
    80005f0c:	034080e7          	jalr	52(ra) # 80003f3c <itrunc>
    80005f10:	bfb1                	j	80005e6c <sys_open+0xd2>
      fileclose(f);
    80005f12:	854e                	mv	a0,s3
    80005f14:	fffff097          	auipc	ra,0xfffff
    80005f18:	db8080e7          	jalr	-584(ra) # 80004ccc <fileclose>
    iunlockput(ip);
    80005f1c:	854a                	mv	a0,s2
    80005f1e:	ffffe097          	auipc	ra,0xffffe
    80005f22:	172080e7          	jalr	370(ra) # 80004090 <iunlockput>
    end_op();
    80005f26:	fffff097          	auipc	ra,0xfffff
    80005f2a:	95a080e7          	jalr	-1702(ra) # 80004880 <end_op>
    return -1;
    80005f2e:	54fd                	li	s1,-1
    80005f30:	b7b9                	j	80005e7e <sys_open+0xe4>

0000000080005f32 <sys_mkdir>:

uint64
sys_mkdir(void)
{
    80005f32:	7175                	addi	sp,sp,-144
    80005f34:	e506                	sd	ra,136(sp)
    80005f36:	e122                	sd	s0,128(sp)
    80005f38:	0900                	addi	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;

  begin_op();
    80005f3a:	fffff097          	auipc	ra,0xfffff
    80005f3e:	8c6080e7          	jalr	-1850(ra) # 80004800 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80005f50:	03e080e7          	jalr	62(ra) # 80002f8a <argstr>
    80005f54:	02054963          	bltz	a0,80005f86 <sys_mkdir+0x54>
    80005f58:	4681                	li	a3,0
    80005f5a:	4601                	li	a2,0
    80005f5c:	4585                	li	a1,1
    80005f5e:	f7040513          	addi	a0,s0,-144
    80005f62:	fffff097          	auipc	ra,0xfffff
    80005f66:	7fe080e7          	jalr	2046(ra) # 80005760 <create>
    80005f6a:	cd11                	beqz	a0,80005f86 <sys_mkdir+0x54>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80005f6c:	ffffe097          	auipc	ra,0xffffe
    80005f70:	124080e7          	jalr	292(ra) # 80004090 <iunlockput>
  end_op();
    80005f74:	fffff097          	auipc	ra,0xfffff
    80005f78:	90c080e7          	jalr	-1780(ra) # 80004880 <end_op>
  return 0;
    80005f7c:	4501                	li	a0,0
}
    80005f7e:	60aa                	ld	ra,136(sp)
    80005f80:	640a                	ld	s0,128(sp)
    80005f82:	6149                	addi	sp,sp,144
    80005f84:	8082                	ret
    end_op();
    80005f86:	fffff097          	auipc	ra,0xfffff
    80005f8a:	8fa080e7          	jalr	-1798(ra) # 80004880 <end_op>
    return -1;
    80005f8e:	557d                	li	a0,-1
    80005f90:	b7fd                	j	80005f7e <sys_mkdir+0x4c>

0000000080005f92 <sys_mknod>:
...
sys_mknod(void)
{
  ...
  begin_op();
    ...
    80005f9e:	866080e7          	jalr	-1946(ra) # 80004800 <begin_op>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80005fa2:	08000613          	li	a2,128
    80005fa6:	f7040593          	addi	a1,s0,-144
    80005faa:	4501                	li	a0,0
    80005fac:	ffffd097          	auipc	ra,0xffffd
    80005fb0:	fde080e7          	jalr	-34(ra) # 80002f8a <argstr>
    80005fb4:	04054a63          	bltz	a0,80006008 <sys_mknod+0x76>
     argint(1, &major) < 0 ||
    80005fb8:	f6c40593          	addi	a1,s0,-148
    80005fbc:	4505                	li	a0,1
    80005fbe:	ffffd097          	auipc	ra,0xffffd
    80005fc2:	f88080e7          	jalr	-120(ra) # 80002f46 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80005fc6:	04054163          	bltz	a0,80006008 <sys_mknod+0x76>
     argint(2, &minor) < 0 ||
    80005fca:	f6840593          	addi	a1,s0,-152
    80005fce:	4509                	li	a0,2
    80005fd0:	ffffd097          	auipc	ra,0xffffd
    80005fd4:	f76080e7          	jalr	-138(ra) # 80002f46 <argint>
     argint(1, &major) < 0 ||
    80005fd8:	02054863          	bltz	a0,80006008 <sys_mknod+0x76>
     (ip = create(path, T_DEVICE, major, minor)) == 0){
    80005fdc:	f6841683          	lh	a3,-152(s0)
    80005fe0:	f6c41603          	lh	a2,-148(s0)
    80005fe4:	458d                	li	a1,3
    80005fe6:	f7040513          	addi	a0,s0,-144
    80005fea:	fffff097          	auipc	ra,0xfffff
    80005fee:	776080e7          	jalr	1910(ra) # 80005760 <create>
     argint(2, &minor) < 0 ||
    80005ff2:	c919                	beqz	a0,80006008 <sys_mknod+0x76>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80005ff4:	ffffe097          	auipc	ra,0xffffe
    80005ff8:	09c080e7          	jalr	156(ra) # 80004090 <iunlockput>
  end_op();
    80005ffc:	fffff097          	auipc	ra,0xfffff
    80006000:	884080e7          	jalr	-1916(ra) # 80004880 <end_op>
  return 0;
    80006004:	4501                	li	a0,0
    80006006:	a031                	j	80006012 <sys_mknod+0x80>
    end_op();
    80006008:	fffff097          	auipc	ra,0xfffff
    8000600c:	878080e7          	jalr	-1928(ra) # 80004880 <end_op>
    return -1;
    80006010:	557d                	li	a0,-1
}
    80006012:	60ea                	ld	ra,152(sp)
    80006014:	644a                	ld	s0,144(sp)
    80006016:	610d                	addi	sp,sp,160
    80006018:	8082                	ret

000000008000601a <sys_chdir>:

uint64
sys_chdir(void)
{
    8000601a:	7135                	addi	sp,sp,-160
    8000601c:	ed06                	sd	ra,152(sp)
    8000601e:	e922                	sd	s0,144(sp)
    80006020:	e526                	sd	s1,136(sp)
    80006022:	e14a                	sd	s2,128(sp)
    80006024:	1100                	addi	s0,sp,160
  char path[MAXPATH];
  struct inode *ip;
  struct proc *p = myproc();
    80006026:	ffffc097          	auipc	ra,0xffffc
    8000602a:	98a080e7          	jalr	-1654(ra) # 800019b0 <myproc>
    8000602e:	892a                	mv	s2,a0
  
  begin_op();
    80006030:	ffffe097          	auipc	ra,0xffffe
    80006034:	7d0080e7          	jalr	2000(ra) # 80004800 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    80006038:	08000613          	li	a2,128
    8000603c:	f6040593          	addi	a1,s0,-160
    80006040:	4501                	li	a0,0
    80006042:	ffffd097          	auipc	ra,0xffffd
    80006046:	f48080e7          	jalr	-184(ra) # 80002f8a <argstr>
    8000604a:	04054b63          	bltz	a0,800060a0 <sys_chdir+0x86>
    8000604e:	f6040513          	addi	a0,s0,-160
    80006052:	ffffe097          	auipc	ra,0xffffe
    80006056:	592080e7          	jalr	1426(ra) # 800045e4 <namei>
    8000605a:	84aa                	mv	s1,a0
    8000605c:	c131                	beqz	a0,800060a0 <sys_chdir+0x86>
    end_op();
    return -1;
  }
  ilock(ip);
    8000605e:	ffffe097          	auipc	ra,0xffffe
    80006062:	dd0080e7          	jalr	-560(ra) # 80003e2e <ilock>
  if(ip->type != T_DIR){
    80006066:	04449703          	lh	a4,68(s1)
    8000606a:	4785                	li	a5,1
    8000606c:	04f71063          	bne	a4,a5,800060ac <sys_chdir+0x92>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
    ...
    80006076:	e7e080e7          	jalr	-386(ra) # 80003ef0 <iunlock>
  iput(p->cwd);
    8000607a:	15093503          	ld	a0,336(s2)
    8000607e:	ffffe097          	auipc	ra,0xffffe
    80006082:	f6a080e7          	jalr	-150(ra) # 80003fe8 <iput>
  end_op();
    80006086:	ffffe097          	auipc	ra,0xffffe
    8000608a:	7fa080e7          	jalr	2042(ra) # 80004880 <end_op>
  p->cwd = ip;
    8000608e:	14993823          	sd	s1,336(s2)
  return 0;
    80006092:	4501                	li	a0,0
}
    80006094:	60ea                	ld	ra,152(sp)
    80006096:	644a                	ld	s0,144(sp)
    80006098:	64aa                	ld	s1,136(sp)
    8000609a:	690a                	ld	s2,128(sp)
    8000609c:	610d                	addi	sp,sp,160
    8000609e:	8082                	ret
    end_op();
    800060a0:	ffffe097          	auipc	ra,0xffffe
    800060a4:	7e0080e7          	jalr	2016(ra) # 80004880 <end_op>
    return -1;
    800060a8:	557d                	li	a0,-1
    800060aa:	b7ed                	j	80006094 <sys_chdir+0x7a>
    iunlockput(ip);
    800060ac:	8526                	mv	a0,s1
    800060ae:	ffffe097          	auipc	ra,0xffffe
    800060b2:	fe2080e7          	jalr	-30(ra) # 80004090 <iunlockput>
    end_op();
    800060b6:	ffffe097          	auipc	ra,0xffffe
    800060ba:	7ca080e7          	jalr	1994(ra) # 80004880 <end_op>
    return -1;
    800060be:	557d                	li	a0,-1
    800060c0:	bfd1                	j	80006094 <sys_chdir+0x7a>

00000000800060c2 <sys_exec>:

uint64
sys_exec(void)
{
    800060c2:	7145                	addi	sp,sp,-464
    800060c4:	e786                	sd	ra,456(sp)
    800060c6:	e3a2                	sd	s0,448(sp)
    800060c8:	ff26                	sd	s1,440(sp)
    800060ca:	fb4a                	sd	s2,432(sp)
    800060cc:	f74e                	sd	s3,424(sp)
    800060ce:	f352                	sd	s4,416(sp)
    800060d0:	ef56                	sd	s5,408(sp)
    800060d2:	0b80                	addi	s0,sp,464
  char path[MAXPATH], *argv[MAXARG];
  int i;
  uint64 uargv, uarg;

  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    800060d4:	08000613          	li	a2,128
    800060d8:	f4040593          	addi	a1,s0,-192
    800060dc:	4501                	li	a0,0
    800060de:	ffffd097          	auipc	ra,0xffffd
    800060e2:	eac080e7          	jalr	-340(ra) # 80002f8a <argstr>
    return -1;
    800060e6:	597d                	li	s2,-1
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    800060e8:	0c054a63          	bltz	a0,800061bc <sys_exec+0xfa>
    800060ec:	e3840593          	addi	a1,s0,-456
    800060f0:	4505                	li	a0,1
    800060f2:	ffffd097          	auipc	ra,0xffffd
    800060f6:	e76080e7          	jalr	-394(ra) # 80002f68 <argaddr>
    800060fa:	0c054163          	bltz	a0,800061bc <sys_exec+0xfa>
  }
  memset(argv, 0, sizeof(argv));
    800060fe:	10000613          	li	a2,256
    80006102:	4581                	li	a1,0
    80006104:	e4040513          	addi	a0,s0,-448
    80006108:	ffffb097          	auipc	ra,0xffffb
    8000610c:	bd8080e7          	jalr	-1064(ra) # 80000ce0 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
    80006110:	e4040493          	addi	s1,s0,-448
  memset(argv, 0, sizeof(argv));
    80006114:	89a6                	mv	s3,s1
    80006116:	4901                	li	s2,0
    if(i >= NELEM(argv)){
    80006118:	02000a13          	li	s4,32
    8000611c:	00090a9b          	sext.w	s5,s2
      goto bad;
    }
    if(fetchaddr(uargv+sizeof(uint64)*i, (uint64*)&uarg) < 0){
    80006120:	00391513          	slli	a0,s2,0x3
    80006124:	e3040593          	addi	a1,s0,-464
    80006128:	e3843783          	ld	a5,-456(s0)
    8000612c:	953e                	add	a0,a0,a5
    8000612e:	ffffd097          	auipc	ra,0xffffd
    80006132:	d7e080e7          	jalr	-642(ra) # 80002eac <fetchaddr>
    80006136:	02054a63          	bltz	a0,8000616a <sys_exec+0xa8>
      goto bad;
    }
    if(uarg == 0){
    8000613a:	e3043783          	ld	a5,-464(s0)
    8000613e:	c3b9                	beqz	a5,80006184 <sys_exec+0xc2>
      argv[i] = 0;
      break;
    }
    argv[i] = kalloc();
    80006140:	ffffb097          	auipc	ra,0xffffb
    80006144:	9b4080e7          	jalr	-1612(ra) # 80000af4 <kalloc>
    80006148:	85aa                	mv	a1,a0
    8000614a:	00a9b023          	sd	a0,0(s3)
    if(argv[i] == 0)
    8000614e:	cd11                	beqz	a0,8000616a <sys_exec+0xa8>
      goto bad;
    if(fetchstr(uarg, argv[i], PGSIZE) < 0)
    80006150:	6605                	lui	a2,0x1
    80006152:	e3043503          	ld	a0,-464(s0)
    80006156:	ffffd097          	auipc	ra,0xffffd
    8000615a:	da8080e7          	jalr	-600(ra) # 80002efe <fetchstr>
    8000615e:	00054663          	bltz	a0,8000616a <sys_exec+0xa8>
    if(i >= NELEM(argv)){
    80006162:	0905                	addi	s2,s2,1
    80006164:	09a1                	addi	s3,s3,8
    80006166:	fb491be3          	bne	s2,s4,8000611c <sys_exec+0x5a>
    kfree(argv[i]);
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    8000616a:	10048913          	addi	s2,s1,256
    8000616e:	6088                	ld	a0,0(s1)
    80006170:	c529                	beqz	a0,800061ba <sys_exec+0xf8>
    kfree(argv[i]);
    80006172:	ffffb097          	auipc	ra,0xffffb
    80006176:	886080e7          	jalr	-1914(ra) # 800009f8 <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    8000617a:	04a1                	addi	s1,s1,8
    8000617c:	ff2499e3          	bne	s1,s2,8000616e <sys_exec+0xac>
  return -1;
    80006180:	597d                	li	s2,-1
    80006182:	a82d                	j	800061bc <sys_exec+0xfa>
      argv[i] = 0;
    80006184:	0a8e                	slli	s5,s5,0x3
    80006186:	fc040793          	addi	a5,s0,-64
    8000618a:	9abe                	add	s5,s5,a5
    8000618c:	e80ab023          	sd	zero,-384(s5)
  int ret = exec(path, argv);
    80006190:	e4040593          	addi	a1,s0,-448
    80006194:	f4040513          	addi	a0,s0,-192
    80006198:	fffff097          	auipc	ra,0xfffff
    8000619c:	194080e7          	jalr	404(ra) # 8000532c <exec>
    800061a0:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    800061a2:	10048993          	addi	s3,s1,256
    800061a6:	6088                	ld	a0,0(s1)
    800061a8:	c911                	beqz	a0,800061bc <sys_exec+0xfa>
    kfree(argv[i]);
    800061aa:	ffffb097          	auipc	ra,0xffffb
    800061ae:	84e080e7          	jalr	-1970(ra) # 800009f8 <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    800061b2:	04a1                	addi	s1,s1,8
    800061b4:	ff3499e3          	bne	s1,s3,800061a6 <sys_exec+0xe4>
    800061b8:	a011                	j	800061bc <sys_exec+0xfa>
  return -1;
    800061ba:	597d                	li	s2,-1
}
    800061bc:	854a                	mv	a0,s2
    800061be:	60be                	ld	ra,456(sp)
    800061c0:	641e                	ld	s0,448(sp)
    800061c2:	74fa                	ld	s1,440(sp)
    800061c4:	795a                	ld	s2,432(sp)
    800061c6:	79ba                	ld	s3,424(sp)
    800061c8:	7a1a                	ld	s4,416(sp)
    800061ca:	6afa                	ld	s5,408(sp)
    800061cc:	6179                	addi	sp,sp,464
    800061ce:	8082                	ret

00000000800061d0 <sys_pipe>:
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    800061de:	7d6080e7          	jalr	2006(ra) # 800019b0 <myproc>
    800061e2:	84aa                	mv	s1,a0

  if(argaddr(0, &fdarray) < 0)
    800061e4:	fd840593          	addi	a1,s0,-40
    800061e8:	4501                	li	a0,0
    800061ea:	ffffd097          	auipc	ra,0xffffd
    800061ee:	d7e080e7          	jalr	-642(ra) # 80002f68 <argaddr>
    return -1;
    800061f2:	57fd                	li	a5,-1
  if(argaddr(0, &fdarray) < 0)
    800061f4:	0e054063          	bltz	a0,800062d4 <sys_pipe+0x104>
  if(pipealloc(&rf, &wf) < 0)
    800061f8:	fc840593          	addi	a1,s0,-56
    800061fc:	fd040513          	addi	a0,s0,-48
    80006200:	fffff097          	auipc	ra,0xfffff
    80006204:	dfc080e7          	jalr	-516(ra) # 80004ffc <pipealloc>
    return -1;
    80006208:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    8000620a:	0c054563          	bltz	a0,800062d4 <sys_pipe+0x104>
  fd0 = -1;
    8000620e:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    80006212:	fd043503          	ld	a0,-48(s0)
    80006216:	fffff097          	auipc	ra,0xfffff
    8000621a:	508080e7          	jalr	1288(ra) # 8000571e <fdalloc>
    8000621e:	fca42223          	sw	a0,-60(s0)
    80006222:	08054c63          	bltz	a0,800062ba <sys_pipe+0xea>
    80006226:	fc843503          	ld	a0,-56(s0)
    8000622a:	fffff097          	auipc	ra,0xfffff
    8000622e:	4f4080e7          	jalr	1268(ra) # 8000571e <fdalloc>
    80006232:	fca42023          	sw	a0,-64(s0)
    80006236:	06054863          	bltz	a0,800062a6 <sys_pipe+0xd6>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    8000623a:	4691                	li	a3,4
    8000623c:	fc440613          	addi	a2,s0,-60
    80006240:	fd843583          	ld	a1,-40(s0)
    80006244:	68a8                	ld	a0,80(s1)
    80006246:	ffffb097          	auipc	ra,0xffffb
    8000624a:	42c080e7          	jalr	1068(ra) # 80001672 <copyout>
    8000624e:	02054063          	bltz	a0,8000626e <sys_pipe+0x9e>
     copyout(p->pagetable, fdarray+sizeof(fd0), (char *)&fd1, sizeof(fd1)) < 0){
    80006252:	4691                	li	a3,4
    80006254:	fc040613          	addi	a2,s0,-64
    80006258:	fd843583          	ld	a1,-40(s0)
    8000625c:	0591                	addi	a1,a1,4
    8000625e:	68a8                	ld	a0,80(s1)
    80006260:	ffffb097          	auipc	ra,0xffffb
    80006264:	412080e7          	jalr	1042(ra) # 80001672 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    8000626a:	06055563          	bgez	a0,800062d4 <sys_pipe+0x104>
    p->ofile[fd0] = 0;
    8000626e:	fc442783          	lw	a5,-60(s0)
    80006272:	07e9                	addi	a5,a5,26
    80006274:	078e                	slli	a5,a5,0x3
    80006276:	97a6                	add	a5,a5,s1
    80006278:	0007b023          	sd	zero,0(a5)
    p->ofile[fd1] = 0;
    8000627c:	fc042503          	lw	a0,-64(s0)
    80006280:	0569                	addi	a0,a0,26
    ...
    80006292:	a3e080e7          	jalr	-1474(ra) # 80004ccc <fileclose>
    fileclose(wf);
    80006296:	fc843503          	ld	a0,-56(s0)
    8000629a:	fffff097          	auipc	ra,0xfffff
    8000629e:	a32080e7          	jalr	-1486(ra) # 80004ccc <fileclose>
    return -1;
    800062a2:	57fd                	li	a5,-1
    800062a4:	a805                	j	800062d4 <sys_pipe+0x104>
    if(fd0 >= 0)
    800062a6:	fc442783          	lw	a5,-60(s0)
    800062aa:	0007c863          	bltz	a5,800062ba <sys_pipe+0xea>
      p->ofile[fd0] = 0;
    800062ae:	01a78513          	addi	a0,a5,26
    800062b2:	050e                	slli	a0,a0,0x3
    800062b4:	9526                	add	a0,a0,s1
    800062b6:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    800062ba:	fd043503          	ld	a0,-48(s0)
    800062be:	fffff097          	auipc	ra,0xfffff
    800062c2:	a0e080e7          	jalr	-1522(ra) # 80004ccc <fileclose>
    fileclose(wf);
    800062c6:	fc843503          	ld	a0,-56(s0)
    800062ca:	fffff097          	auipc	ra,0xfffff
    800062ce:	a02080e7          	jalr	-1534(ra) # 80004ccc <fileclose>
    return -1;
    800062d2:	57fd                	li	a5,-1
}
    800062d4:	853e                	mv	a0,a5
    800062d6:	70e2                	ld	ra,56(sp)
    800062d8:	7442                	ld	s0,48(sp)
    800062da:	74a2                	ld	s1,40(sp)
    800062dc:	6121                	addi	sp,sp,64
    800062de:	8082                	ret
...
00000000800062e0 <kernelvec>:
    ...
    80006320:	a59fc0ef          	jal	ra,80002d78 <kerneltrap>
...
plicinithart(void)
{
  ...
  int hart = cpuid();
    ...
    800063bc:	5cc080e7          	jalr	1484(ra) # 80001984 <cpuid>
...
plic_claim(void)
{
  ...
  int hart = cpuid();
    ...
    800063f4:	594080e7          	jalr	1428(ra) # 80001984 <cpuid>
  int irq = *(uint32*)PLIC_SCLAIM(hart);
    800063f8:	00d5179b          	slliw	a5,a0,0xd
    800063fc:	0c201537          	lui	a0,0xc201
    80006400:	953e                	add	a0,a0,a5
  return irq;
}
    80006402:	4148                	lw	a0,4(a0)
...
plic_complete(int irq)
{
  ...
  int hart = cpuid();
    ...
    8000641c:	56c080e7          	jalr	1388(ra) # 80001984 <cpuid>
...
free_desc(int i)
{
  ...
  if(i >= NUM)
    ...
    80006440:	06a7c963          	blt	a5,a0,800064b2 <free_desc+0x7c>
    panic("free_desc 1");
  if(disk.free[i])
    80006444:	0001e797          	auipc	a5,0x1e
    80006448:	bbc78793          	addi	a5,a5,-1092 # 80024000 <disk>
    8000644c:	00a78733          	add	a4,a5,a0
    80006450:	6789                	lui	a5,0x2
    80006452:	97ba                	add	a5,a5,a4
    80006454:	0187c783          	lbu	a5,24(a5) # 2018 <_entry-0x7fffdfe8>
    80006458:	e7ad                	bnez	a5,800064c2 <free_desc+0x8c>
    panic("free_desc 2");
  disk.desc[i].addr = 0;
    8000645a:	00451793          	slli	a5,a0,0x4
    8000645e:	00020717          	auipc	a4,0x20
    80006462:	ba270713          	addi	a4,a4,-1118 # 80026000 <disk+0x2000>
    80006466:	6314                	ld	a3,0(a4)
    80006468:	96be                	add	a3,a3,a5
    8000646a:	0006b023          	sd	zero,0(a3)
  disk.desc[i].len = 0;
    8000646e:	6314                	ld	a3,0(a4)
    80006470:	96be                	add	a3,a3,a5
    80006472:	0006a423          	sw	zero,8(a3)
  disk.desc[i].flags = 0;
    80006476:	6314                	ld	a3,0(a4)
    80006478:	96be                	add	a3,a3,a5
    8000647a:	00069623          	sh	zero,12(a3)
  disk.desc[i].next = 0;
    8000647e:	6318                	ld	a4,0(a4)
    80006480:	97ba                	add	a5,a5,a4
    80006482:	00079723          	sh	zero,14(a5)
  disk.free[i] = 1;
    80006486:	0001e797          	auipc	a5,0x1e
    8000648a:	b7a78793          	addi	a5,a5,-1158 # 80024000 <disk>
    8000648e:	97aa                	add	a5,a5,a0
    80006490:	6509                	lui	a0,0x2
    80006492:	953e                	add	a0,a0,a5
    80006494:	4785                	li	a5,1
    80006496:	00f50c23          	sb	a5,24(a0) # 2018 <_entry-0x7fffdfe8>
  wakeup(&disk.free[0]);
    8000649a:	00020517          	auipc	a0,0x20
    8000649e:	b7e50513          	addi	a0,a0,-1154 # 80026018 <disk+0x2018>
    800064a2:	ffffc097          	auipc	ra,0xffffc
    800064a6:	ce0080e7          	jalr	-800(ra) # 80002182 <wakeup>
}
    800064aa:	60a2                	ld	ra,8(sp)
    800064ac:	6402                	ld	s0,0(sp)
    800064ae:	0141                	addi	sp,sp,16
    800064b0:	8082                	ret
    panic("free_desc 1");
    800064b2:	00002517          	auipc	a0,0x2
    800064b6:	41e50513          	addi	a0,a0,1054 # 800088d0 <syscalls+0x330>
    800064ba:	ffffa097          	auipc	ra,0xffffa
    800064be:	084080e7          	jalr	132(ra) # 8000053e <panic>
    panic("free_desc 2");
    800064c2:	00002517          	auipc	a0,0x2
    800064c6:	41e50513          	addi	a0,a0,1054 # 800088e0 <syscalls+0x340>
    800064ca:	ffffa097          	auipc	ra,0xffffa
    800064ce:	074080e7          	jalr	116(ra) # 8000053e <panic>

00000000800064d2 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    800064e0:	41458593          	addi	a1,a1,1044 # 800088f0 <syscalls+0x350>
    800064e4:	00020517          	auipc	a0,0x20
    800064e8:	c4450513          	addi	a0,a0,-956 # 80026128 <disk+0x2128>
    800064ec:	ffffa097          	auipc	ra,0xffffa
    800064f0:	668080e7          	jalr	1640(ra) # 80000b54 <initlock>
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    800064f4:	100017b7          	lui	a5,0x10001
    800064f8:	4398                	lw	a4,0(a5)
    800064fa:	2701                	sext.w	a4,a4
    800064fc:	747277b7          	lui	a5,0x74727
    80006500:	97678793          	addi	a5,a5,-1674 # 74726976 <_entry-0xb8d968a>
    80006504:	0ef71163          	bne	a4,a5,800065e6 <virtio_disk_init+0x114>
     *R(VIRTIO_MMIO_VERSION) != 1 ||
    80006508:	100017b7          	lui	a5,0x10001
    8000650c:	43dc                	lw	a5,4(a5)
    8000650e:	2781                	sext.w	a5,a5
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    80006510:	4705                	li	a4,1
    80006512:	0ce79a63          	bne	a5,a4,800065e6 <virtio_disk_init+0x114>
     *R(VIRTIO_MMIO_DEVICE_ID) != 2 ||
    80006516:	100017b7          	lui	a5,0x10001
    8000651a:	479c                	lw	a5,8(a5)
    8000651c:	2781                	sext.w	a5,a5
     *R(VIRTIO_MMIO_VERSION) != 1 ||
    8000651e:	4709                	li	a4,2
    80006520:	0ce79363          	bne	a5,a4,800065e6 <virtio_disk_init+0x114>
     *R(VIRTIO_MMIO_VENDOR_ID) != 0x554d4551){
    80006524:	100017b7          	lui	a5,0x10001
    80006528:	47d8                	lw	a4,12(a5)
    8000652a:	2701                	sext.w	a4,a4
     *R(VIRTIO_MMIO_DEVICE_ID) != 2 ||
    8000652c:	554d47b7          	lui	a5,0x554d4
    80006530:	55178793          	addi	a5,a5,1361 # 554d4551 <_entry-0x2ab2baaf>
    80006534:	0af71963          	bne	a4,a5,800065e6 <virtio_disk_init+0x114>
  *R(VIRTIO_MMIO_STATUS) = status;
    80006538:	100017b7          	lui	a5,0x10001
    8000653c:	4705                	li	a4,1
    8000653e:	dbb8                	sw	a4,112(a5)
  *R(VIRTIO_MMIO_STATUS) = status;
    80006540:	470d                	li	a4,3
    80006542:	dbb8                	sw	a4,112(a5)
  uint64 features = *R(VIRTIO_MMIO_DEVICE_FEATURES);
    80006544:	4b94                	lw	a3,16(a5)
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    80006546:	c7ffe737          	lui	a4,0xc7ffe
    8000654a:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fd775f>
    8000654e:	8f75                	and	a4,a4,a3
  *R(VIRTIO_MMIO_DRIVER_FEATURES) = features;
    80006550:	2701                	sext.w	a4,a4
    80006552:	d398                	sw	a4,32(a5)
  *R(VIRTIO_MMIO_STATUS) = status;
    80006554:	472d                	li	a4,11
    80006556:	dbb8                	sw	a4,112(a5)
  *R(VIRTIO_MMIO_STATUS) = status;
    80006558:	473d                	li	a4,15
    8000655a:	dbb8                	sw	a4,112(a5)
  *R(VIRTIO_MMIO_GUEST_PAGE_SIZE) = PGSIZE;
    8000655c:	6705                	lui	a4,0x1
    8000655e:	d798                	sw	a4,40(a5)
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
    80006560:	0207a823          	sw	zero,48(a5) # 10001030 <_entry-0x6fffefd0>
  uint32 max = *R(VIRTIO_MMIO_QUEUE_NUM_MAX);
    80006564:	5bdc                	lw	a5,52(a5)
    80006566:	2781                	sext.w	a5,a5
  if(max == 0)
    80006568:	c7d9                	beqz	a5,800065f6 <virtio_disk_init+0x124>
  if(max < NUM)
    8000656a:	471d                	li	a4,7
    8000656c:	08f77d63          	bgeu	a4,a5,80006606 <virtio_disk_init+0x134>
  *R(VIRTIO_MMIO_QUEUE_NUM) = NUM;
    80006570:	100014b7          	lui	s1,0x10001
    80006574:	47a1                	li	a5,8
    80006576:	dc9c                	sw	a5,56(s1)
  memset(disk.pages, 0, sizeof(disk.pages));
    80006578:	6609                	lui	a2,0x2
    8000657a:	4581                	li	a1,0
    8000657c:	0001e517          	auipc	a0,0x1e
    80006580:	a8450513          	addi	a0,a0,-1404 # 80024000 <disk>
    80006584:	ffffa097          	auipc	ra,0xffffa
    80006588:	75c080e7          	jalr	1884(ra) # 80000ce0 <memset>
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
    8000658c:	0001e717          	auipc	a4,0x1e
    80006590:	a7470713          	addi	a4,a4,-1420 # 80024000 <disk>
    80006594:	00c75793          	srli	a5,a4,0xc
    80006598:	2781                	sext.w	a5,a5
    8000659a:	c0bc                	sw	a5,64(s1)
  disk.desc = (struct virtq_desc *) disk.pages;
    8000659c:	00020797          	auipc	a5,0x20
    800065a0:	a6478793          	addi	a5,a5,-1436 # 80026000 <disk+0x2000>
    800065a4:	e398                	sd	a4,0(a5)
  disk.avail = (struct virtq_avail *)(disk.pages + NUM*sizeof(struct virtq_desc));
    800065a6:	0001e717          	auipc	a4,0x1e
    800065aa:	ada70713          	addi	a4,a4,-1318 # 80024080 <disk+0x80>
    800065ae:	e798                	sd	a4,8(a5)
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    800065b0:	0001f717          	auipc	a4,0x1f
    800065b4:	a5070713          	addi	a4,a4,-1456 # 80025000 <disk+0x1000>
    800065b8:	eb98                	sd	a4,16(a5)
    disk.free[i] = 1;
    800065ba:	4705                	li	a4,1
    800065bc:	00e78c23          	sb	a4,24(a5)
    800065c0:	00e78ca3          	sb	a4,25(a5)
    800065c4:	00e78d23          	sb	a4,26(a5)
    800065c8:	00e78da3          	sb	a4,27(a5)
    800065cc:	00e78e23          	sb	a4,28(a5)
    800065d0:	00e78ea3          	sb	a4,29(a5)
    800065d4:	00e78f23          	sb	a4,30(a5)
    800065d8:	00e78fa3          	sb	a4,31(a5)
}
...
{
    80006616:	7159                	addi	sp,sp,-112
    80006618:	f486                	sd	ra,104(sp)
    8000661a:	f0a2                	sd	s0,96(sp)
    8000661c:	eca6                	sd	s1,88(sp)
    8000661e:	e8ca                	sd	s2,80(sp)
    80006620:	e4ce                	sd	s3,72(sp)
    80006622:	e0d2                	sd	s4,64(sp)
    80006624:	fc56                	sd	s5,56(sp)
    80006626:	f85a                	sd	s6,48(sp)
    80006628:	f45e                	sd	s7,40(sp)
    8000662a:	f062                	sd	s8,32(sp)
    8000662c:	ec66                	sd	s9,24(sp)
    8000662e:	e86a                	sd	s10,16(sp)
    80006630:	1880                	addi	s0,sp,112
    80006632:	892a                	mv	s2,a0
    80006634:	8d2e                	mv	s10,a1
  uint64 sector = b->blockno * (BSIZE / 512);
    80006636:	00c52c83          	lw	s9,12(a0)
    8000663a:	001c9c9b          	slliw	s9,s9,0x1
    8000663e:	1c82                	slli	s9,s9,0x20
    80006640:	020cdc93          	srli	s9,s9,0x20

  acquire(&disk.vdisk_lock);
    80006644:	00020517          	auipc	a0,0x20
    80006648:	ae450513          	addi	a0,a0,-1308 # 80026128 <disk+0x2128>
    8000664c:	ffffa097          	auipc	ra,0xffffa
    80006650:	598080e7          	jalr	1432(ra) # 80000be4 <acquire>
  for(int i = 0; i < 3; i++){
    80006654:	4981                	li	s3,0
  for(int i = 0; i < NUM; i++){
    80006656:	4c21                	li	s8,8
      disk.free[i] = 0;
    80006658:	0001eb97          	auipc	s7,0x1e
    8000665c:	9a8b8b93          	addi	s7,s7,-1624 # 80024000 <disk>
    80006660:	6b09                	lui	s6,0x2
  for(int i = 0; i < 3; i++){
    80006662:	4a8d                	li	s5,3
  for(int i = 0; i < NUM; i++){
    80006664:	8a4e                	mv	s4,s3
    80006666:	a051                	j	800066ea <virtio_disk_rw+0xd4>
      disk.free[i] = 0;
    80006668:	00fb86b3          	add	a3,s7,a5
    8000666c:	96da                	add	a3,a3,s6
    8000666e:	00068c23          	sb	zero,24(a3)
    idx[i] = alloc_desc();
    80006672:	c21c                	sw	a5,0(a2)
    if(idx[i] < 0){
    80006674:	0207c563          	bltz	a5,8000669e <virtio_disk_rw+0x88>
  for(int i = 0; i < 3; i++){
    80006678:	2485                	addiw	s1,s1,1
    8000667a:	0711                	addi	a4,a4,4
    8000667c:	25548063          	beq	s1,s5,800068bc <virtio_disk_rw+0x2a6>
    idx[i] = alloc_desc();
    80006680:	863a                	mv	a2,a4
  for(int i = 0; i < NUM; i++){
    80006682:	00020697          	auipc	a3,0x20
    80006686:	99668693          	addi	a3,a3,-1642 # 80026018 <disk+0x2018>
    8000668a:	87d2                	mv	a5,s4
    if(disk.free[i]){
    8000668c:	0006c583          	lbu	a1,0(a3)
    80006690:	fde1                	bnez	a1,80006668 <virtio_disk_rw+0x52>
  for(int i = 0; i < NUM; i++){
    80006692:	2785                	addiw	a5,a5,1
    80006694:	0685                	addi	a3,a3,1
    80006696:	ff879be3          	bne	a5,s8,8000668c <virtio_disk_rw+0x76>
    idx[i] = alloc_desc();
    8000669a:	57fd                	li	a5,-1
    8000669c:	c21c                	sw	a5,0(a2)
      for(int j = 0; j < i; j++)
    8000669e:	02905a63          	blez	s1,800066d2 <virtio_disk_rw+0xbc>
        free_desc(idx[j]);
    800066a2:	f9042503          	lw	a0,-112(s0)
    800066a6:	00000097          	auipc	ra,0x0
    800066aa:	d90080e7          	jalr	-624(ra) # 80006436 <free_desc>
      for(int j = 0; j < i; j++)
    800066ae:	4785                	li	a5,1
    800066b0:	0297d163          	bge	a5,s1,800066d2 <virtio_disk_rw+0xbc>
        free_desc(idx[j]);
    800066b4:	f9442503          	lw	a0,-108(s0)
    800066b8:	00000097          	auipc	ra,0x0
    800066bc:	d7e080e7          	jalr	-642(ra) # 80006436 <free_desc>
      for(int j = 0; j < i; j++)
    800066c0:	4789                	li	a5,2
    800066c2:	0097d863          	bge	a5,s1,800066d2 <virtio_disk_rw+0xbc>
        free_desc(idx[j]);
    800066c6:	f9842503          	lw	a0,-104(s0)
    800066ca:	00000097          	auipc	ra,0x0
    800066ce:	d6c080e7          	jalr	-660(ra) # 80006436 <free_desc>
  int idx[3];
  while(1){
    ...
    800066d2:	00020597          	auipc	a1,0x20
    800066d6:	a5658593          	addi	a1,a1,-1450 # 80026128 <disk+0x2128>
    800066da:	00020517          	auipc	a0,0x20
    800066de:	93e50513          	addi	a0,a0,-1730 # 80026018 <disk+0x2018>
    800066e2:	ffffc097          	auipc	ra,0xffffc
    800066e6:	914080e7          	jalr	-1772(ra) # 80001ff6 <sleep>
  for(int i = 0; i < 3; i++){
    800066ea:	f9040713          	addi	a4,s0,-112
    800066ee:	84ce                	mv	s1,s3
    800066f0:	bf41                	j	80006680 <virtio_disk_rw+0x6a>
  ...
  if(write)
    ...
    800066f2:	20058713          	addi	a4,a1,512
    800066f6:	00471693          	slli	a3,a4,0x4
    800066fa:	0001e717          	auipc	a4,0x1e
    800066fe:	90670713          	addi	a4,a4,-1786 # 80024000 <disk>
    80006702:	9736                	add	a4,a4,a3
    80006704:	4685                	li	a3,1
    80006706:	0ad72423          	sw	a3,168(a4)
  else
    buf0->type = VIRTIO_BLK_T_IN; // read the disk
  buf0->reserved = 0;
    8000670a:	20058713          	addi	a4,a1,512
    8000670e:	00471693          	slli	a3,a4,0x4
    80006712:	0001e717          	auipc	a4,0x1e
    80006716:	8ee70713          	addi	a4,a4,-1810 # 80024000 <disk>
    8000671a:	9736                	add	a4,a4,a3
    8000671c:	0a072623          	sw	zero,172(a4)
  buf0->sector = sector;
    80006720:	0b973823          	sd	s9,176(a4)

  disk.desc[idx[0]].addr = (uint64) buf0;
    80006724:	7679                	lui	a2,0xffffe
    80006726:	963e                	add	a2,a2,a5
    80006728:	00020697          	auipc	a3,0x20
    8000672c:	8d868693          	addi	a3,a3,-1832 # 80026000 <disk+0x2000>
    80006730:	6298                	ld	a4,0(a3)
    80006732:	9732                	add	a4,a4,a2
    80006734:	e308                	sd	a0,0(a4)
  disk.desc[idx[0]].len = sizeof(struct virtio_blk_req);
    80006736:	6298                	ld	a4,0(a3)
    80006738:	9732                	add	a4,a4,a2
    8000673a:	4541                	li	a0,16
    8000673c:	c708                	sw	a0,8(a4)
  disk.desc[idx[0]].flags = VRING_DESC_F_NEXT;
    8000673e:	6298                	ld	a4,0(a3)
    80006740:	9732                	add	a4,a4,a2
    80006742:	4505                	li	a0,1
    80006744:	00a71623          	sh	a0,12(a4)
  disk.desc[idx[0]].next = idx[1];
    80006748:	f9442703          	lw	a4,-108(s0)
    8000674c:	6288                	ld	a0,0(a3)
    8000674e:	962a                	add	a2,a2,a0
    80006750:	00e61723          	sh	a4,14(a2) # ffffffffffffe00e <end+0xffffffff7ffd700e>

  disk.desc[idx[1]].addr = (uint64) b->data;
    80006754:	0712                	slli	a4,a4,0x4
    80006756:	6290                	ld	a2,0(a3)
    80006758:	963a                	add	a2,a2,a4
    8000675a:	05890513          	addi	a0,s2,88
    8000675e:	e208                	sd	a0,0(a2)
  disk.desc[idx[1]].len = BSIZE;
    80006760:	6294                	ld	a3,0(a3)
    80006762:	96ba                	add	a3,a3,a4
    80006764:	40000613          	li	a2,1024
    80006768:	c690                	sw	a2,8(a3)
  if(write)
    8000676a:	140d0063          	beqz	s10,800068aa <virtio_disk_rw+0x294>
    disk.desc[idx[1]].flags = 0; // device reads b->data
    8000676e:	00020697          	auipc	a3,0x20
    80006772:	8926b683          	ld	a3,-1902(a3) # 80026000 <disk+0x2000>
    80006776:	96ba                	add	a3,a3,a4
    80006778:	00069623          	sh	zero,12(a3)
  else
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    8000677c:	0001e817          	auipc	a6,0x1e
    80006780:	88480813          	addi	a6,a6,-1916 # 80024000 <disk>
    80006784:	00020517          	auipc	a0,0x20
    80006788:	87c50513          	addi	a0,a0,-1924 # 80026000 <disk+0x2000>
    8000678c:	6114                	ld	a3,0(a0)
    8000678e:	96ba                	add	a3,a3,a4
    80006790:	00c6d603          	lhu	a2,12(a3)
    80006794:	00166613          	ori	a2,a2,1
    80006798:	00c69623          	sh	a2,12(a3)
  disk.desc[idx[1]].next = idx[2];
    8000679c:	f9842683          	lw	a3,-104(s0)
    800067a0:	6110                	ld	a2,0(a0)
    800067a2:	9732                	add	a4,a4,a2
    800067a4:	00d71723          	sh	a3,14(a4)

  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    800067a8:	20058613          	addi	a2,a1,512
    800067ac:	0612                	slli	a2,a2,0x4
    800067ae:	9642                	add	a2,a2,a6
    800067b0:	577d                	li	a4,-1
    800067b2:	02e60823          	sb	a4,48(a2)
  disk.desc[idx[2]].addr = (uint64) &disk.info[idx[0]].status;
    800067b6:	00469713          	slli	a4,a3,0x4
    800067ba:	6114                	ld	a3,0(a0)
    800067bc:	96ba                	add	a3,a3,a4
    800067be:	03078793          	addi	a5,a5,48
    800067c2:	97c2                	add	a5,a5,a6
    800067c4:	e29c                	sd	a5,0(a3)
  disk.desc[idx[2]].len = 1;
    800067c6:	611c                	ld	a5,0(a0)
    800067c8:	97ba                	add	a5,a5,a4
    800067ca:	4685                	li	a3,1
    800067cc:	c794                	sw	a3,8(a5)
  disk.desc[idx[2]].flags = VRING_DESC_F_WRITE; // device writes the status
    800067ce:	611c                	ld	a5,0(a0)
    800067d0:	97ba                	add	a5,a5,a4
    800067d2:	4809                	li	a6,2
    800067d4:	01079623          	sh	a6,12(a5)
  disk.desc[idx[2]].next = 0;
    800067d8:	611c                	ld	a5,0(a0)
    800067da:	973e                	add	a4,a4,a5
    800067dc:	00071723          	sh	zero,14(a4)

  // record struct buf for virtio_disk_intr().
  b->disk = 1;
    800067e0:	00d92223          	sw	a3,4(s2)
  disk.info[idx[0]].b = b;
    800067e4:	03263423          	sd	s2,40(a2)

  // tell the device the first index in our chain of descriptors.
  disk.avail->ring[disk.avail->idx % NUM] = idx[0];
    800067e8:	6518                	ld	a4,8(a0)
    800067ea:	00275783          	lhu	a5,2(a4)
    800067ee:	8b9d                	andi	a5,a5,7
    800067f0:	0786                	slli	a5,a5,0x1
    800067f2:	97ba                	add	a5,a5,a4
    800067f4:	00b79223          	sh	a1,4(a5)
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
    ...
    80006810:	0407a823          	sw	zero,80(a5) # 10001050 <_entry-0x6fffefb0>

  // Wait for virtio_disk_intr() to say request has finished.
  while(b->disk == 1) {
    80006814:	00492703          	lw	a4,4(s2)
    80006818:	4785                	li	a5,1
    8000681a:	02f71163          	bne	a4,a5,8000683c <virtio_disk_rw+0x226>
    sleep(b, &disk.vdisk_lock);
    8000681e:	00020997          	auipc	s3,0x20
    80006822:	90a98993          	addi	s3,s3,-1782 # 80026128 <disk+0x2128>
  while(b->disk == 1) {
    80006826:	4485                	li	s1,1
    sleep(b, &disk.vdisk_lock);
    80006828:	85ce                	mv	a1,s3
    8000682a:	854a                	mv	a0,s2
    8000682c:	ffffb097          	auipc	ra,0xffffb
    80006830:	7ca080e7          	jalr	1994(ra) # 80001ff6 <sleep>
  while(b->disk == 1) {
    80006834:	00492783          	lw	a5,4(s2)
    80006838:	fe9788e3          	beq	a5,s1,80006828 <virtio_disk_rw+0x212>
  }

  disk.info[idx[0]].b = 0;
    8000683c:	f9042903          	lw	s2,-112(s0)
    80006840:	20090793          	addi	a5,s2,512
    80006844:	00479713          	slli	a4,a5,0x4
    80006848:	0001d797          	auipc	a5,0x1d
    8000684c:	7b878793          	addi	a5,a5,1976 # 80024000 <disk>
    80006850:	97ba                	add	a5,a5,a4
    80006852:	0207b423          	sd	zero,40(a5)
    int flag = disk.desc[i].flags;
    80006856:	0001f997          	auipc	s3,0x1f
    8000685a:	7aa98993          	addi	s3,s3,1962 # 80026000 <disk+0x2000>
    8000685e:	00491713          	slli	a4,s2,0x4
    80006862:	0009b783          	ld	a5,0(s3)
    80006866:	97ba                	add	a5,a5,a4
    80006868:	00c7d483          	lhu	s1,12(a5)
    int nxt = disk.desc[i].next;
    8000686c:	854a                	mv	a0,s2
    8000686e:	00e7d903          	lhu	s2,14(a5)
    free_desc(i);
    80006872:	00000097          	auipc	ra,0x0
    80006876:	bc4080e7          	jalr	-1084(ra) # 80006436 <free_desc>
    if(flag & VRING_DESC_F_NEXT)
    8000687a:	8885                	andi	s1,s1,1
    8000687c:	f0ed                	bnez	s1,8000685e <virtio_disk_rw+0x248>
  free_chain(idx[0]);

  release(&disk.vdisk_lock);
    8000687e:	00020517          	auipc	a0,0x20
    80006882:	8aa50513          	addi	a0,a0,-1878 # 80026128 <disk+0x2128>
    80006886:	ffffa097          	auipc	ra,0xffffa
    8000688a:	412080e7          	jalr	1042(ra) # 80000c98 <release>
}
    8000688e:	70a6                	ld	ra,104(sp)
    80006890:	7406                	ld	s0,96(sp)
    80006892:	64e6                	ld	s1,88(sp)
    80006894:	6946                	ld	s2,80(sp)
    80006896:	69a6                	ld	s3,72(sp)
    80006898:	6a06                	ld	s4,64(sp)
    8000689a:	7ae2                	ld	s5,56(sp)
    8000689c:	7b42                	ld	s6,48(sp)
    8000689e:	7ba2                	ld	s7,40(sp)
    800068a0:	7c02                	ld	s8,32(sp)
    800068a2:	6ce2                	ld	s9,24(sp)
    800068a4:	6d42                	ld	s10,16(sp)
    800068a6:	6165                	addi	sp,sp,112
    800068a8:	8082                	ret
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
    800068aa:	0001f697          	auipc	a3,0x1f
    800068ae:	7566b683          	ld	a3,1878(a3) # 80026000 <disk+0x2000>
    800068b2:	96ba                	add	a3,a3,a4
    800068b4:	4609                	li	a2,2
    800068b6:	00c69623          	sh	a2,12(a3)
    800068ba:	b5c9                	j	8000677c <virtio_disk_rw+0x166>
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    800068bc:	f9042583          	lw	a1,-112(s0)
    800068c0:	20058793          	addi	a5,a1,512
    800068c4:	0792                	slli	a5,a5,0x4
    800068c6:	0001d517          	auipc	a0,0x1d
    800068ca:	7e250513          	addi	a0,a0,2018 # 800240a8 <disk+0xa8>
    800068ce:	953e                	add	a0,a0,a5
  if(write)
    800068d0:	e20d11e3          	bnez	s10,800066f2 <virtio_disk_rw+0xdc>
    buf0->type = VIRTIO_BLK_T_IN; // read the disk
    800068d4:	20058713          	addi	a4,a1,512
    800068d8:	00471693          	slli	a3,a4,0x4
    800068dc:	0001d717          	auipc	a4,0x1d
    800068e0:	72470713          	addi	a4,a4,1828 # 80024000 <disk>
    800068e4:	9736                	add	a4,a4,a3
    800068e6:	0a072423          	sw	zero,168(a4)
    800068ea:	b505                	j	8000670a <virtio_disk_rw+0xf4>

00000000800068ec <virtio_disk_intr>:
...
virtio_disk_intr()
{
    ...
    800068f4:	e04a                	sd	s2,0(sp)
    800068f6:	1000                	addi	s0,sp,32
  acquire(&disk.vdisk_lock);
    800068f8:	00020517          	auipc	a0,0x20
    800068fc:	83050513          	addi	a0,a0,-2000 # 80026128 <disk+0x2128>
    80006900:	ffffa097          	auipc	ra,0xffffa
    80006904:	2e4080e7          	jalr	740(ra) # 80000be4 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    8000691a:	6ea78793          	addi	a5,a5,1770 # 80026000 <disk+0x2000>
    8000691e:	6b94                	ld	a3,16(a5)
    80006920:	0207d703          	lhu	a4,32(a5)
    80006924:	0026d783          	lhu	a5,2(a3)
    80006928:	06f70163          	beq	a4,a5,8000698a <virtio_disk_intr+0x9e>
    __sync_synchronize();
    int id = disk.used->ring[disk.used_idx % NUM].id;
    8000692c:	0001d917          	auipc	s2,0x1d
    80006930:	6d490913          	addi	s2,s2,1748 # 80024000 <disk>
    80006934:	0001f497          	auipc	s1,0x1f
    80006938:	6cc48493          	addi	s1,s1,1740 # 80026000 <disk+0x2000>
    __sync_synchronize();
    8000693c:	0ff0000f          	fence
    int id = disk.used->ring[disk.used_idx % NUM].id;
    80006940:	6898                	ld	a4,16(s1)
    80006942:	0204d783          	lhu	a5,32(s1)
    80006946:	8b9d                	andi	a5,a5,7
    80006948:	078e                	slli	a5,a5,0x3
    8000694a:	97ba                	add	a5,a5,a4
    8000694c:	43dc                	lw	a5,4(a5)

    if(disk.info[id].status != 0)
    8000694e:	20078713          	addi	a4,a5,512
    80006952:	0712                	slli	a4,a4,0x4
    80006954:	974a                	add	a4,a4,s2
    80006956:	03074703          	lbu	a4,48(a4) # 10001030 <_entry-0x6fffefd0>
    8000695a:	e731                	bnez	a4,800069a6 <virtio_disk_intr+0xba>
      panic("virtio_disk_intr status");

    struct buf *b = disk.info[id].b;
    8000695c:	20078793          	addi	a5,a5,512
    80006960:	0792                	slli	a5,a5,0x4
    80006962:	97ca                	add	a5,a5,s2
    80006964:	7788                	ld	a0,40(a5)
    b->disk = 0;   // disk is done with buf
    80006966:	00052223          	sw	zero,4(a0)
    wakeup(b);
    8000696a:	ffffc097          	auipc	ra,0xffffc
    8000696e:	818080e7          	jalr	-2024(ra) # 80002182 <wakeup>

    disk.used_idx += 1;
    80006972:	0204d783          	lhu	a5,32(s1)
    80006976:	2785                	addiw	a5,a5,1
    80006978:	17c2                	slli	a5,a5,0x30
    8000697a:	93c1                	srli	a5,a5,0x30
    8000697c:	02f49023          	sh	a5,32(s1)
  while(disk.used_idx != disk.used->idx){
    80006980:	6898                	ld	a4,16(s1)
    80006982:	00275703          	lhu	a4,2(a4)
    80006986:	faf71be3          	bne	a4,a5,8000693c <virtio_disk_intr+0x50>
  }

  release(&disk.vdisk_lock);
    8000698a:	0001f517          	auipc	a0,0x1f
    8000698e:	79e50513          	addi	a0,a0,1950 # 80026128 <disk+0x2128>
    80006992:	ffffa097          	auipc	ra,0xffffa
    80006996:	306080e7          	jalr	774(ra) # 80000c98 <release>
}
    8000699a:	60e2                	ld	ra,24(sp)
    8000699c:	6442                	ld	s0,16(sp)
    8000699e:	64a2                	ld	s1,8(sp)
    800069a0:	6902                	ld	s2,0(sp)
    800069a2:	6105                	addi	sp,sp,32
    800069a4:	8082                	ret
      panic("virtio_disk_intr status");
    800069a6:	00002517          	auipc	a0,0x2
    800069aa:	fba50513          	addi	a0,a0,-70 # 80008960 <syscalls+0x3c0>
    800069ae:	ffffa097          	auipc	ra,0xffffa
    800069b2:	b90080e7          	jalr	-1136(ra) # 8000053e <panic>

00000000800069b6 <push>:
...
{
  if (list->size == NPROC) {
    800069b6:	21052703          	lw	a4,528(a0)
    800069ba:	04000793          	li	a5,64
    800069be:	02f70363          	beq	a4,a5,800069e4 <push+0x2e>
    panic("Proccess limit exceeded");
  }  

  list->array[list->tail] = element;
    800069c2:	415c                	lw	a5,4(a0)
    800069c4:	00379693          	slli	a3,a5,0x3
    800069c8:	96aa                	add	a3,a3,a0
    800069ca:	e68c                	sd	a1,8(a3)
  list->tail++;
    800069cc:	2785                	addiw	a5,a5,1
    800069ce:	0007861b          	sext.w	a2,a5
  if (list->tail == NPROC + 1) {
    800069d2:	04100693          	li	a3,65
    800069d6:	02d60363          	beq	a2,a3,800069fc <push+0x46>
  list->tail++;
    800069da:	c15c                	sw	a5,4(a0)
    list->tail = 0;
  }
  list->size++;
    800069dc:	2705                	addiw	a4,a4,1
    800069de:	20e52823          	sw	a4,528(a0)
    800069e2:	8082                	ret
{
    ...
    800069f0:	f8c50513          	addi	a0,a0,-116 # 80008978 <syscalls+0x3d8>
    800069f4:	ffffa097          	auipc	ra,0xffffa
    800069f8:	b4a080e7          	jalr	-1206(ra) # 8000053e <panic>
    list->tail = 0;
    800069fc:	00052223          	sw	zero,4(a0)
    80006a00:	bff1                	j	800069dc <push+0x26>

0000000080006a02 <pop>:
}
...
{
  if (list->size == 0) {
    80006a02:	21052783          	lw	a5,528(a0)
    80006a06:	cf91                	beqz	a5,80006a22 <pop+0x20>
    panic("Poping from empty queue");
  }

  list->head++;
    80006a08:	4118                	lw	a4,0(a0)
    80006a0a:	2705                	addiw	a4,a4,1
    80006a0c:	0007061b          	sext.w	a2,a4
  if (list->head == NPROC + 1) {
    80006a10:	04100693          	li	a3,65
    80006a14:	02d60363          	beq	a2,a3,80006a3a <pop+0x38>
  list->head++;
    80006a18:	c118                	sw	a4,0(a0)
    list->head = 0;
  }

  list->size--;
    80006a1a:	37fd                	addiw	a5,a5,-1
    80006a1c:	20f52823          	sw	a5,528(a0)
    80006a20:	8082                	ret
{
    80006a22:	1141                	addi	sp,sp,-16
    80006a24:	e406                	sd	ra,8(sp)
    80006a26:	e022                	sd	s0,0(sp)
    80006a28:	0800                	addi	s0,sp,16
    panic("Poping from empty queue");
    80006a2a:	00002517          	auipc	a0,0x2
    80006a2e:	f6650513          	addi	a0,a0,-154 # 80008990 <syscalls+0x3f0>
    80006a32:	ffffa097          	auipc	ra,0xffffa
    80006a36:	b0c080e7          	jalr	-1268(ra) # 8000053e <panic>
    list->head = 0;
    80006a3a:	00052023          	sw	zero,0(a0)
    80006a3e:	bff1                	j	80006a1a <pop+0x18>

0000000080006a40 <front>:
}
...
front(struct Queue *list)
{
  ...
  if (list->head == list->tail) {
    80006a46:	411c                	lw	a5,0(a0)
    80006a48:	4158                	lw	a4,4(a0)
    80006a4a:	00f70863          	beq	a4,a5,80006a5a <front+0x1a>
    return 0;
  } 
  return list->array[list->head];
    80006a4e:	078e                	slli	a5,a5,0x3
    80006a50:	953e                	add	a0,a0,a5
    80006a52:	6508                	ld	a0,8(a0)
}
    ...
    80006a5c:	bfe5                	j	80006a54 <front+0x14>

0000000080006a5e <qerase>:

void 
qerase(struct Queue *list, int pid) 
{
    80006a5e:	1141                	addi	sp,sp,-16
    80006a60:	e422                	sd	s0,8(sp)
    80006a62:	0800                	addi	s0,sp,16
  for (int curr = list->head; curr != list->tail; curr = (curr + 1) % (NPROC + 1)) {
    80006a64:	411c                	lw	a5,0(a0)
    80006a66:	00452803          	lw	a6,4(a0)
    80006a6a:	03078d63          	beq	a5,a6,80006aa4 <qerase+0x46>
    if (list->array[curr]->pid == pid) {
      struct proc *temp = list->array[curr];
      list->array[curr] = list->array[(curr + 1) % (NPROC + 1)];
    80006a6e:	04100893          	li	a7,65
    80006a72:	a031                	j	80006a7e <qerase+0x20>
  for (int curr = list->head; curr != list->tail; curr = (curr + 1) % (NPROC + 1)) {
    80006a74:	2785                	addiw	a5,a5,1
    80006a76:	0317e7bb          	remw	a5,a5,a7
    80006a7a:	03078563          	beq	a5,a6,80006aa4 <qerase+0x46>
    if (list->array[curr]->pid == pid) {
    80006a7e:	00379713          	slli	a4,a5,0x3
    80006a82:	972a                	add	a4,a4,a0
    80006a84:	6710                	ld	a2,8(a4)
    80006a86:	5a14                	lw	a3,48(a2)
    80006a88:	feb696e3          	bne	a3,a1,80006a74 <qerase+0x16>
      list->array[curr] = list->array[(curr + 1) % (NPROC + 1)];
    80006a8c:	0017869b          	addiw	a3,a5,1
    80006a90:	0316e6bb          	remw	a3,a3,a7
    80006a94:	068e                	slli	a3,a3,0x3
    80006a96:	96aa                	add	a3,a3,a0
    80006a98:	0086b303          	ld	t1,8(a3)
    80006a9c:	00673423          	sd	t1,8(a4)
      list->array[(curr + 1) % (NPROC + 1)] = temp;
    80006aa0:	e690                	sd	a2,8(a3)
    80006aa2:	bfc9                	j	80006a74 <qerase+0x16>
    } 
  }

  list->tail--;
    80006aa4:	387d                	addiw	a6,a6,-1
    80006aa6:	01052223          	sw	a6,4(a0)
  list->size--;
    80006aaa:	21052783          	lw	a5,528(a0)
    80006aae:	37fd                	addiw	a5,a5,-1
    80006ab0:	20f52823          	sw	a5,528(a0)
  if (list->tail < 0) {
    80006ab4:	02081793          	slli	a5,a6,0x20
    80006ab8:	0007c563          	bltz	a5,80006ac2 <qerase+0x64>
    list->tail = NPROC;
  }
    ...
    80006ac0:	8082                	ret
    list->tail = NPROC;
    80006ac2:	04000793          	li	a5,64
    80006ac6:	c15c                	sw	a5,4(a0)
    80006ac8:	bfd5                	j	80006abc <qerase+0x5e>
	...
